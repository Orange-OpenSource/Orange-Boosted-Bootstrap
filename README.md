...
- Install with [npm](https://www.npmjs.com/): `npm install boosted@v5.3.7`
- Install with [yarn](https://yarnpkg.com/): `yarn add boosted@v5.3.7`
- Install with [Bun](https://bun.sh/): `bun add boosted@v5.3.7`
