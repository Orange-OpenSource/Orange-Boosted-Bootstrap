...
- Install with [npm](https://www.npmjs.com/): `npm install @ouds/web-common@v1.3.0 @ouds/web-orange@v1.3.0`
- Install with [yarn](https://yarnpkg.com/): `yarn add @ouds/web-common@v1.3.0 @ouds/web-orange@v1.3.0`
- Install with [Bun](https://bun.sh/): `bun add @ouds/web-common@v1.3.0 @ouds/web-orange@v1.3.0`
