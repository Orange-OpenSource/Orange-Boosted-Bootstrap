...
[![CSS gzip size](https://img.badgesize.io/Orange-OpenSource/Orange-Boosted-Bootstrap/master/dist/css/boosted.min.css?compression=gzip&label=CSS+gzip+size)](https://github.com/Orange-OpenSource/Orange-Boosted-Bootstrap/blob/v5-dev/dist/css/boosted.min.css)
[![JS gzip size](https://img.badgesize.io/Orange-OpenSource/Orange-Boosted-Bootstrap/master/dist/js/boosted.min.js?compression=gzip&label=JS+gzip+size)](https://github.com/Orange-OpenSource/Orange-Boosted-Bootstrap/blob/v5-dev/dist/js/boosted.min.js)
