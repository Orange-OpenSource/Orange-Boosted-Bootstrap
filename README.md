<p align="center">
  <a href="https://boosted.orange.com/">
    <img src="https://boosted.orange.com/docs/4.5/assets/brand/orange-logo.svg" alt="Boosted" width="72" height="72">
  </a>
</p>
...
- Install with [yarn](https://yarnpkg.com/): `yarn add boosted@4.5.0`
...
Boosted's documentation, included in this repo in the root directory, is built with [Hugo](https://gohugo.io/) and publicly hosted on GitHub Pages at <https://v5-dev--boosted.netlify.app/>. The docs may also be run locally.
