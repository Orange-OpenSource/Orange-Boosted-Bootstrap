...
function(e){"use strict";e(function(){
// Tooltip and popover demos
e(".tooltip-demo").tooltip({selector:'[data-toggle="tooltip"]',container:"body"}),e('[data-toggle="popover"]').popover(),
// Demos within modals
e(".tooltip-test").tooltip(),e(".popover-test").popover(),
// Indeterminate checkbox example
e('.bd-example-indeterminate [type="checkbox"]').prop("indeterminate",!0),
// Disable empty links in docs examples
e('.bd-content [href="#"]').click(function(e){e.preventDefault()}),
// Modal relatedTarget demo
e("#exampleModal").on("show.bs.modal",function(t){var n=e(t.relatedTarget),r=n.data("whatever"),i=e(this);i.find(".modal-title").text("New message to "+r),i.find(".modal-body input").val(r)}),
// Activate animated progress bar
e(".bd-toggle-animated-progress").on("click",function(){e(this).siblings(".progress").find(".progress-bar-striped").toggleClass("progress-bar-animated")}),
// Insert copy to clipboard button before .highlight
// boosted mod
// change class btn-clipboard to btn btn-sm btn-secondary
e(".highlight").each(function(){var t='<div class="bd-clipboard"><span class="btn btn-sm btn-secondary" title="Copy to clipboard">Copy</span></div>';e(this).before(t),e(".btn-clipboard").tooltip()});
// end mod
var t=new Clipboard(".btn-clipboard",{target:function(e){return e.parentNode.nextElementSibling}});t.on("success",function(t){e(t.trigger).attr("title","Copied!").tooltip("_fixTitle").tooltip("show").attr("title","Copy to clipboard").tooltip("_fixTitle"),t.clearSelection()}),t.on("error",function(t){var n=/Mac/i.test(navigator.userAgent)?"⌘":"Ctrl-",r="Press "+n+"C to copy";e(t.trigger).attr("title",r).tooltip("_fixTitle").tooltip("show").attr("title","Copy to clipboard").tooltip("_fixTitle")})})}(jQuery),function(){"use strict";anchors.options.placement="left",anchors.add(".bd-content > h1, .bd-content > h2, .bd-content > h3, .bd-content > h4, .bd-content > h5")}(),!function(e){"use strict";e(function(){e('[href="#"]').click(function(e){e.preventDefault()}),e(document).ready(function(){
// init megamenu demo
e(".mega-menu.panel").megamenu()})})}(jQuery),function(){"use strict";function e(e,t){var n=e.getBoundingClientRect();return t||(t=0),n.bottom>t&&n.right>0&&n.left<(window.innerWidth||document.documentElement.clientWidth)&&n.top<(window.innerHeight||document.documentElement.clientHeight)}function t(t){if(t)return function(){var n=document.getElementById("docsNavbarContent");e(t)?(n.style.position="static",n.style.top="auto"):(n.style.position="fixed",n.style.top="0")}}function n(t,n,r){if(t&&window.innerWidth>768)return function(){var i=t.getBoundingClientRect();e(t)?n.style.bottom=window.innerHeight-i.top+parseInt(r)+"px":n.style.bottom=r}}window.onload=function(){var e,r,i,o=document.getElementById("page_header"),a=t(o),s=document.getElementsByClassName("scroll-top"),l=s.item(0),c=document.getElementsByTagName("footer"),u=c.item(c.length-1);l&&(e=window.getComputedStyle(l,null),r=e.bottom,i=n(u,l,r)),window.addEventListener?(window.innerWidth>768&&addEventListener("scroll",a,!1),i&&addEventListener("scroll",i,!1)):window.attachEvent&&(attachEvent("onscroll",a),i&&attachEvent("scroll",i))}}();