 ...
 */
!function(a){"use strict";a(function(){a(".tooltip-demo").tooltip({selector:'[data-toggle="tooltip"]',container:"body"}),a('[data-toggle="popover"]').popover(),a(".tooltip-test").tooltip(),a(".popover-test").popover(),a('.bd-example-indeterminate [type="checkbox"]').prop("indeterminate",!0),a("[href=#]").click(function(a){a.preventDefault()}),a(".highlight").each(function(){var b='<div class="bd-clipboard"><span class="btn-clipboard" title="Copy to clipboard">Copy</span></div>';a(this).before(b),a(".btn-clipboard").tooltip()});var b=new Clipboard(".btn-clipboard",{target:function(a){return a.parentNode.nextElementSibling}});b.on("success",function(b){a(b.trigger).attr("title","Copied!").tooltip("_fixTitle").tooltip("show").attr("title","Copy to clipboard").tooltip("_fixTitle"),b.clearSelection()}),b.on("error",function(b){var c=/Mac/i.test(navigator.userAgent)?"Press ⌘ to copy":"Press Ctrl-C to copy";a(b.trigger).attr("title",c).tooltip("_fixTitle").tooltip("show").attr("title","Copy to clipboard").tooltip("_fixTitle")})})}(jQuery),function(){"use strict";anchors.options.placement="left",anchors.add(".bd-content > h1, .bd-content > h2, .bd-content > h3, .bd-content > h4, .bd-content > h5")}(),!function(a){"use strict";a(function(){a("[href=#]").click(function(a){a.preventDefault()}),a(document).ready(function(){a(window).scroll(function(){a(this).scrollTop()>100?a(".scroll-top").fadeIn():a(".scroll-top").fadeOut()}),a(".scroll-top").click(function(){return a("html, body").animate({scrollTop:0},600,function(){a("header li a").first().focus()}),!1})})})}(jQuery),function(){"use strict";function a(a,b){var c=a.getBoundingClientRect();return b||(b=0),c.bottom>b&&c.right>0&&c.left<(window.innerWidth||document.documentElement.clientWidth)&&c.top<(window.innerHeight||document.documentElement.clientHeight)}function b(b){return b?function(){var c=document.getElementById("docsNavbarContent");a(b)?(c.style.position="static",c.style.top="auto"):(c.style.position="fixed",c.style.top="0")}:void 0}function c(b,c,d){return b?function(){var e=b.getBoundingClientRect();a(b)?c.style.bottom=window.innerHeight-e.top+parseInt(d)+"px":c.style.bottom=d}:void 0}window.onload=function(){var a,d,e,f=document.getElementById("page_header"),g=b(f),h=document.getElementsByClassName("scroll-top"),i=h.item(0),j=document.getElementsByTagName("footer"),k=j.item(j.length-1);i&&(a=window.getComputedStyle(i,null),d=a.bottom,e=c(k,i,d)),window.addEventListener?(addEventListener("scroll",g,!1),e&&addEventListener("scroll",e,!1)):window.attachEvent&&(attachEvent("onscroll",g),e&&attachEvent("scroll",e))}}(),!function(a){"use strict";a(function(){a("[href=#]").click(function(a){a.preventDefault()}),a(document).ready(function(){a(window).scroll(function(){a(this).scrollTop()>100?a(".scroll-top").fadeIn():a(".scroll-top").fadeOut()}),a(".scroll-top").click(function(){return a("html, body").animate({scrollTop:0},600,function(){a("header li a").first().focus()}),!1})})})}(jQuery),function(){"use strict";function a(a,b){var c=a.getBoundingClientRect();return b||(b=0),c.bottom>b&&c.right>0&&c.left<(window.innerWidth||document.documentElement.clientWidth)&&c.top<(window.innerHeight||document.documentElement.clientHeight)}function b(b){return b?function(){var c=document.getElementById("docsNavbarContent");a(b)?(c.style.position="static",c.style.top="auto"):(c.style.position="fixed",c.style.top="0")}:void 0}function c(b,c,d){return b?function(){var e=b.getBoundingClientRect();a(b)?c.style.bottom=window.innerHeight-e.top+parseInt(d)+"px":c.style.bottom=d}:void 0}window.onload=function(){var a,d,e,f=document.getElementById("page_header"),g=b(f),h=document.getElementsByClassName("scroll-top"),i=h.item(0),j=document.getElementsByTagName("footer"),k=j.item(j.length-1);i&&(a=window.getComputedStyle(i,null),d=a.bottom,e=c(k,i,d)),window.addEventListener?(addEventListener("scroll",g,!1),e&&addEventListener("scroll",e,!1)):window.attachEvent&&(attachEvent("onscroll",g),e&&attachEvent("scroll",e))}}(),!function(a){"use strict";a(function(){a("[href=#]").click(function(a){a.preventDefault()}),a(document).ready(function(){a(window).scroll(function(){a(this).scrollTop()>100?a(".scroll-top").fadeIn():a(".scroll-top").fadeOut()}),a(".scroll-top").click(function(){return a("html, body").animate({scrollTop:0},600,function(){a("header li a").first().focus()}),!1})})})}(jQuery),function(){"use strict";function a(a,b){var c=a.getBoundingClientRect();return b||(b=0),c.bottom>b&&c.right>0&&c.left<(window.innerWidth||document.documentElement.clientWidth)&&c.top<(window.innerHeight||document.documentElement.clientHeight)}function b(b){return b?function(){var c=document.getElementById("docsNavbarContent");a(b)?(c.style.position="static",c.style.top="auto"):(c.style.position="fixed",c.style.top="0")}:void 0}function c(b,c,d){return b?function(){var e=b.getBoundingClientRect();a(b)?c.style.bottom=window.innerHeight-e.top+parseInt(d)+"px":c.style.bottom=d}:void 0}window.onload=function(){var a,d,e,f=document.getElementById("page_header"),g=b(f),h=document.getElementsByClassName("scroll-top"),i=h.item(0),j=document.getElementsByTagName("footer"),k=j.item(j.length-1);i&&(a=window.getComputedStyle(i,null),d=a.bottom,e=c(k,i,d)),window.addEventListener?(addEventListener("scroll",g,!1),e&&addEventListener("scroll",e,!1)):window.attachEvent&&(attachEvent("onscroll",g),e&&attachEvent("scroll",e))}}();