...
// end mod
t.fn.tab=h._jQueryInterface,t.fn.tab.Constructor=h,t.fn.tab.noConflict=function(){return t.fn.tab=i,h._jQueryInterface}}(jQuery),function(t){/**
...
t(window).on(s.LOAD_DATA_API,function(){for(var e=t.makeArray(t(l.SCROLL_TOP)),n=e.length;n--;){var i=t(e[n]);c._jQueryInterface.call(i,i.data())}}),/**
   ...
   * ------------------------------------------------------------------------
   */
t.fn[e]=c._jQueryInterface,t.fn[e].Constructor=c,t.fn[e].noConflict=function(){return t.fn[e]=i,c._jQueryInterface}}(jQuery),function(r){/**
   * ------------------------------------------------------------------------
   * Constants
   * ------------------------------------------------------------------------
   */
...
get:function(){return"4.0.0-alpha.6"}},{key:"Default",get:function(){return h}},{key:"NAME",get:function(){return a}},{key:"DATA_KEY",get:function(){return"bs.popover"}},{key:"Event",get:function(){return _}},{key:"EVENT_KEY",get:function(){return l}},{key:"DefaultType",get:function(){return u}}]),c}(s);/**
   ...
   * ------------------------------------------------------------------------
   */
r.fn[a]=p._jQueryInterface,r.fn[a].Constructor=p,r.fn[a].noConflict=function(){return r.fn[a]=c,p._jQueryInterface}}(jQuery)}();