...
Almost every token provided in the design specification and potentially needed in various contexts is represented in our codebase as a Sass variable. However, as explained in the [the previous section](#design-tokens), not all tokens should be used directly in your codebase.
