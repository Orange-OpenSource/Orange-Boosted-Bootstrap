/*!
  ...
  * Bootstrap v4.5.0 (https://boosted.orange.com)
...
(function (global, factory) {
  ...
  var Dropdown = /*#__PURE__*/function () {
    ...
    _proto.show = function show(usePopper) {
      ...
      $(parent).toggleClass(CLASS_NAME_SHOW$2).trigger($.Event(EVENT_SHOWN$1, relatedTarget)); // Boosted mod

      $(parent).find(SELECTOR_FIRST_ITEM_IN_MENU).first().trigger('focus'); // end mod
    };
  ...
  .on('DOMContentLoaded', function () {
    ...
    Dropdown._jQueryInterface.call($(SELECTOR_DATA_TOGGLE$2));
  }); // end mod
  ...
  $(document).on(EVENT_CLICK_DATA_API$5, SELECTOR_DATA_TOGGLE$3, function (event) {
    ...
    var config = $(target).data(DATA_KEY$6) ? 'toggle' : _objectSpread2(_objectSpread2({}, $(target).data()), $(this).data());
  ...
  var Navbar = /*#__PURE__*/function () {
    function Navbar(element, config) {
      ...
      if (this._config.sticky) {
        ...
        $(SELECTOR_MEGAMENU_PANEL$1).addClass('sticky');
    ...
    Navbar._jQueryInterface = function _jQueryInterface(config) {
      return this.each(function () {
        ...
        var _config = _objectSpread2(_objectSpread2(_objectSpread2({}, Default$4), $(this).data()), typeof config === 'object' && config ? config : {});
  ...
  $(document).on('DOMContentLoaded', function () {
    ...
    Otab._jQueryInterface.call($(this), CLASS_NAME_SHOW$4);
  });
  /**
   * ------------------------------------------------------------------------
   * jQuery
  ...
  var Tooltip = /*#__PURE__*/function () {
    ...
    _proto.toggle = function toggle(event) {
      ...
      if (event) {
        ...
        if ($(this.getTipElement()).hasClass(CLASS_NAME_SHOW$5)) {
    ...
    _proto.show = function show() {
      ...
      if (this.isWithContent() && this._isEnabled) {
        ...
        $(tip).addClass(CLASS_NAME_SHOW$5); // If this is a touch-enabled device we add extra
        // empty mouseover listeners to the body's immediate children;
        // only needed because of broken event delegation on iOS
        // https://www.quirksmode.org/blog/archives/2014/02/mouse_event_bub.html
    ...
    _proto.hide = function hide(callback) {
      ...
      $(tip).removeClass(CLASS_NAME_SHOW$5); // If this is a touch-enabled device we remove the extra
      // empty mouseover listeners we added for iOS support
    ...
    _proto.setContent = function setContent() {
      ...
      $(tip).removeClass(CLASS_NAME_FADE$2 + " " + CLASS_NAME_SHOW$5);
    };
    ...
    _proto._enter = function _enter(event, context) {
      ...
      if ($(context.getTipElement()).hasClass(CLASS_NAME_SHOW$5) || context._hoverState === HOVER_STATE_SHOW) {
  ...
  var Default$6 = _objectSpread2(_objectSpread2({}, Tooltip.Default), {}, {
    placement: 'right',
    trigger: 'click',
    content: '',
  ...
  var PriorityNav = /*#__PURE__*/function () {
    ...
    _proto._bindUIActions = function _bindUIActions() {
      ...
      $(window).on(EVENT_RESIZE$1, function () {
  ...
  var ScrollSpy = /*#__PURE__*/function () {
    function ScrollSpy(element, config) {
      ...
      $(this._scrollElement).on(EVENT_SCROLL$1, function (event) {
    ...
    _proto._activate = function _activate(target) {
      ...
      if ($link.hasClass(CLASS_NAME_DROPDOWN_ITEM)) {
        ...
        $link.addClass(CLASS_NAME_ACTIVE$3).attr('aria-current', 'page');
      } else {
        // Set triggered link as active
        $link.addClass(CLASS_NAME_ACTIVE$3).attr('aria-current', 'page'); // Set triggered links parents as active
  ...
  $(window).on(EVENT_LOAD_DATA_API$3, function () {
  ...
  var Tab = /*#__PURE__*/function () {
    ...
    _proto.show = function show() {
      ...
      if (this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && $(this._element).hasClass(CLASS_NAME_ACTIVE$4) || $(this._element).hasClass(CLASS_NAME_DISABLED$1)) {
        return;
      }
    ...
    _proto._activate = function _activate(element, container, callback) {
      ...
      if (active && isTransitioning) {
        ...
        $(active).removeClass(CLASS_NAME_SHOW$7).one(Util.TRANSITION_END, complete).emulateTransitionEnd(transitionDuration);
      } else {
        complete();
      }
    };
    ...
    _proto._transitionComplete = function _transitionComplete(element, active, callback) {
      if (active) {
        $(active).removeClass(CLASS_NAME_ACTIVE$4);
        var dropdownChild = $(active.parentNode).find(SELECTOR_DROPDOWN_ACTIVE_CHILD)[0];

        if (dropdownChild) {
          $(dropdownChild).removeClass(CLASS_NAME_ACTIVE$4);
        }
      ...
      $(element).addClass(CLASS_NAME_ACTIVE$4);
      ...
      if (element.parentNode && $(element.parentNode).hasClass(CLASS_NAME_DROPDOWN_MENU)) {
        ...
        if (dropdownElement) {
          ...
          $(dropdownToggleList).addClass(CLASS_NAME_ACTIVE$4);
        }
  ...
  $(document).on(EVENT_CLICK_DATA_API$7, SELECTOR_DATA_TOGGLE$4, function (event) {
    event.preventDefault();
  ...
  .on(EVENT_KEYDOWN_DATA_API$1, SELECTOR_DATA_TOGGLE$4, function (event) {
    ...
    Tab._jQueryInterface.call($(SELECTOR_DATA_TOGGLE$4));
  }); // end mod
  ...
  var Toast = /*#__PURE__*/function () {
    ...
    _proto._getConfig = function _getConfig(config) {
      config = _objectSpread2(_objectSpread2(_objectSpread2({}, Default$9), $(this._element).data()), typeof config === 'object' && config ? config : {});
