...
t(".panel-heading").attr({role:"tab"}),t(".panel-collapse:not(.mega-menu)").attr({role:"tabpanel"}),t(".panel").attr("role","presentation"),/**
   ...
   * ------------------------------------------------------------------------
   */
t(document).on(h.CLICK_DATA_API,f.DATA_TOGGLE,function(e){/input|textarea/i.test(e.target.tagName)||e.preventDefault();var n=_._getTargetFromElement(this),i=t(n).data(s),o=i?"toggle":t(this).data();_._jQueryInterface.call(t(n),o)}),t(function(){
// local navigation
