...
As control items are always displayed as a list, they must be enclosed in a `.control-items-list`. This will handle automatic error text display when a control input is invalid.
