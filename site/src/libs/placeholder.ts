...
function renderPlaceholderToString(placeholder: Placeholder) {
  ...
  if (placeholder.options.showIcon) {
    placeholderStr = `${placeholderStr}<svg x="30%" y="30%" width="40%" height="40%" viewBox="0 0 24 24" fill=${placeholder.options.background.startsWith('var(--') ? placeholder.options.color : placeholder.options.background === '#000' ? '#ffffff30' : '#00000014'} aria-hidden="true">
