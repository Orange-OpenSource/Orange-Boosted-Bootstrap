...
| --------------------------------- | ------------------------------------- | -------------------------------------------------------------------------------------- |
| `$core-ouds-dimension-base`            | <code>{asArray.find((token) => token.name === '$core-ouds-dimension-base').compiledValue}</code> (default), or any value > 0     | Specifies the default spacer value to programmatically generate our [spacer utilities]([[docsref:/utilities/spacing]]). |
