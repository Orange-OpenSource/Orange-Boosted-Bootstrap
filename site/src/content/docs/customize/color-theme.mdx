...
{getData('theme-colors').map((themeColor) => {
  return (
    <div class="col-md-4">
      <div class={`p-3 mb-3 fw-bold text-bg-${themeColor.name}`}>{themeColor.title}</div>
    </div>
  )
 })}
</div>
...
{getData('palette').filter(palette => palette.category === "Core colors").map((category) => {
  return(
        ...
        return(
         <div class="double-figure-svg d-flex">
           <svg
             ...
             style={color.name === "Body Bg" ? { border: "1px solid var(--bs-border-color-subtle)" } : undefined}
           >
             <rect fill={`var(--bs-${getSlug(color.name)})`} x="0" y="0" width="100" height="51" data-bs-theme="light"/>
             <rect fill={`var(--bs-${getSlug(color.name)})`} x="0" y="50" width="100" height="50" data-bs-theme="dark"/>
           </svg>
...
{getData('palette').filter(palette => palette.category === "Functional colors").map((category) => {
  return(
    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 gy-2">
      {category.colors.map((color) => {
        return(
...
{getData('palette').filter(palette => palette.category === "Grays").map((category) => {
  return(
    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 gy-2">
      {category.colors.map((color) => {
        return(
...
{getData('palette').filter(palette => palette.category === "Supporting colors").map((category) => {
  return(
    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 gy-2">
      {category.colors.map((color) => {
        return(
         <div class="double-figure d-flex">
           <figure class="mb-0 w-50" aria-label={`Supporting ${color.name.toLowerCase()}`}>
             <svg viewBox="0 0 100 100" role="img" aria-label={`Supporting ${getSlug(color.name)}`} preserveAspectRatio="xMidYMid meet">
               <rect fill={color.hex } x="0" y="0" width="100" height="100"/>
             </svg>
            <figcaption>
              <b>Supporting {color.name.toLowerCase()}</b>
            </figcaption>
          </figure>
          <div class="d-flex flex-column justify-content-around w-50 p-2 mb-4">
             <p class="mb-0" data-bs-theme="light"><code class="user-select-all text-body">{color.hex}</code></p>
...
{getData('theme-colors').map((themeColor) => {
  return (
      <tr>
        <td>
          <span set:html={themeColor.description} />
        </td>
        <td>
          <div class="border-color">
            <div class="w-100 h-100" style={`background-color: var(--bs-${themeColor.name});`} data-bs-theme="light" title="{{.hex}}"><p class="visually-hidden">{themeColor.hex}</p></div>
          </div>
        </td>
        <td>
          <div class="border-color">
            <div class="w-100 h-100" style={`background-color: var(--bs-${themeColor.name});`} data-bs-theme="dark" title={themeColor.dark_hex}><p class="visually-hidden">{themeColor.dark_hex}</p></div>
          </div>
        </td>
        <td>
          <div>
            <button class="color-copy" data-clipboard-text={`--bs-${themeColor.name}`} data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="Copy to clipboard"><code>--bs-{themeColor.name}</code></button>
            <button class="color-copy" data-clipboard-text={`--bs-${themeColor.name}-rgb`} data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="Copy to clipboard"><code>--bs-{themeColor.name}-rgb</code></button>
            <button class="color-copy" data-clipboard-text={`--bs-${themeColor.name}-bg-subtle`} data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="Copy to clipboard"><code>--bs-{themeColor.name}-bg-subtle</code></button>
            <button class="color-copy" data-clipboard-text={`--bs-${themeColor.name}-border-subtle`} data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="Copy to clipboard"><code>--bs-{themeColor.name}-border-subtle</code></button>
            <button class="color-copy" data-clipboard-text={`--bs-${themeColor.name}-text-emphasis`} data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="Copy to clipboard"><code>--bs-{themeColor.name}-text-emphasis</code></button>
          </div>
        </td> 
      </tr>
  )
  ...
  <table class="table table-swatches">
    ...
    <tbody>
      <tr class="border-bottom-0">
        <td rowspan="2">
          <strong>Body</strong> - Default background and foreground colors, including components.
        </td>
        <td>
          Background.
        </td>
      ...
      <tr class="border-bottom-0">
        <td rowspan="2">
          <strong>Body secondary</strong> - Use the `color` option for less accentuated text (placeholder, helper text, code). Use the `bg` option to low emphasis a content or display a specific component state (hover, form disabled).
        </td>
        <td>
          Background.
        </td>
      ...
      <tr class="border-bottom-0">
        <td rowspan="2">
          <strong>Body tertiary</strong> - Use the tertiary `color` and `bg` options to have a body secondary less-emphasized rendering.
        </td>
        <td>
          Background.
        </td>
      ...
      <tr class="border-bottom-0">
        <td rowspan="2">
          <strong>Border</strong> - Use the default border for clickable component borders and the subtle variant for everything else.
        </td>
        <td>
          Default.
        </td>
      ...
      <tr>
        <td colspan="2">
          <strong>**Disabled</strong> - For disabled state.
        </td>
        <td>
          <div class="border-color">
      ...
      <tr class="border-bottom-0">
        <td rowspan="2">
          <strong>*Highlight</strong> - Use to highlight some components.
        </td>
        <td>
          Background.
        </td>
      ...
      <tr>
        <td>
          <strong>Tertiary active</strong> - Use for active components often accompanied to an orange active bar.
        </td>
        <td>
          Background.
        </td>
      ...
      <tr class="border-bottom-0">
        <td rowspan="2">
          <strong>Focus visible</strong> - Use `outer` for the focus outline. Use `inner` for the focus box-shadow.
        </td>
        <td>
          Outer.
        </td>
      ...
      <tr class="border-bottom-0">
        <td rowspan="2">
          <strong>Link</strong> - Use the default `color` for a link and the hover variant for a link hover state.
        </td>
        <td>
          Default.
        </td>
      ...
      <tr>
        <td colspan="2">
          <strong>Code</strong> - For code color text.
        </td>
        <td>
          <div class="border-color">
