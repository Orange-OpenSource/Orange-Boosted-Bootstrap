...
<Example code={`<div class="bg-status-neutral-emphasized p-sm">
...
<Example class="d-flex justify-content-between flex-wrap gap-2xs" code={`<div class="dropdown" data-bs-theme="light">
