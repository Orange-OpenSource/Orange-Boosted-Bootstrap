...
<Example code={`<!-- h1 uses heading-xlarge font reference like all related classes as \`.h1\`, \`.fs-hxl\`, etc... -->
  ...
  <div class="d-flex align-items-center mb-medium">
    <svg class="hxl-sm-icon me-scaled-small text-status-info" width="1rem" height="1rem" fill="currentColor" aria-hidden="true">
      <use xlink:href="${getVersionedDocsPath('/assets/img/ouds-web-sprite.svg#internet')}" />
    </svg>
  ...
  <div class="d-flex align-items-center mb-medium">
    <svg class="hl-sm-icon me-scaled-small text-status-info" width="1rem" height="1rem" fill="currentColor" aria-hidden="true">
      <use xlink:href="${getVersionedDocsPath('/assets/img/ouds-web-sprite.svg#internet')}" />
    </svg>
  ...
  <div class="d-flex align-items-center mb-medium">
    <svg class="hm-sm-icon me-scaled-small text-status-info" width="1rem" height="1rem" fill="currentColor" aria-hidden="true">
      <use xlink:href="${getVersionedDocsPath('/assets/img/ouds-web-sprite.svg#internet')}" />
    </svg>
  ...
  <div class="d-flex align-items-center mb-medium">
    <svg class="hs-sm-icon me-scaled-small text-status-info" width="1rem" height="1rem" fill="currentColor" aria-hidden="true">
      <use xlink:href="${getVersionedDocsPath('/assets/img/ouds-web-sprite.svg#internet')}" />
    </svg>
  ...
  <div class="d-flex align-items-center mb-medium">
    <svg class="bl-sm-icon me-scaled-small text-status-info" width="1rem" height="1rem" fill="currentColor" aria-hidden="true">
      <use xlink:href="${getVersionedDocsPath('/assets/img/ouds-web-sprite.svg#internet')}" />
    </svg>
  ...
  <div class="d-flex align-items-center mb-medium">
    <svg class="bm-sm-icon me-scaled-small text-status-info" width="1rem" height="1rem" fill="currentColor" aria-hidden="true">
      <use xlink:href="${getVersionedDocsPath('/assets/img/ouds-web-sprite.svg#internet')}" />
    </svg>
...
<Example showMarkup={false} code={`<div class="d-flex mb-medium">
  ...
  <div class="d-flex mb-medium">
    <div class="bg-emphasized d-inline-flex align-items-center justify-content-center me-medium flex-shrink-0" style="width: 6.25rem; height: 6.25rem;">
      <svg class="decorative-sm-icon text-status-info" width="1rem" height="1rem" fill="currentColor" aria-hidden="true" data-bs-theme="${getMode('modes-on-bg-inverse-low')}">
        <use xlink:href="${getVersionedDocsPath('/assets/img/ouds-web-sprite.svg#internet')}"/>
      </svg>
    </div>
    <div>
...
<Example class="mt-0" code={`<svg fill="currentColor" class="decorative-sm-icon" viewBox="0 0 1000 1000" aria-hidden="true">
