...
<Example showMarkup={false} code={`<div class="d-flex mb-md">
  ...
  <div class="d-flex mb-md">
    <div class="bg-emphasized d-inline-flex align-items-center justify-content-center me-md flex-shrink-0" style="width: 6.25rem; height: 6.25rem;">
      <svg class="decorative-2xs-icon text-status-info" width="1rem" height="1rem" fill="currentColor" aria-hidden="true" data-bs-theme="${getMode('modes-on-bg-emphasized')}">
        <use xlink:href="${getVersionedDocsPath('/assets/img/ouds-web-sprite.svg#internet')}"/>
      </svg>
    </div>
    <div>
  ...
  <div class="d-flex mb-md">
    <div class="bg-emphasized d-inline-flex align-items-center justify-content-center me-md flex-shrink-0" style="width: 6.25rem; height: 6.25rem;">
      <svg class="decorative-xs-icon text-status-info" width="1rem" height="1rem" fill="currentColor" aria-hidden="true" data-bs-theme="${getMode('modes-on-bg-emphasized')}">
        <use xlink:href="${getVersionedDocsPath('/assets/img/ouds-web-sprite.svg#internet')}"/>
      </svg>
    </div>
    <div>
  ...
  <div class="d-flex mb-md">
    <div class="bg-emphasized d-inline-flex align-items-center justify-content-center me-md flex-shrink-0" style="width: 6.25rem; height: 6.25rem;">
      <svg class="decorative-md-icon text-status-info" width="1rem" height="1rem" fill="currentColor" aria-hidden="true" data-bs-theme="${getMode('modes-on-bg-emphasized')}">
        <use xlink:href="${getVersionedDocsPath('/assets/img/ouds-web-sprite.svg#internet')}"/>
      </svg>
    </div>
    <div>
  ...
  <div class="d-flex mb-md">
    <div class="bg-emphasized d-inline-flex align-items-center justify-content-center me-md flex-shrink-0" style="width: 6.25rem; height: 6.25rem;">
      <svg class="decorative-lg-icon text-status-info" width="1rem" height="1rem" fill="currentColor" aria-hidden="true" data-bs-theme="${getMode('modes-on-bg-emphasized')}">
        <use xlink:href="${getVersionedDocsPath('/assets/img/ouds-web-sprite.svg#internet')}"/>
      </svg>
    </div>
    <div>
  ...
  <div class="d-flex mb-md">
    <div class="bg-emphasized d-inline-flex align-items-center justify-content-center me-md flex-shrink-0" style="width: 6.25rem; height: 6.25rem;">
      <svg class="decorative-xl-icon text-status-info" width="1rem" height="1rem" fill="currentColor" aria-hidden="true" data-bs-theme="${getMode('modes-on-bg-emphasized')}">
        <use xlink:href="${getVersionedDocsPath('/assets/img/ouds-web-sprite.svg#internet')}"/>
      </svg>
    </div>
    <div>
  ...
  <div class="d-flex mb-md">
    <div class="bg-emphasized d-inline-flex align-items-center justify-content-center me-md flex-shrink-0" style="width: 6.25rem; height: 6.25rem;">
      <svg class="decorative-2xl-icon text-status-info" width="1rem" height="1rem" fill="currentColor" aria-hidden="true" data-bs-theme="${getMode('modes-on-bg-emphasized')}">
        <use xlink:href="${getVersionedDocsPath('/assets/img/ouds-web-sprite.svg#internet')}"/>
      </svg>
    </div>
    <div>
...
<Example code={`<div class="d-flex align-items-center mb-md">
    <img class="hxl-lg-icon me-sm" alt="" src="${getVersionedDocsPath('/assets/img/vite.svg')}" />
    <h1 class="mb-none">H1 with large icon</h1>
  </div>
  <div class="d-flex align-items-center mb-md">
