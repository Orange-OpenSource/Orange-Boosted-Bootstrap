...
<Example code={`<div class="d-flex justify-content-center gap-md-lg">
...
<Example class="d-inline-flex flex-column" code={`<p class="p-small bg-primary d-inline-flex align-items-center gap-xs" data-bs-theme="light">
  ...
  <p class="p-small bg-emphasized d-inline-flex align-items-center gap-xs" data-bs-theme="dark">
    <svg class="decorative-sm-icon" aria-hidden="true">
      <use xlink:href="${getVersionedDocsPath('/assets/img/ouds-web-sprite.svg#heart-empty')}" />
    </svg>
...
<Example showMarkup={false} code={`<div class="d-flex mb-md">
...
<Example code={`<div class="d-flex align-items-center mb-md">
    <img class="hxl-large-icon me-sm" alt="" src="${getVersionedDocsPath('/assets/img/vite.svg')}" />
    <h1 class="mb-none">H1 with large icon</h1>
  </div>
  <div class="d-flex align-items-center mb-md">
