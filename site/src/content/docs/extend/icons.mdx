...
<Example showMarkup={false} code={`<div class="d-flex mb-md">
    <div class="bg-emphasized d-inline-flex align-items-center justify-content-center me-md flex-shrink-0" style="width: 6.25rem; height: 6.25rem;">
      <svg class="decorative-4xs-icon text-status-info" width="1rem" height="1rem" fill="currentColor" aria-hidden="true" data-bs-theme="dark">
        <use xlink:href="/docs/${getConfig().docs_version}/assets/img/ouds-web-sprite.svg#internet"/>
      </svg>
    </div>
    <div>
...
<Example class="mt-0 bd-btn-example" code={`<button type="button" class="btn btn-icon btn-default">
  ...
  <div class="d-inline-block bg-always-white">
    <img src="${getVersionedDocsPath('/assets/img/heart-recommend.svg')}" alt="Favorite" width="32" height="32" />
  </div>`} />
