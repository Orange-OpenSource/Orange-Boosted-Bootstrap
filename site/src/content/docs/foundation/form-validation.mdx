...
<Example buttonLabel="example client-side form" code={`<form class="needs-validation" novalidate>
    ...
    <div class="switch-item-container mb-large">
      <div class="switch-item control-item-reverse component-max-width">
        <div class="control-item-assets-container">
          <input class="control-item-indicator" ty pe="checkbox" role="switch" value="" id="readTermsAndConditions" data-errormessage="readTermsAndConditionsFeedback" required />
        </div>
        <div class="control-item-text-container">
...
<Example buttonLabel="form with all fields mandatory" code={`<form class="needs-validation" novalidate>
    ...
    <div class="text-input component-max-width mb-large">
      <div class="text-input-container">
        ...
        <input type="text" class="text-input-field" id="firstname" placeholder=" " required>
      </div>
    </div>
    ...
    <div class="text-input component-max-width mb-large">
      <div class="text-input-container">
        ...
        <input type="text" class="text-input-field" id="commonname" placeholder=" " required>
      </div>
    </div>
    ...
    <div class="text-input component-max-width mb-large">
      <div class="text-input-container">
        ...
        <input type="text" class="text-input-field" id="lastname" placeholder=" " required>
      </div>
    </div>
    ...
    <div class="text-input component-max-width mb-large">
      <div class="text-input-container">
        ...
        <input type="text" class="text-input-field" id="city" placeholder=" " required>
      </div>
    </div>
  </form>`} />
...
<Example buttonLabel="form with some mandatory fields" code={`<form class="needs-validation" novalidate>
    ...
    <div class="text-input component-max-width mb-large">
      <div class="text-input-container">
        <label for="commonname">Common name</label>
        <input type="text" class="text-input-field" id="commonname" placeholder=" ">
      </div>
    </div>
    ...
    <div class="text-input component-max-width mb-large">
      <div class="text-input-container">
        <label for="city">City of birth</label>
        <input type="text" class="text-input-field" id="city" placeholder=" ">
      </div>
    </div>
  </form>`} />
