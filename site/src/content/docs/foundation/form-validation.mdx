...
- HTML form validation is applied via CSS’s pseudo-classe `:user-invalid`. It applies to `<input />`, `<select>`, and `<textarea>` elements.
...
Try to submit the form below; our JavaScript will intercept the submit button, and you’ll see the `:user-invalid` styles applied to the fields. For invalid fields, it also associates the invalid feedback/error message with the relevant form field using `aria-describedby` (noting that this attribute allows more than one `id` to be referenced, in case the field already points to additional description/helper text).
...
<Example code={`<form class="needs-validation" novalidate>
    ...
    <div class="text-input mb-large">
      <div class="text-input-container">
        ...
        <input type="text" class="text-input-field" id="username" data-feedback-id="usernameFeedback" autocomplete="username" placeholder=" " required>
      </div>
    ...
    <div class="text-input mb-large">
      <div class="text-input-container">
        ...
        <input type="password" id="inputPassword" class="text-input-field" aria-describedby="inputPasswordPrefixHelper" data-feedback-id="passwordFeedback" autocomplete="new-password" placeholder=" " required minlength="8">
...
We recommend using client-side validation before server-side validation. If server-side validation returns any invalid field, you can indicate it by setting the `aria-invalid` to `true`.
...
<Example code={`<form novalidate>
    ...
    <div class="text-input mb-large">
      <div class="text-input-container">
        ...
        <input type="text" class="text-input-field" aria-invalid="true" id="username2" aria-describedby="username2Feedback"
    ...
    <div class="text-input mb-large">
      <div class="text-input-container">
        ...
        <input type="password" id="inputPassword2" class="text-input-field" aria-invalid="true" aria-describedby="password2Feedback" placeholder=" " required>
        <button class="btn btn-minimal btn-icon">
          <svg aria-hidden="true">
            <use xlink:href="/orange/docs/1.0/assets/img/ouds-web-sprite.svg#accessibility-vision"/>
          </svg>
