...
<Example buttonLabel="example server-side form" code={`<form novalidate>
    ...
    <div class="text-input mb-large">
      <div class="text-input-container">
        ...
        <input type="password" id="inputPassword2" class="text-input-field" aria-invalid="true" aria-describedby="password2Feedback" autocomplete="new-password" placeholder=" " required minlength="8">
        <button class="btn btn-minimal btn-icon">
          <svg aria-hidden="true">
            <use xlink:href="/orange/docs/1.0/assets/img/ouds-web-sprite.svg#accessibility-vision"/>
          </svg>
