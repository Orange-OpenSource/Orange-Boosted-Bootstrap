...
<Callout type="negative" title="Do not use multiple themes in the same project">
  OUDS Web is designed for use with a single theme per project. This page displays a themes showcase and should not be replicated in actual projects, as it can create confusion and inconsistency in design.
</Callout>
...
<img src={getVersionedDocsPath('assets/brand/orange-compact-logo.svg')} class="figure-img img-fluid m-auto mb-medium" width="50" height="50" alt="Orange logos" loading="lazy" />
