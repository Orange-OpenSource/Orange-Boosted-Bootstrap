...
{/* - `$theme-colors` lists all [semantically named light theme colors]([[docsref:/foundation/color-theme]]) */}
{/* - `$theme-colors-dark` lists all [semantically named dark theme colors]([[docsref:/foundation/color-theme]]) */}
