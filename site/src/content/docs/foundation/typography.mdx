...
<BrandSpecific brand={['orange', 'orange-compact']}>
  ### Headings with marker

  A brand-colored marker can be displayed below the heading large (`<h2>` or `.h2`), to enhance its visual emphasis and reinforce information hierarchy, by adding the `.marker class`.
  <Example code={`<h2 class="marker">h2. OUDS Web heading with marker</h2>
