...
- Use a [native font stack]([[docsref:/foundation/reboot#native-font-stack]]) that selects the best `font-family` for each OS and device.
...
Change text alignment, transform, style, weight, line-height, decoration and color with our [text utilities]([[docsref:/utilities/text]]) and [color utilities]([[docsref:/utilities/color]]).
