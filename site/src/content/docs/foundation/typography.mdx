...
## Font size for custom components

OUDS Web introduces a specific font size for components named `label` with 4 levels: `small`, `medium`, `large` and `xlarge`. We use this font size for many components included in OUDS Web, if you need to develop a custom component for your project you can use this font by calling the Scss mixin `get-font-size()`. Following is an call example for this mixin.
