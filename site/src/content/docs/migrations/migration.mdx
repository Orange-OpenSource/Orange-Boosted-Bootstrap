...
- <span class="badge text-bg-status-negative-emphasized">Breaking</span> Button CSS variables have been changed. `--bs-button-mono-color-bg-minimal-loading` is no longer available.
-<span class="badge text-bg-status-positive-emphasized">New</span> `.btn-rounded` is now available.
-<span class="badge text-bg-status-positive-emphasized">New</span> `.btn-brand` is now available.
...
- <span class="badge text-bg-status-warning-emphasized">Warning</span> `.rounded-small` and `.rounded-medium` have been updated to respectively 4px and 8px. All components have been updated accordingly. It shouldn’t bother you too much since it’s handled on OUDS Web side.
...
- <span class="badge text-bg-status-positive-emphasized">New</span> Badges components has been implemented.
