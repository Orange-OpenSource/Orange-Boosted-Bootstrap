...
- <span class="tag tag-small rounded-none tag-positive">New</span> Tag component has been implemented.

### Helpers

#### Color background

- <span class="tag tag-small rounded-none tag-positive">New</span> `.text-bg-opacity-lower` and `.text-bg-opacity-lowest` color-background color helpers are now available. Visit our [color-bg page]([[docsref:/helpers/color-background]]) to see more.
...
- <span class="tag tag-small rounded-none tag-positive">New</span> We provide four brand new themes that are <code>light</code>, <code>dark</code>,  <code>root</code> and <code>root-inverted</code>. See more on our [color modes page]([[docsref:/customize/color-modes]])
