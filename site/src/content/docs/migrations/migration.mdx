...
- <span class="tag tag-small rounded-none tag-positive">New</span> Select Input has been implemented. Read more in our [text area page]([[docsref:/forms/select-input]]).
...
- <span class="tag tag-small rounded-none tag-positive">New</span> `.shadow-sticky` shadow utility have been added. Visit our [shadows page]([[docsref:/utilities/shadows]]) to read more.

- <span class="tag tag-small rounded-none tag-negative">Breaking</span> `.shadow-sticky-default`, `.shadow-sticky-emphasized` and `.shadow-sticky-navigation-scrolled` shadow utilities have been removed. Visit our [shadows page]([[docsref:/utilities/shadows]]) to read more.
...
- <span class="tag tag-small rounded-none tag-positive">New</span> We provide four brand new themes that are <code>light</code>, <code>dark</code>,  <code>root</code> and <code>root-inverted</code>. Read more on our [color modes page]([[docsref:/customize/color-modes]])
...
- <span class="tag tag-small rounded-none tag-positive">New</span> The new color-background color helpers are now available. Visit our [color-bg page]([[docsref:/helpers/color-background]]) to read more.
...
- <span class="tag tag-small rounded-none tag-positive">New</span> The new border color utilities are now available. Visit our [border page]([[docsref:/utilities/borders#color]]) to read more.

#### Colors

- <span class="tag tag-small rounded-none tag-positive">New</span> The new text color utilities are now available. Visit our [color page]([[docsref:/utilities/colors]]) to read more.
