...
- <span class="tag tag-small rounded-none tag-positive">New</span> Text input has been implemented. See more in our [text input page]([[docsref:/forms/text-input]]).
...
- <span class="tag tag-small rounded-none tag-positive">New</span> Tags components have been implemented. See more in our [tags page]([[docsref:/components/tags]]).
...
- <span class="tag tag-small rounded-none tag-warning">Warning</span> Opacity levels values have been changed, please check [opacity page]([[docsref:/utilities/opacity]]).
