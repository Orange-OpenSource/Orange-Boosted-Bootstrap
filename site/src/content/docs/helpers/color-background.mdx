...
<Example buttonLabel="opacity backgrounds" code={`<p class="text-bg-opacity-lower p-lg fw-bold">.text-bg-opacity-lower</p>
  <p class="text-bg-opacity-lowest p-lg fw-bold">.text-bg-opacity-lowest</p>`} />
