...
<Example buttonLabel="vertical" class="bd-example-flex" code={`<div class="vstack gap-lg">
...
<Example buttonLabel="horizontal" class="bd-example-flex" code={`<div class="hstack gap-lg">
    <div class="p-sm">First item</div>
    <div class="p-sm">Second item</div>
    <div class="p-sm">Third item</div>
  </div>`} />
...
<Example buttonLabel="horizontal with `.ms-auto`" class="bd-example-flex" code={`<div class="hstack gap-lg">
    <div class="p-sm">First item</div>
...
<Example buttonLabel="horizontal with `.ms-auto` and vertical rule" class="bd-example-flex" code={`<div class="hstack gap-lg">
    <div class="p-sm">First item</div>
    <div class="p-small ms-auto">Second item</div>
    <div class="vr"></div>
    <div class="p-sm">Third item</div>
...
<Example buttonLabel="inline form with horizontal stack" code={`<div class="hstack gap-lg">
