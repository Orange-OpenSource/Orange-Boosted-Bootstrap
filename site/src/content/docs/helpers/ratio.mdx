...
<Example buttonLabel="ratio" code={`<div class="ratio ratio-16x9">
...
<Example buttonLabel="aspect ratio" class="bd-example-ratios" code={`<div class="ratio ratio-9x16">
    <div>9x16</div>
  </div>
...
<Example buttonLabel="custom ratio" class="bd-example-ratios" code={`<div class="ratio" style="--bs-aspect-ratio: 50%;">
    <div>2x1</div>
  </div>`} />
...
<Example buttonLabel="--bs-aspect-ratio example" class="bd-example-ratios bd-example-ratios-breakpoint" code={`<div class="ratio ratio-4x3">
