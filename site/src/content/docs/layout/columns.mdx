...
The classes can be used together with utilities to create responsive floated images. Make sure to wrap the content in a [`.clearfix`]([[docsref:/utilities/clearfix]]) wrapper to clear the float if the text is shorter.
