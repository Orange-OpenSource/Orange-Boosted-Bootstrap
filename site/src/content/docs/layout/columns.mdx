...
<Example class="bd-example-row" code={`<div class="col-3 p-large mb-sm">
    .col-3: width of 25%
  </div>
...
<Example code={`<div class="clearfix">
    <Placeholder width="100%" height="210" class="col-md-6 float-md-end mb-large ms-md-lg" text="Responsive floated image" color="#999" />
