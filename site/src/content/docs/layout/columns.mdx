...
Move columns to the right using `.{breakpoint}:offset-*` classes. These classes increase the left margin of a column by `*` columns. For example, `.md:offset-4` moves `.md:col-4` over four columns.
