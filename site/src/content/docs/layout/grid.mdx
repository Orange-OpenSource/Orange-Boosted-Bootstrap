...
<Example class="bd-example-row" code={`<div class="container-fluid text-center">
    <div class="row">
      <div class="sm:col-8">col-sm-8</div>
      <div class="sm:col-4">col-sm-4</div>
    </div>
    <div class="row">
      <div class="sm:col">col-sm</div>
      <div class="sm:col">col-sm</div>
      <div class="sm:col">col-sm</div>
    </div>
  </div>`} />
...
<Example class="bd-example-row" code={`<div class="container-fluid text-center">
    ...
    <div class="row">
      <div class="md:col-8">.col-md-8</div>
      <div class="col-6 md:col-4">.col-6 .col-md-4</div>
    </div>
