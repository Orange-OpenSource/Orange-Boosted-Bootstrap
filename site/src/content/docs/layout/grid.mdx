...
<div class="table-responsive">
  <table class="table mb-2xlarge">
    <thead>
      <tr>
        <th scope="col"></th>
        <th scope="col">2xs<br /><span class="fw-normal">&lt;{getTokenValue('$ouds-grid-xs-min-width')}</span></th>
        <th scope="col">xs<br /><span class="fw-normal">&ge;{getTokenValue('$ouds-grid-xs-min-width')}</span></th>
        <th scope="col">sm<br /><span class="fw-normal">&ge;{getTokenValue('$ouds-grid-sm-min-width')}</span></th>
        <th scope="col">md<br /><span class="fw-normal">&ge;{getTokenValue('$ouds-grid-md-min-width')}</span></th>
        <th scope="col">lg<br /><span class="fw-normal">&ge;{getTokenValue('$ouds-grid-lg-min-width')}</span></th>
        <th scope="col">xl<br /><span class="fw-normal">&ge;{getTokenValue('$ouds-grid-xl-min-width')}</span></th>
        <th scope="col">2xl<br /><span class="fw-normal">&ge;{getTokenValue('$ouds-grid-2xl-min-width')}</span></th>
        <th scope="col">3xl<br /><span class="fw-normal">&ge;{getTokenValue('$ouds-grid-3xl-min-width')}</span></th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <th class="text-nowrap" scope="row">Container fluid <code class="fw-normal">max-width</code></th>
        <td>100vw -<br />(2 * {getTokenValue('$ouds-grid-2xs-margin')})</td>
        <td>100vw -<br />(2 * {getTokenValue('$ouds-grid-xs-margin')})</td>
        <td>100vw -<br />(2 * {getTokenValue('$ouds-grid-sm-margin')})</td>
        <td>100vw -<br />(2 * {getTokenValue('$ouds-grid-md-margin')})</td>
        <td>100vw -<br />(2 * {getTokenValue('$ouds-grid-lg-margin')})</td>
        <td>100vw -<br />(2 * {getTokenValue('$ouds-grid-xl-margin')})</td>
        <td>100vw -<br />(2 * {getTokenValue('$ouds-grid-2xl-margin')})</td>
        <td>100vw -<br />(2 * {getTokenValue('$ouds-grid-3xl-margin')})</td>
      </tr>
      <tr>
        <th class="text-nowrap" scope="row">Class prefix</th>
        <td><code>.col-</code></td>
        <td><code>.xs:col-</code></td>
        <td><code>.sm:col-</code></td>
        <td><code>.md:col-</code></td>
        <td><code>.lg:col-</code></td>
        <td><code>.xl:col-</code></td>
        <td><code>.2xl:col-</code></td>
        <td><code>.3xl:col-</code></td>
      </tr>
      <tr>
        <th class="text-nowrap" scope="row"># of columns</th>
        <td colspan="8">{getTokenValue('$core-ouds-grid-column-count-1200')}</td>
      </tr>
      <tr>
        <th class="text-nowrap" scope="row">Container padding width</th>
        <td>{getTokenValue('$ouds-grid-2xs-margin')} (each side)</td>
        <td>{getTokenValue('$ouds-grid-xs-margin')} (each side)</td>
        <td>{getTokenValue('$ouds-grid-sm-margin')} (each side)</td>
        <td>{getTokenValue('$ouds-grid-md-margin')} (each side)</td>
        <td>{getTokenValue('$ouds-grid-lg-margin')} (each side)</td>
        <td>{getTokenValue('$ouds-grid-xl-margin')} (each side)</td>
        <td>{getTokenValue('$ouds-grid-2xl-margin')} (each side)</td>
        <td>{getTokenValue('$ouds-grid-3xl-margin')} (each side)</td>
      </tr>
      <tr>
        <th class="text-nowrap" scope="row">Gutter width</th>
        <td>{getTokenValue('$ouds-grid-2xs-column-gap')}</td>
        <td colspan="2">{getTokenValue('$ouds-grid-xs-column-gap')}</td>
        <td colspan="2">{getTokenValue('$ouds-grid-md-column-gap')}</td>
        <td colspan="2">{getTokenValue('$ouds-grid-xl-column-gap')}</td>
        <td colspan="1">{getTokenValue('$ouds-grid-3xl-column-gap')}</td>
      </tr>
      <tr>
...
Includes support for xxl breakpoint, defined like 2xl. Bootstrap responsive classes use an infix to target the breakpoint.
  ...
  <table class="table mb-2xlarge">
    <thead>
      <tr>
        ...
        <th scope="col">lg<br /><span class="fw-normal">&ge;{getTokenValue('$ouds-grid-lg-min-width')}</span></th>
        <th scope="col">xl<br /><span class="fw-normal">&ge;{getTokenValue('$ouds-grid-xl-min-width')}</span></th>
        <th scope="col">2xl or xxl<br /><span class="fw-normal">&ge;{getTokenValue('$ouds-grid-2xl-min-width')}</span></th>
        <th scope="col">3xl<br /><span class="fw-normal">&ge;{getTokenValue('$ouds-grid-3xl-min-width')}</span></th>
      </tr>
    </thead>
    <tbody>
      <tr>
        ...
        <td>100vw -<br />(2 * {getTokenValue('$ouds-grid-2xs-margin')})</td>
        <td>342px</td>
        <td>4{getTokenValue('$ouds-grid-md-column-gap')}</td>
        <td>672px</td>
        <td>944px</td>
        <td>1208px</td>
        <td>1{getTokenValue('$ouds-grid-sm-min-width')}</td>
        <td>1656px</td>
      </tr>
      <tr>
        <th class="text-nowrap" scope="row">Class prefix</th>
