...
<Callout type="warning">
  **Our CSS Grid system is experimental and opt-in!** We included it in our documentation’s CSS to demonstrate it for you, but it’s disabled by default. Keep reading to learn how to enable it in your projects.
</Callout>
...
<Example class="bd-example-cssgrid" code={`<div class="grid text-center">
    <div class="g-col-6 md:g-col-4">.g-col-6 .g-col-md-4</div>
    <div class="g-col-6 md:g-col-4">.g-col-6 .g-col-md-4</div>
    <div class="g-col-6 md:g-col-4">.g-col-6 .g-col-md-4</div>
  </div>`} />
...
- In the second auto-column, we’ve reset the column count on the nested `.grid` to {getTokenValue('$ouds-grid-3xl-column-count')} (our default).
