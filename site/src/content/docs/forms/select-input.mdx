...
By default select inputs will span the whole width of their parent container, to limit the width of the select input on wider parent container, add a `.max-width` to the `.text-input` container.

<Example code={`<div class="select-input max-width">
    <div class="select-input-container">
