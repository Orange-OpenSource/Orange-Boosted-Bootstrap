...
You can find here the [OUDS Select Input design guidelines](https://unified-design-system.orange.com/).
</Callout>
...
<Example buttonLabel="rounded selects" code={`<div class="select-input mb-medium">
    <div class="select-input-container select-input-container-rounded">
  ...
  <div class="select-input">
    <div class="select-input-container select-input-container-outlined select-input-container-rounded">
...
<Example buttonLabel="loading selects" code={`<div class="select-input mb-medium">
    <div class="select-input-container">
      ...
      <select disabled class="select-input-field loading-indeterminate" id="exampleDisabledLoadingSelect">
        <option value="" disabled selected></option>
        <option value="1">One</option>
        <option value="2">Two</option>
        <option value="3">Three</option>
      ...
      <span role="status" id="loading-msg-0" class="loading-message">Loading message</span>
    </div>
  </div>
  <div class="select-input mb-medium">
    <div class="select-input-container" style="--bs-loading-time: 5s;">
      ...
      <select class="select-input-field loading-determinate" id="exampleLoadingSelect">
        <option value="" disabled selected></option>
        <option value="1">One</option>
        <option value="2">Two</option>
        <option value="3">Three</option>
      ...
      <span role="status" id="loading-msg-1" class="loading-message">Loading message</span>
    </div>
  </div>
  <div class="select-input">
    <div class="select-input-container">
      ...
      <select class="select-input-field loading-indeterminate" id="exampleIndeterminateLoadingSelect">
        <option value="" disabled></option>
        <option value="1">One</option>
        <option value="2" selected>Two</option>
        <option value="3">Three</option>
      ...
      <span role="status" id="loading-msg-2" class="loading-message">Loading message</span>
    </div>
  </div>`} />
