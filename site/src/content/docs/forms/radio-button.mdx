...
<Example code={`<fieldset class="control-items-list" role="radiogroup" aria-readonly="true">
    <div class="radio-button-item">
      <div class="control-item-assets-container">
...
To display an invalid radio button, add `.is-invalid` to a `.control-item-indicator`. Please take a look at our [Validation page to learn more]([[docsref:/forms/validation]]).
...
<Example code={`<ul class="control-items-list">
    <li class="radio-button-item">
      <div class="control-item-assets-container">
        <input class="control-item-indicator is-invalid" type="radio" value="" name="radioInvalidUl" id="radioInvalidUl" aria-describedby="radioInvalidUlExtraLabel radioInvalidUlDescription radioInvalidUlErrorText" />
      </div>
      <div class="control-item-text-container">
        <label class="control-item-label" for="radioInvalidUl">Default invalid radio button</label>
        <p class="radio-button-extra-label" id="radioInvalidUlExtraLabel">Extra label</p>
        <p class="control-item-description" id="radioInvalidUlDescription">Description text</p>
      </div>
    </li>
    <li class="radio-button-item">
      <div class="control-item-assets-container">
        <input class="control-item-indicator is-invalid" type="radio" value="" name="radioInvalidUl" id="radioInvalidUl2" aria-describedby="radioInvalidUl2Description radioInvalidUlErrorText" checked />
      </div>
      <div class="control-item-text-container">
        <label class="control-item-label" for="radioInvalidUl2">Checked invalid radio button</label>
        <p class="control-item-description" id="radioInvalidUl2Description">Description text</p>
      </div>
    </li>
  </ul>
  <p class="control-item-error-message" id="radioInvalidUlErrorText">You must choose one.</p>`} />

## Fieldset `<legend>`

If radio buttons belong to a group (e.g., in a form), provide clear context by adding a `<legend>` element inside the `<fieldset>` for the group title. Then, screen readers will read the legend before navigating through the radio buttons.
