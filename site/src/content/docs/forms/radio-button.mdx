...
<Example code={`<div class="radio-button-item">
  ...
  <div class="radio-button-item">
    <div class="control-item-assets-container">
      <input class="control-item-indicator" type="radio" value="" id="radioWithDescription2" aria-describedby="radioExtraLabel2 radioDescription2" name="radioTextDescription" checked />
    </div>
    <div class="control-item-text-container">
