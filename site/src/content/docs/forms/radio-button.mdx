...
<Example addStackblitzJs code={`<div class="radio-button-item">
    <div class="control-item-assets-container">
...
<BootstrapCompatibility>
<Example addStackblitzJs code={`<div class="form-check">
...
<Example addStackblitzJs code={`<div role="radiogroup" aria-readonly="true">
    <div class="radio-button-item">
      <div class="control-item-assets-container">
