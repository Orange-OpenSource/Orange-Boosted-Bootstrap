...
<Example code={`<div class="quantity-selector">
...
<Example code={`<div class="quantity-selector quantity-selector-sm">
...
<ScssDocs name="quantity-selector" file="scss/_variables.scss" />
