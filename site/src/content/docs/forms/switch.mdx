...
They are implemented using `.control-item-*` classes, [see below](#control-item). Browser default checkboxes are replaced with the help of `.control-item-indicator[role="switch"]`.
...
As switch items can be used inside a list or a form, but also in a standalone way, there is several way to group them. You can use a `<fieldset>` container if they are in a form, with an optional `<legend>` ([read more here](group)), you can also use a `<ul>` (like most of the examples in this page). For both these solutions please add a `.control-items-list` class on the list container.

For automatic error handling you need either to group switch items inside `<fieldset>`s with a `.control-items-list` class or enclose a single switch item in a `.switch-item-container`, read more in the [invalid state section](#invalid).
...
<Callout type="warning">
  The `.control-item-assets-container` containing the icon *must be the last child* of the `.switch-item`, the flow of the item is reversed by CSS to work like other control items.
</Callout>
...
To automatically display a error text on a single switch item, enclose it inside a `.switch-item-container` and  add a `.control-item-error-message` as a sibling of the `.switch-item`.

<Example code={`<div class="switch-item-container">
    <div class="switch-item control-item-divider">
      <div class="control-item-assets-container">
        <input class="control-item-indicator is-invalid" type="checkbox" role="switch" value="" id="switchInvalid" aria-describedby="switchInvalidDescription" checked />
      </div>
      <div class="control-item-text-container">
    ...
    <p class="control-item-error-message" id="checkboxInvalidErrorText">Cannot be activated at this time.</p>
  </div>`} />
...
<Example code={`<ul class="list-unstyled">
    <li class="switch-item-container">
      <div class="switch-item control-item-divider">
        <div class="control-item-assets-container">
          <input class="control-item-indicator is-invalid" type="checkbox" role="switch" value="" id="switchInvalidUl" aria-describedby="switchInvalidUlDescription" checked />
        </div>
        <div class="control-item-text-container">
      ...
      <p class="control-item-error-message mb-xsmall" id="checkboxInvalidErrorText">Cannot be activated at this time.</p>
    </li>
    <li class="switch-item-container">
      <div class="switch-item control-item-divider">
        <div class="control-item-assets-container">
          <input class="control-item-indicator" type="checkbox" role="switch" value="" id="switchInvalidUl2" aria-describedby="switchInvalidUl2Description" checked />
        </div>
        <div class="control-item-text-container">
...
<Example code={`<fieldset class="control-items-list">
    <div class="switch-item">
      <div class="control-item-assets-container">
        <input class="control-item-indicator is-invalid" type="checkbox" role="switch" value="" id="switchInvalidFieldset" aria-describedby="switchInvalidFieldsetDescription" />
      </div>
      <div class="control-item-text-container">
    ...
    <div class="switch-item">
      <div class="control-item-assets-container">
        <input class="control-item-indicator is-invalid" type="checkbox" role="switch" value="" id="switchInvalidFieldset2" aria-describedby="switchInvalidFieldset2Description" checked />
      </div>
      <div class="control-item-text-container">
