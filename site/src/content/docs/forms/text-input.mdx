...
To display a helper link below inputs, add a `.text-input-helper-link` as a sibling of a `.text-input-container`.
...
<Example code={`<div class="text-input-container">
  ...
  <a href="#" class="text-input-helper-link">
    More information
  </a>
  ...
  <a href="#" id="feedbackTextHelpLink" class="text-input-helper-link">
    More information
  </a>`} />
...
<Example code={`<div class="text-input-container">
    ...
    <div class="input-container" data-prefix="https://">
  ...
  <div class="text-input-container mt-md">
    ...
    <div class="input-container" data-prefix="£" data-suffix="€">
...
<Example code={`<div class="text-input-container">
  ...
  <div id="addressFeedback" class="text-input-error">
   ...
   <div class="text-input-container text-input-container mt-md">
    ...
    <div class="input-container" data-prefix="£" data-suffix="€">
      <input type="text" class="text-input  is-invalid" id="exampleTextInputInvalidTrailingWithPrefixSuffix" value="-2.2XX" placeholder="">
    </div>
    <button class="btn btn-minimal btn-icon">
      <svg aria-hidden="true">
