...
Add an icon to help indicate the purpose of the input by placing an `<svg>` or `<img>` element inside the `.form-control-item`. The icon is automatically positioned at the left side of the input field.
...
<Example code={`<div class="form-control-item mb-3">
    ...
    <input type="email" class="form-control" id="exampleFormControlInputEmptyWithIcon" placeholder="">
    <label for="exampleFormControlInputEmptyWithIcon">Label</label>
  </div>
  <div class="form-control-item mb-3">
    <svg aria-hidden="true">
      <use xlink:href="/docs/${getConfig().docs_version}/assets/img/ouds-web-sprite.svg#heart-recommend"/>
    </svg>
    <input type="email" class="form-control" id="exampleFormControlInputPlaceholderWithIcon" placeholder="placehoder">
    <label for="exampleFormControlInputPlaceholderWithIcon">Label</label>
  </div>
  <div class="form-control-item mb-3">
    <svg aria-hidden="true">
      <use xlink:href="/docs/${getConfig().docs_version}/assets/img/ouds-web-sprite.svg#heart-recommend"/>
    </svg>
    <input type="email" class="form-control form-control-alternative" id="exampleFormControlInputAltEmptyWithIcon" placeholder="">
    <label for="exampleFormControlInputAltEmptyWithIcon">Label</label>
  </div>
  <div class="form-control-item mb-3">
    <svg aria-hidden="true">
      <use xlink:href="/docs/${getConfig().docs_version}/assets/img/ouds-web-sprite.svg#heart-recommend"/>
    </svg>
    <input type="email" class="form-control form-control-alternative" id="exampleFormControlInputAltValueWithIcon" placeholder="placehoder" value="Input">
    <label for="exampleFormControlInputAltValueWithIcon">Label</label>
  </div>`} />

### Trailing action

Trailing actions can be added to the right side of the input field by placing a minimal icon only button (`.btn`, `.btn-minimal` and `.btn-icon`) inside the `.form-control-item`. It can be used to provide actions related to the field: clear input, toggle password visibility, open a date picker, etc.

<Example code={`<div class="form-control-item mb-3">
    <input type="email" class="form-control" id="exampleFormControlInputEmptyWithAction" placeholder="">
    <label for="exampleFormControlInputEmptyWithAction">Label</label>
