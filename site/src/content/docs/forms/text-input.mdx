...
<Example code={`<div class="text-input mb-medium">
    ...
    <a href="#" id="feedbackTextHelpMore" class="link link-small">
      More information <span class="visually-hidden">about the expected feedback</span>
    </a>
  </div>
  <div class="text-input">
    <div class="text-input-container">
      <label for="inputTextWithHelperLink">Send your feedback</label>
      <input type="text" id="inputTextWithHelperLink" aria-describedby="feedbackTextHelpLink" aria-labelledby="labelTextWithHelperLink feedbackTextHelpLink" class="text-input-field" placeholder=" ">
    </div>
...
<Example code={`<div class="text-input mb-medium">
  ...
  <div class="text-input">
    <div class="text-input-container">
      ...
      <div class="input-container" data-bs-prefix="£" data-bs-suffix=".00">
        <input type="text" class="text-input-field is-invalid" id="exampleTextInputInvalidTrailingWithPrefixSuffix" value="-2.2XX" aria-describedby="invalidPrice" aria-labelledby="labelTextInputInvalidTrailingWithPrefixSuffix priceTextHelpLink" placeholder=" ">
      </div>
      <button class="btn btn-minimal btn-icon">
        <svg aria-hidden="true">
    ...
    <a href="#" id="priceTextHelpLink" class="link link-small">
      More information <span class="visually-hidden"> about the price to enter</span>
    </a>
  </div>`} />
