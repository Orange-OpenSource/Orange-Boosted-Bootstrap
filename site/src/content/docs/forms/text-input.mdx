...
<Example code={`<div class="text-input-container">
    ...
    <div class="input-container" data-bs-prefix="https://">
      <input type="text" id="inputTextWithPrefix" aria-describedby="prefixTextHelpBlock" class="text-input" placeholder="">
    </div>
  </div>
  ...
  <div class="text-input-container mt-md">
    ...
    <div class="input-container" data-bs-suffix="€">
      <input type="text" id="inputTextWithSuffix" aria-describedby="suffixTextHelpBlock" class="text-input" placeholder="">
    </div>
  </div>
