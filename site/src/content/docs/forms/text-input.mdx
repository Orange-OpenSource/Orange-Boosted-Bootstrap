...
<Callout type="warning">
Helper link should be explicitly described using the `aria-describedby` attribute in which you must combine the helper link id and the related text input label id. This will ensure that assistive technologies—such as screen readers—will announce this helper link in relation with the input. We also recommend adding a `.visually-hidden` span inside the link to provide additional context about the link purpose in relation with the input.
</Callout>
...
<Example code={`<div class="text-input mb-medium">
    ...
    <a href="#" id="feedbackTextHelpMore" aria-describedby="feedbackTextHelpMore labelTextWithHelperTextLink" class="link link-small">
      More information <span class="visually-hidden">on sending feedback</span>
    </a>
  </div>
  <div class="text-input">
    <div class="text-input-container">
    ...
    <a href="#" id="feedbackTextHelpLink" aria-describedby="feedbackTextHelpLink labelTextWithHelperLink" class="link link-small">
      More information <span class="visually-hidden">on sending feedback</span>
    </a>
  </div>`} />
...
<Example code={`<div class="text-input mb-medium">
  ...
  <div class="text-input">
    ...
    <a href="#" id="priceTextHelpLink" aria-describedby="priceTextHelpLink labelTextInputInvalidTrailingWithPrefixSuffix" class="link link-small">
      More information <span class="visually-hidden">on price</span>
    </a>
  </div>`} />
