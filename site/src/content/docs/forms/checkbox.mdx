...
This is often used to indicate a partial selection within a group of choices. For instance, in a nested (hierarchical) list, a parent checkbox can be indeterminate if some, but not all, sub-options are selected. [Lear more about nesting in the design guidelines](https://unified-design-system.orange.com/472794e18/p/23f1c1-checkbox/t/15b9a5fddb).
...
You can reverse the component simply by adding `.control-item-reverse` to a `.checkbox-item`.
