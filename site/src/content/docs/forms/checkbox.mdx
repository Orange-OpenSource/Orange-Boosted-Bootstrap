...
<Example code={`<div class="control-items-list">
...
<Example code={`<div class="row">
    <div class="control-items-list col-8 col-md-6 col-xl-5">
      <div class="checkbox-item control-item-divider">
        <div class="control-item-assets-container">
...
<Example class="bd-example-indeterminate" addStackblitzJs code={`<div class="control-items-list">
    <div class="checkbox-item">
      <div class="control-item-assets-container">
...
<Example class="bd-example-indeterminate" addStackblitzJs code={`<ul class="control-items-list">
    ...
    <li class="control-item-error-message" id="checkboxInvalidErrorText">Incompatible choices.</li>
  </ul>`} />
...
<Example code={`<div class="row">
    <fieldset class="control-items-list col-md-6">
