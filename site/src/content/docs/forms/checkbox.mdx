...
It is best practice to provide clear context by adding a `<legend>` element inside a `<fieldset>` for the checkbox group title. Then, screen readers will read the legend before navigating through the checkboxes.
