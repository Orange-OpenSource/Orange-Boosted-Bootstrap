...
Users cannot set a checkbox as indeterminate directly. This must be calculated by the system and set via JavaScript (there is no available HTML attribute available for specifying it). Then, checkboxes use the `:indeterminate` pseudo class for styling.
  ...
  <Example class="bd-example-indeterminate" stackblitz_add_js="true" code={`<div class="checkbox-item">
  <div class="control-item-assets-container">
...
```
  ...
  <BootstrapCompatibility>
  <Example class="bd-example-indeterminate" stackblitz_add_js="true" code={`<div class="form-check">
...
<Example code={`<div class="checkbox-item control-item-reverse">
    <div class="control-item-assets-container">
...
<BootstrapCompatibility>
<Example class="bd-example-indeterminate" stackblitz_add_js="true" code={`
  <div class="form-check">
...
<Example class="bd-example-indeterminate" code={`<div class="checkbox-item">
    <div class="control-item-assets-container">
  ...
  <div class="checkbox-item">
    <div class="control-item-assets-container">
      <input class="control-item-indicator is-invalid" type="checkbox" value="" id="checkboxInvalid2" checked />
    </div>
    <div class="control-item-text-container">
  ...
  <div class="checkbox-item">
    <div class="control-item-assets-container">
      <input class="control-item-indicator is-invalid" type="checkbox" value="" id="checkboxInvalidIndeterminate" />
    </div>
    <div class="control-item-text-container">
