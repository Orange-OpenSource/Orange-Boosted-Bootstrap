...
They are implemented using `.control-item-*` classes, [see below](#control-item). Browser default checkboxes are replaced with the help of the selector `.control-item-indicator[type="checkbox"]`.
...
<Example code={`<div class="d-lg-flex flex-row gap-small">
    <div class="checkbox-item flex-fill">
      <div class="control-item-assets-container">
        <input class="control-item-indicator" type="checkbox" value="" id="checkboxLayoutRow1" name="checkboxLayoutRow" aria-describedby="checkboxLayoutRow1ExtraLabel checkboxLayoutRow1Description" />
      </div>
      <div class="control-item-text-container">
    ...
    <div class="checkbox-item flex-fill">
      <div class="control-item-assets-container">
        <input class="control-item-indicator" type="checkbox" value="" id="checkboxLayoutRow2" name="checkboxLayoutRow"  aria-describedby="checkboxLayoutRow2ExtraLabel checkboxLayoutRow2Description" checked />
      </div>
      <div class="control-item-text-container">
    ...
    <div class="checkbox-item flex-fill">
      <div class="control-item-assets-container">
        <input class="control-item-indicator" type="checkbox" value="" id="checkboxLayoutRow3" name="checkboxLayoutRow"  aria-describedby="checkboxLayoutRow3ExtraLabel checkboxLayoutRow3Description" checked />
      </div>
      <div class="control-item-text-container">
