...
<Example code={`<fieldset class="control-items-list">
    <div class="d-lg-flex flex-row gap-small">
      <div class="checkbox-item flex-fill">
        <div class="control-item-assets-container">
          <input class="control-item-indicator" type="checkbox" value="" id="checkboxLayoutRow1" name="checkboxLayoutRow" />
        </div>
        <div class="control-item-text-container">
      ...
      <div class="checkbox-item flex-fill">
        <div class="control-item-assets-container">
          <input class="control-item-indicator" type="checkbox" value="" id="checkboxLayoutRow2" name="checkboxLayoutRow" checked />
        </div>
        <div class="control-item-text-container">
      ...
      <div class="checkbox-item flex-fill">
        <div class="control-item-assets-container">
          <input class="control-item-indicator" type="checkbox" value="" id="checkboxLayoutRow3" name="checkboxLayoutRow" checked />
        </div>
        <div class="control-item-text-container">
          <label class="control-item-label" for="checkboxLayoutRow3">Option 2</label>
        </div>
      </div>
    </div>
  </fieldset>`} />
...
<Example class="bd-example-indeterminate" addStackblitzJs code={`<fieldset class="control-items-list">
    <div class="checkbox-item">
      <div class="control-item-assets-container">
...
<Example code={`<fieldset class="control-items-list">
    <div class="d-flex flex-row gap-small w-50">
      <div class="checkbox-item flex-fill">
        <div class="control-item-assets-container">
          <input class="control-item-indicator is-invalid" type="checkbox" value="" id="checkboxLayoutRowInvalid1" name="checkboxLayoutRowInvalid" aria-describedby="checkboxLayoutRowInvalidErrorText" />
        </div>
        <div class="control-item-text-container">
      ...
      <div class="checkbox-item flex-fill">
        <div class="control-item-assets-container">
          <input class="control-item-indicator is-invalid" type="checkbox" value="" id="checkboxLayoutRowInvalid2" name="checkboxLayoutRowInvalid" aria-describedby="checkboxLayoutRowInvalidErrorText" />
        </div>
        <div class="control-item-text-container">
...
It is possible to use a `<ul>` instead of `<fieldset>` but you will need to handle the error message display as it will not be hidden by default. The error message must be outside of the list as it not a list item.

<Example class="bd-example-indeterminate" addStackblitzJs code={`<ul class="control-items-list">
    <li class="checkbox-item control-item-divider">
      ...
      <div class="control-item-text-container">
        <label class="control-item-label" for="checkboxInvalidUl">Default invalid checkbox</label>
    ...
    <li class="checkbox-item control-item-divider">
      ...
      <div class="control-item-text-container">
        <label class="control-item-label" for="checkboxInvalidUl2">Checked invalid checkbox</label>
...
It is best practice to provide clear context by adding a `<legend>` element inside the `<fieldset>` for the checkbox group title. Then, screen readers will read the legend before navigating through the checkboxes.
      ...
      <fieldset class="control-items-list">
        ...
        <div class="checkbox-item control-item-divider">
          ...
          <div class="control-item-text-container">
            ...
            <p class="control-item-description" id="checkboxGroup1Description">Description</p>
          </div>
          <div class="control-item-assets-container">
            <svg aria-hidden="true">
              <use xlink:href="${getVersionedDocsPath('/assets/img/ouds-web-sprite.svg#heart-empty')}" />
