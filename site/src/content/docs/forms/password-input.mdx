...
<Example code={`<div class="text-input mb-medium">
    <div class="text-input-container">
      ...
      <input type="password" aria-describedby="inputPassword" class="text-input-field" placeholder="">
  ...
  <div class="text-input mb-medium">
    <div class="text-input-container">
      ...
      <input type="password" aria-describedby="inputPasswordIcon" class="text-input-field" placeholder="Minimum 8 characters">
      <button class="btn btn-minimal btn-icon">
        <svg aria-hidden="true">
          <use xlink:href="${getVersionedDocsPath('/assets/img/ouds-web-sprite.svg#accessibility-vision')}"/>
        </svg>
  ...
  <div class="text-input mb-medium">
    <div class="text-input-container">
      ...
      <div class="input-container" data-bs-prefix="DEV-">
        <input type="password" aria-describedby="inputPasswordPrefix" class="text-input-field" placeholder="">
      </div>
      <button class="btn btn-minimal btn-icon">
        <svg aria-hidden="true">
          <use xlink:href="${getVersionedDocsPath('/assets/img/ouds-web-sprite.svg#accessibility-vision')}"/>
  ...
  <div class="text-input mb-medium">
    <div class="text-input-container text-input-container-outlined">
      ...
      <input type="password" aria-describedby="inputPasswordOutlined" class="text-input-field" placeholder="">
      <button class="btn btn-minimal btn-icon">
        <svg aria-hidden="true">
          <use xlink:href="${getVersionedDocsPath('/assets/img/ouds-web-sprite.svg#accessibility-vision')}"/>
        </svg>
   ...
   <div class="text-input mb-medium">
    <div class="text-input-container text-input-container-outlined">
      ...
      <input type="password" aria-describedby="inputPasswordOutlinedValue" class="text-input-field" placeholder="" value="My$ecureP@ssw0rd">
      <button class="btn btn-minimal btn-icon">
        <svg aria-hidden="true">
          <use xlink:href="${getVersionedDocsPath('/assets/img/ouds-web-sprite.svg#accessibility-vision')}"/>
        </svg>
  ...
  <div class="text-input mb-medium">
    <div class="text-input-container">
      ...
      <div class="input-container" data-bs-prefix="DEV-">
        <input type="password" class="text-input-field is-invalid" aria-describedby="inputPasswordInvalid" placeholder="" value="12345">
      </div>
      <button class="btn btn-minimal btn-icon">
        <svg aria-hidden="true">
          <use xlink:href="${getVersionedDocsPath('/assets/img/ouds-web-sprite.svg#accessibility-vision')}"/>
  ...
  <div class="text-input">
    <div class="text-input-container text-input-container-outlined">
      ...
      <div class="input-container" data-bs-prefix="DEV-">
        <input type="password" class="text-input-field is-invalid" aria-describedby="inputPasswordOutlinedInvalid" placeholder="" value="12345">
      </div>
      <button class="btn btn-minimal btn-icon">
        <svg aria-hidden="true">
          <use xlink:href="${getVersionedDocsPath('/assets/img/ouds-web-sprite.svg#accessibility-vision')}"/>
