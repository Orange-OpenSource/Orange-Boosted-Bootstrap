  ...
  headingLevel.map((level) => (
    <tr>
      <td>
        ...
        {level === 'heading-large' && (<>Heading xlarge (<code>{'<h2></h2>'}</code>)</>)}
        {level === 'heading-medium' && (<>Heading xlarge (<code>{'<h3></h3>'}</code>)</>)}
        {level === 'heading-small' && (<>Heading xlarge (<code>{'<h4></h4>'}</code>)</>)}
        {level === 'body-large' && (<>Heading xlarge (<code>{'<h5></h5>'}</code>)</>)}
        {level === 'body-medium' && (<>Heading xlarge (<code>{'<h6></h6>'}</code>)</>)}
      </td>
      {
          screenSize.map((size) => (
          <td>
