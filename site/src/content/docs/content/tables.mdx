...
<br />
<DesignCalloutAlert>
These colored tables should not be used because they do not respect the [Orange Design System]([[config:ods.web]]) specifications as they are inherited from Bootstrap.
</DesignCalloutAlert>
...
<Example showMarkup={false} code={`<table class="table table-dark">
...
<Example showMarkup={false} code={`<table class="table table-striped table-bordered">
...
The selection behavior isn’t implemented yet. This feature will be delivered with [#410]([[config:repo]]/issues/410) as an example.
</Callout>
    ...
    <table class="table table-sm table-hover align-middle has-checkbox">
      ...
      <tbody>
        <tr>
          ...
          <td>
            <img src="/docs/${getConfig().docs_version}/assets/img/thumbnail.png" alt="Thumbnail" width="30" height="30" class="me-2 inline" />
            <span>Cell text</span>
          </td>
          <td>Cell text</td>
          <td>Cell text</td>
        ...
        <tr>
          ...
          <td>
            <svg width="1.875rem" height="1.875rem" class="me-2" aria-hidden="true">
              <use xlink:href="/docs/${getConfig().docs_version}/assets/img/boosted-sprite.svg#file-document"></use>
            </svg>
        ...
        <tr class="table-active">
          ...
          <td>
            <img src="/docs/${getConfig().docs_version}/assets/img/thumbnail.png" alt="Thumbnail" width="30" height="30" class="me-2" />
            <span>Cell text</span>
          </td>
          <td>Cell text</td>
          <td>Cell text</td>
...
<div class="table-responsive">
  <table class="table table-sm table-hover align-middle has-checkbox">
    ...
    <td>
      <img src="/docs/[[config:docs_version]]/assets/img/thumbnail.png" alt="Thumbnail" width="30" height="30" class="me-2" />
      Cell text
    </td>
    ...
    <td>
      <svg width="1.875rem" height="1.875rem" class="me-2" aria-hidden="true">
        <use xlink:href="/docs/[[config:docs_version]]/assets/img/boosted-sprite.svg#file-document"></use>
      </svg>
      <span class="visually-hidden">Document</span>
      Cell text
    </td>
        ...
        <tr>
          ...
          <td>
            <svg width="1.875rem" height="1.875rem" aria-hidden="true" class="text-success">
              <use xlink:href="/docs/${getConfig().docs_version}/assets/img/boosted-sprite.svg#tick"></use>
            </svg>
...
<div class="table-responsive">
  <table class="table align-middle">
    ...
    <td>
      <svg width="1.875rem" height="1.875rem" aria-hidden="true" class="text-success">
        <use xlink:href="/docs/[[config:docs_version]]/assets/img/boosted-sprite.svg#tick"></use>
      </svg>
      <span class="visually-hidden">Yes</span>
    </td>
    ...
