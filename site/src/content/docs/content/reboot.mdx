...
| Heading | Example |
| --- | --- |
| `<h1></h1>` | <div class="h1">h1. OUDS Web heading</div> |
| `<h2></h2>` | <div class="h2">h2. OUDS Web heading</div> |
| `<h3></h3>` | <div class="h3">h3. OUDS Web heading</div> |
| `<h4></h4>` | <div class="h4">h4. OUDS Web heading</div> |
| `<h5></h5>` | <div class="h5">h5. OUDS Web heading</div> |
| `<h6></h6>` | <div class="h6">h6. OUDS Web heading</div> |
</BsTable>
...
<Example buttonLabel="links on colored backgrounds" class="p-none" code={`<div class="colored-bg">
    <div class="bg-brand-primary p-large">
    ...
    <div class="bg-status-negative-emphasized p-large">
