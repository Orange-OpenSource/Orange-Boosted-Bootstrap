...
<Example code={`<p class="mw-none mb-none">This is an example paragraph which is long enough so it’s easy to see and compare the <code>max-width</code> in action and compare it to the one below.</p>
...
<Example code={`<a aria-disabled="true">This is an example of a disabled link</a>`} />
...
<Example code={`<div class="visited-links">
    <div>
...
<Example class="p-none" code={`<div class="colored-bg">
