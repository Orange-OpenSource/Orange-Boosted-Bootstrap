...
<Callout type="info">
  **This is the recommended scenario.**
  ...
  - to use any Scss variable or mixin from OUDS Web in this scenario. Only the one from Boosted will be available.

  If you want to have both, you may separate the 2 builds in different files and import the result in the main style file of your project. It will allow you to tree shake OUDS Web as well.
</Callout>
...
2. Replace your Boosted import file by copy pasting this code in the main style file of your project:
    ...
    .boosted {
      ...
      // It will also allow use the dark mode of OUDS Web inside Boosted.
      [data-bs-theme] {
