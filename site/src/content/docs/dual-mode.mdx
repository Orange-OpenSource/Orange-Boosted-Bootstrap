...
<Callout type="info">
  **This is the recommended scenario.**
  ...
  - use any Scss variable or mixin from OUDS Web in this scenario. Only the one from Boosted will be available.
...
<Callout type="warning">
  ...
  You won’t be able:
  - to use any Scss variable or mixin from OUDS Web in this scenario.
  - to tree shake Boosted.
  - to change easily the edge cases and unwanted side effects of OUDS Web.
  - to use dynamic modes in Boosted.
</Callout>
...
<Callout type="warning">
  ...
  You won’t be able:
  - to use any Scss variable or mixin from Boosted in this scenario.
  - to use OUDS Web containers, grid and utilities.
  - to use dynamic modes in Boosted.
</Callout>
