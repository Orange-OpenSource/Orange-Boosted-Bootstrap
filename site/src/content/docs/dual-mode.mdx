...
<Callout type="info">
  **This is the recommended scenario.**
  ...
  Note that you won’t be able to use any Scss variable or mixin from OUDS Web in this scenario.
</Callout>
...
<Callout type="warning">
  ...
  You won’t be able to use any Scss variable or mixin from either Boosted or OUDS Web in this scenario.
</Callout>
...
<Callout type="warning">
  ...
  You won’t be able to use any Scss variable or mixin from Boosted in this scenario.
</Callout>
