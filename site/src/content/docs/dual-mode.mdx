...
As there is no diff on any javascript component at the moment, we encourage you to take the JavaScript from `@ouds/web-common`. So replace `boosted/dist/js/boosted.bundle.min.js` by `@ouds/web-common/dist/js/ouds-web.bundle.min.js`, and you should be good to go.
