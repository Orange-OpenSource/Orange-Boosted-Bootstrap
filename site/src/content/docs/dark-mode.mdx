...
<div class="border p-3">
  <ul class="list-unstyled d-flex gap-2 flex-wrap m-0">
    ...
    <li>
      <span class="tag" id="labelTag11">Dismissible tag
...
<div class="border p-3" data-bs-theme="dark">
  <ul class="list-unstyled d-flex gap-2 flex-wrap m-0">
    ...
    <li><a class="tag" href="#">1. Introduction</a></li>
    <li>
      <span class="tag" id="labelTag12">Dismissible tag
...
<div class="border p-3" data-bs-theme="light">
  <ul class="list-unstyled d-flex gap-2 flex-wrap m-0">
    ...
    <li><a class="tag" href="#">1. Introduction</a></li>
    <li>
      <span class="tag" id="labelTag13">Dismissible tag
...
<div class="border p-3" style="background-color: #282d55">
  <ul class="list-unstyled d-flex gap-2 flex-wrap m-0">
    ...
    <li>
      <span class="tag" id="labelTag14" data-bs-theme="dark">Dismissible tag
...
<div class="border p-3" style="background-color: #b5e8f7">
  <ul class="list-unstyled d-flex gap-2 flex-wrap m-0">
    ...
    <li>
      <span class="tag" id="labelTag15" data-bs-theme="light">Dismissible tag
