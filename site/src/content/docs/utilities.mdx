...
<BsTable>
  ...
  | An opacity using a standard token `ouds/opacity/*`, used carefully because it might affect design or accessibility. | `ouds/opacity/medium` | `.opacity-medium` | [Opacity]([[docsref:/utilities/opacity]]) |
