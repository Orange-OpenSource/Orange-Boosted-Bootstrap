...
1. Make sure to install `sass`, and `boosted`. You’ll also need a theme, and this tutorial assumes it will be the Orange theme. <Code lang="sh" code="npm i sass @ouds/web-orange boosted" />
...
1. Make sure to install `sass`, `@ouds/web-common`, and `boosted`. You’ll also need a theme, and this tutorial assumes it will be the Orange theme. <Code lang="sh" code="npm i sass @ouds/web-common @ouds/web-orange boosted" />
