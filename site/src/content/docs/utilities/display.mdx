...
<Example code={`<div class="d-inline p-small text-bg-brand-primary">d-inline</div>
<div class="d-inline p-small text-bg-always-black">d-inline</div>`} />

<Example code={`<span class="d-block p-small text-bg-brand-primary">d-block</span>
<span class="d-block p-small text-bg-always-black">d-block</span>`} />
