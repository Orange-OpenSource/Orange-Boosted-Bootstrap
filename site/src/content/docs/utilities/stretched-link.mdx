...
<Example buttonLabel="card with stretched link" code={`<div class="card" style="width: 18rem;">
...
<Example buttonLabel="custom component with stretched link" code={`<div class="d-flex position-relative">
    <Placeholder width="144" height="144" class="flex-shrink-0 me-large" text="false" title="Generic placeholder image" />
    <div>
...
<Example buttonLabel="columns with stretched link" code={`<div class="row g-none bg-status-neutral-muted position-relative">
    <div class="col-md-6 mb-md-none p-md-2xlarge">
      <Placeholder width="100%" height="200" class="w-100" text="false" title="Generic placeholder image" />
    </div>
    <div class="col-md-6 p-2xlarge ps-md-none">
...
{/* <Example buttonLabel="card with stretched links" code={`<div class="card" style="width: 18rem;">
    <Placeholder width="100%" height="180" class="card-img-top" text="false" title="Card image cap" />
    <div class="card-body">
      ...
      <p class="card-text bg-status-neutral-muted" style="transform: rotate(0);">
