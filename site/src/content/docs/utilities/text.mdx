...
<Example code={`<div class="badge text-bg-brand-primary text-wrap" style="width: 6rem;">
...
You can easily add an icon with your font reference using [our icon size utilities]([[docsref:/components/icon#icons-size]]).
...
<ScssDocs name="root-font-variables-ouds" file="scss/_root.scss" />
...
<ScssDocs name="ouds-semantic-font" file="scss/tokens/_semantic.scss" />

#### Composite tokens

Font composite tokens are defined as Sass variables.

<ScssDocs name="ouds-composite-font" file="scss/tokens/_composite.scss" />
...
<ScssDocs name="ouds-maps-font" file="scss/_maps.scss" />
...
<ScssDocs name="ouds-mixin-font" file="scss/mixins/_fonts.scss" />
...
<ScssDocs name="ouds-font-implementation" file="scss/_reboot.scss" />
...
<ScssDocs name="utils-text-ouds" file="scss/_utilities.scss" />
