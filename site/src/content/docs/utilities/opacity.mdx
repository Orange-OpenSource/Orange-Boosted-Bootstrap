...
<Example showMarkup={false} class="d-sm-flex" code={`<div class="opacity-opaque p-large m-small bg-brand-primary fw-bold"></div>
  <div class="opacity-strong p-large m-small bg-brand-primary fw-bold"></div>
  <div class="opacity-medium p-large m-small bg-brand-primary fw-bold"></div>
  <div class="opacity-weak p-large m-small bg-brand-primary fw-bold"></div>
  <div class="opacity-weaker p-large m-small bg-brand-primary fw-bold"></div>
  <div class="opacity-weakest p-large m-small bg-brand-primary fw-bold"></div>
  <div class="opacity-invisible p-large m-small bg-brand-primary fw-bold"></div>`} />
...
<Example showMarkup={false} class="d-sm-flex" code={`<div class="opacity-100 p-3 m-2 bg-brand-primary fw-bold"></div>
