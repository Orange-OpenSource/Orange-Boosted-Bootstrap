...
<Example showMarkup={false} class="d-sm-flex" code={`<div class="opacity-opaque p-lg m-sm bg-brand-primary fw-bold"></div>
...
<Example code={`<svg class="opacity-disabled text-brand-primary" aria-hidden="true">
