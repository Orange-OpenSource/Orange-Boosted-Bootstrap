...
<Example class="bd-example-flex" code={`<div class="vstack gap-lg">
...
<Example class="bd-example-flex" code={`<div class="hstack gap-lg">
    <div class="p-sm">First item</div>
    <div class="p-sm">Second item</div>
    <div class="p-sm">Third item</div>
  </div>`} />
...
<Example code={`<div class="vstack gap-sm col-md-5 mx-auto">
...
<Example code={`<div class="hstack gap-lg">
