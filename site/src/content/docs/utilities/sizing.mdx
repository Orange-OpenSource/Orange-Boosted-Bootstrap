...
<Example class="bd-example-flex" code={`<div class="w-25 p-large">Width 25%</div>
  <div class="w-50 p-large">Width 50%</div>
  <div class="w-75 p-large">Width 75%</div>
  <div class="w-100 p-large">Width 100%</div>
  <div class="w-auto p-large">Width auto</div>`} />
...
You can also use in some cases (mainly [font references]([[docsref:/foundation/typography]])) `max-width: none` utility as needed.
