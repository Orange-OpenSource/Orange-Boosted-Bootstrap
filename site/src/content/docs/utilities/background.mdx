...
<Example code={`<p class="bg-primary p-lg fw-bold">.bg-primary</p>
  ...
  <p class="bg-brand-secondary p-lg fw-bold"><span data-bs-theme="root-inverted">.bg-brand-secondary</span></p>
  <p class="bg-brand-tertiary p-lg fw-bold"><span data-bs-theme="light">.bg-brand-tertiary</span></p>
...
We also provide some opacity backgounds that should only be used in very specific context, to opacify the background and make some text readable. Prefer using `.bg-secondary` when possible.
...
<Example code={`<div class="bg-brand-primary p-lg">
    <div data-bs-theme="light">
...
<Example code={`<div class="bg-emphasized p-lg">
    <div data-bs-theme="dark">
      <p class="bg-opacity-lower p-lg fw-bold">.bg-opacity-lower</p>
      <p class="bg-opacity-lowest p-lg fw-bold">.bg-opacity-lowest</p>
    </div>
