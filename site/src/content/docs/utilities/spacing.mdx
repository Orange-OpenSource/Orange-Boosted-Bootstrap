...
<Example class="bd-example-spacings" code={`<div class="mx-scaled-large">Tall scaled x margin</div>
  <div class="mx-large">Tall x margin (fixed)</div>
  <div class="mx-large mx-md-xlarge mx-xl-2xlarge">Tall scaled x margin (manually)</div>`} />
