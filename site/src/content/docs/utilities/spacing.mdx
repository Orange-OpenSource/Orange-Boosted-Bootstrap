...
<Example class="bd-example-spacings" code={`<div class="mx-scaled-lg">Tall scaled x margin</div>
  ...
  <div class="mx-large mx-md-xlarge mx-xl-2xl">Tall scaled x margin (manually)</div>`} />
...
<Example showMarkup={false} code={`<div class="mx-auto p-sm" style="width: 200px; background-color: rgba(var(--bd-primary-light-rgb),.15); border: rgba(var(--bd-primary-light-rgb),.3) solid 1px;">
    Centered element
  </div>`} />
