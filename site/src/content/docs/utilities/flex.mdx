...
<Example class="bd-example-flex" code={`<div class="d-flex p-sm">I’m a flexbox container!</div>`} />

<Example class="bd-example-flex" code={`<div class="d-inline-flex p-sm">I’m an inline flexbox container!</div>`} />
...
<Example class="bd-example-flex" code={`<div class="d-flex flex-row mb-lg">
...
<Example class="bd-example-flex" code={`<div class="d-flex flex-column mb-lg">
    <div class="p-sm">Flex item 1</div>
    <div class="p-sm">Flex item 2</div>
    <div class="p-sm">Flex item 3</div>
  </div>
...
<Example showMarkup={false} class="bd-example-flex" code={`<div class="d-flex justify-content-start mb-lg">
...
<Example showMarkup={false} class="bd-example-flex" code={`<div class="d-flex align-items-start mb-lg" style="height: 100px">
...
<Example showMarkup={false} class="bd-example-flex" code={`<div class="d-flex mb-lg" style="height: 100px">
    <div class="p-sm">Flex item</div>
...
<Example class="bd-example-flex" code={`<div class="d-flex mb-lg">
    <div class="p-sm">Flex item</div>
    <div class="p-sm">Flex item</div>
    <div class="p-sm">Flex item</div>
  </div>
...
<Example class="bd-example-flex" code={`<div class="d-flex align-items-start flex-column mb-lg" style="height: 200px;">
...
<Example showMarkup={false} class="bd-example-flex" code={`<div class="d-flex align-content-start flex-wrap mb-lg" style="height: 200px">
    <div class="p-sm">Flex item</div>
    <div class="p-sm">Flex item</div>
    <div class="p-sm">Flex item</div>
    <div class="p-sm">Flex item</div>
...
<Example showMarkup={false} class="bd-example-flex" code={`<div class="d-flex align-content-end flex-wrap mb-lg" style="height: 200px">
    <div class="p-sm">Flex item</div>
    <div class="p-sm">Flex item</div>
    <div class="p-sm">Flex item</div>
    <div class="p-sm">Flex item</div>
...
<Example showMarkup={false} class="bd-example-flex" code={`<div class="d-flex align-content-center flex-wrap mb-lg" style="height: 200px">
    <div class="p-sm">Flex item</div>
    <div class="p-sm">Flex item</div>
    <div class="p-sm">Flex item</div>
    <div class="p-sm">Flex item</div>
...
<Example showMarkup={false} class="bd-example-flex" code={`<div class="d-flex align-content-between flex-wrap mb-lg" style="height: 200px">
    <div class="p-sm">Flex item</div>
    <div class="p-sm">Flex item</div>
    <div class="p-sm">Flex item</div>
    <div class="p-sm">Flex item</div>
...
<Example showMarkup={false} class="bd-example-flex" code={`<div class="d-flex align-content-around flex-wrap mb-lg" style="height: 200px">
    <div class="p-sm">Flex item</div>
    <div class="p-sm">Flex item</div>
    <div class="p-sm">Flex item</div>
    <div class="p-sm">Flex item</div>
...
<Example showMarkup={false} class="bd-example-flex" code={`<div class="d-flex align-content-stretch flex-wrap mb-lg" style="height: 200px">
    <div class="p-sm">Flex item</div>
    <div class="p-sm">Flex item</div>
    <div class="p-sm">Flex item</div>
    <div class="p-sm">Flex item</div>
