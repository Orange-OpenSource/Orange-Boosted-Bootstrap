...
<Example class="d-flex overflow-auto" code={`<Placeholder width="140" height="120" class="object-fit-contain border" text="Object fit contain" markup="img" color="#333" background="#bbb" />
...
Responsive variations also exist for each `object-fit` value using the format `.{breakpoint}:object-fit-{value}`, for the following breakpoint abbreviations: `xs`, `sm`, `md`, `lg`, `xl`, `2xl` and `3xl`. Classes can be combined for various effects as you need.

<Example class="d-flex overflow-auto" code={`<Placeholder width="140" height="80" class="xs:object-fit-contain border" text="Contain on xs" markup="img" color="#333" background="#bbb" />
  <Placeholder width="140" height="80" class="sm:object-fit-contain border" text="Contain on sm" markup="img" color="#333" background="#bbb" />
  <Placeholder width="140" height="80" class="md:object-fit-contain border" text="Contain on md" markup="img" color="#333" background="#bbb" />
  <Placeholder width="140" height="80" class="lg:object-fit-contain border" text="Contain on lg" markup="img" color="#333" background="#bbb" />
  <Placeholder width="140" height="80" class="xl:object-fit-contain border" text="Contain on xl" markup="img" color="#333" background="#bbb" />
  <Placeholder width="140" height="80" class="2xl:object-fit-contain border" text="Contain on 2xl" markup="img" color="#333" background="#bbb" />
  <Placeholder width="140" height="80" class="3xl:object-fit-contain border" text="Contain on 3xl" markup="img" color="#333" background="#bbb" />`} />


<BootstrapCompatibility>
<Example class="d-flex overflow-auto" code={`<Placeholder width="140" height="80" class="object-fit-xs-contain border" text="Contain on xs" markup="img" color="#333" background="#bbb" />
