...
To colorize icons, please refer to our [icon color section]([[docsref:/foundation/icons#colors]]).
...
See [icons documentation]([[docsref:/foundation/icons#colors]]) to learn how to use color utilities on icons.
