...
To colorize icons, please refer to our [icon color section]([[docsref:/foundation/icons#icon-colors]]).
...
See [icons documentation]([[docsref:/foundation/icons#icon-colors]]) to learn how to use color utilities on icons.
