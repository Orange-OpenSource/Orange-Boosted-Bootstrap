...
To colorize icons, please refer to our [icon color section]([[docsref:/foundation/icons#icons-color]]).
...
See [icons documentation]([[docsref:/foundation/icons#icons-color]]) to learn how to use color utilities on icons.
