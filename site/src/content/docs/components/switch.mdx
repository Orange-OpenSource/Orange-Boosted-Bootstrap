---
title: Switch
description: A switch is a UI element that toggles between two states, typically 'On' and 'Off', used to enable or disable features, options, or settings.
aliases:
  - "/docs/forms/switch/"
...
Switch item is a UI element that toggles between two states, typically "On" and "Off," and is used to enable or disable features, options, or settings.

Unlike the [switch](#standalone), the switch item accommodates a broader range of contexts by enabling the toggling of visibility of additional text labels and icon assets.
...
<Example buttonLabel="basic switches" code={`<ul class="control-items-list">
...
<Example buttonLabel="Bootstrap compatibility: basic switches" code={`<div class="form-check form-switch">
...
<Example buttonLabel="switches with divider" code={`<ul class="control-items-list">
...
<Example buttonLabel="switches with icon" code={`<ul class="control-items-list">
    <li class="switch-item">
      <div class="control-item-assets-container">
...
<Example buttonLabel="switches with description text" code={`<ul class="control-items-list">
    <li class="switch-item">
      <div class="control-item-assets-container">
...
<Example buttonLabel="switch max width" code={`<div class="switch-item component-max-width">
    <div class="control-item-assets-container">
...
<Example buttonLabel="disabled switches" code={`<ul class="control-items-list">
    <li class="switch-item">
      <div class="control-item-assets-container">
...
<BootstrapCompatibility>
<Example buttonLabel="Bootstrap compatibility: disabled switches" code={`<div class="form-check form-switch">
...
To manually mark a switch as invalid, add `aria-invalid="true"` to a `.control-item-indicator`. An error icon will be automatically shown, if there is a decorative icon specified it will be hidden.
...
<Example buttonLabel="invalid single switch" code={`<div class="switch-item-container">
...
<Example buttonLabel="Bootstrap compatibility: invalid single switch" code={`<div class="form-check form-switch">
...
<Example buttonLabel="invalid single switch inside a list" code={`<ul class="list-unstyled">
...
<Example buttonLabel="invalid switch group" code={`<fieldset class="control-items-list">
...
<SkeletonRedirect component="switch item" />

<Example buttonLabel="switch item skeleton" code={`<div aria-busy="true" inert>
    <div class="switch-item">
      <div class="control-item-assets-container">
...
<Example buttonLabel="switches grouped with fieldset" code={`<div class="row">
    <div class="col-md-6">
...
Switch is a UI element that toggles between two states, typically "On" and "Off," and is used to enable or disable features, options, or settings.

Switch, that lacks an additional icon asset or text label, provides greater flexibility when creating other components that require a switch.
...
<Example buttonLabel="standalone switch" code={`<label class="switch-standalone">
...
<Example buttonLabel="native switch" code={`<div class="switch-item">
    <div class="control-item-assets-container">
...
<MandatoryFieldIndication componentName="switch" />

<Example buttonLabel="mandatory switches indication" code={`<div class="switch-item-container">
    <div class="switch-item component-max-width">
      <div class="control-item-assets-container">
        <input class="control-item-indicator" type="checkbox" role="switch" value="" id="switchUniqueMandatory" name="mandatorySwitch"/>
      </div>
      <div class="control-item-text-container">
