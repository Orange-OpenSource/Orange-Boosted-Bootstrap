...
To display an invalid switch, add `.is-invalid` to a `.control-item-indicator` or add a `.was-validated` to any ancestor (`<form>` usually). Please take a look at our [Validation page to learn more]([[docsref:/foundation/form-validation]]).
...
<Example buttonLabel="invalid single switch" code={`<div class="switch-item-container">
  ...
  <div class="was-validated">
    <div class="switch-item-container">
      <div class="switch-item control-item-divider">
        <div class="control-item-assets-container">
          <input class="control-item-indicator" type="checkbox" role="switch" value="" id="switchAsyncInvalid" aria-describedby="switchAsyncInvalidDescription switchAsyncInvalidErrorText" required />
        </div>
        <div class="control-item-text-container">
          <label class="control-item-label" for="switchAsyncInvalid">Default invalid switch</label>
          <p class="control-item-description" id="switchAsyncInvalidDescription">Description text</p>
        </div>
      </div>
      <p class="control-item-error-message" id="switchAsyncInvalidErrorText">Cannot be deactivated at this time.</p>
    </div>
  </div>`} />
