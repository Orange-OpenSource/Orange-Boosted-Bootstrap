...
You can display an invalid switch by adding `.is-invalid` to a `.control-item-indicator`. Please take a look at our [Validation]([[docsref:/components/validation]]) page to know more about this.
