...
To display an invalid switch, add `aria-invalid="true"` to a `.form-check-input`.

<Example buttonLabel="Bootstrap compatibility: invalid single switch" code={`<div class="form-check form-switch">
    <input class="form-check-input" aria-invalid="true" type="checkbox" value="" id="checkInvalid" role="switch" />
