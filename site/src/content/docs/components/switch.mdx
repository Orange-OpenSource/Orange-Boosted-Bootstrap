...
<Example buttonLabel="mandatory switches indication" code={`<div class="switch-item-container">
    <div class="switch-item component-max-width">
      <div class="control-item-assets-container">
        <input class="control-item-indicator" type="checkbox" role="switch" value="" id="switchUniqueMandatory" />
      </div>
      <div class="control-item-text-container">
  ...
  <fieldset class="control-items-list">
    ...
    <div class="switch-item component-max-width">
      <div class="control-item-assets-container">
        <input class="control-item-indicator" type="checkbox" role="switch" value="" id="mandatorySwitch1" required />
      </div>
      <div class="control-item-text-container">
    ...
    <div class="switch-item component-max-width">
      <div class="control-item-assets-container">
        <input checked class="control-item-indicator" type="checkbox" role="switch" value="" id="mandatorySwitch2" required />
      </div>
      <div class="control-item-text-container">
