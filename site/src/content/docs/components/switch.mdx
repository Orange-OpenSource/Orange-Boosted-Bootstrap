---
title: Switch
description: Switch is a UI element that allows to toggle between two states, typically “On” and “Off”, and used to enable or disable features, options or settings.
aliases:
  - "/docs/forms/switch/"
