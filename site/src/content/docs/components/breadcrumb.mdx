---
title: Breadcrumb
description: Breadcrumb is a UI element that helps navigating and identifying current location in a website, by displaying a hierarchical path of web pages.
aliases:
