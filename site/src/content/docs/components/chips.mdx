...
<Code buttonLabel="JavaScript to create a button instance" lang="js" showPreview="false" code={`const bsButton = new oudsWeb.Button('#myButton')`} />
...
<Code buttonLabel="JavaScript to toggle all chips" lang="js" showPreview="false" code={`document.querySelectorAll('.chip-suggestion').forEach(chipElement => {
