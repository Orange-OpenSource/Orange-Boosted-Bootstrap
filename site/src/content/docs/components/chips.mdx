...
Use our [button JS plugin](#javascript) or handle interactivity on your side, but make sure to use `aria-pressed` to ensure a good level of accessibility:
...
<Example code={`<ul class="chips-container" aria-label="Filter by">
    <li class="chip chip-filter">
      <button class="chip-interactive" data-bs-toggle="button" aria-pressed="false">
...
<Example code={`<ul class="chips-container" aria-label="Filter by">
    ...
    <li class="chip chip-filter">
      <button class="chip-interactive" data-bs-toggle="button" aria-pressed="false" disabled>
