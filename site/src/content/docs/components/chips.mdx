...
A chip's text should not exceed one line. It also natively supports `<br/>` tags to break the text into multiple lines. Read more about [text wrapping in a filter chip](https://r.orange.fr/r/S-ouds-doc-filter-chip/t/75dd4ff373).
