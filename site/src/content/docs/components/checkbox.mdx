...
aliases:
  - "/docs/forms/checks/"
  - "/docs/components/checks/"
  - "/docs/forms/checks-radios/"
  - "/docs/components/checks-radios/"
  - "/docs/forms/checkbox/"
...
To manually mark a checkbox as invalid, add `aria-invalid="true"` to a `.control-item-indicator`. An error icon will be automatically shown, if there is a decorative icon specified it will be hidden.
...
<Example buttonLabel="invalid checkboxes" class="bd-example-indeterminate" addStackblitzJs code={`<fieldset class="control-items-list">
    <div class="checkbox-item control-item-divider">
      <div class="control-item-assets-container">
        <input class="control-item-indicator" aria-invalid="true" type="checkbox" value="" id="checkboxInvalid" aria-describedby="checkboxInvalidDescription checkboxInvalidErrorText" />
      </div>
      <div class="control-item-text-container">
    ...
    <div class="checkbox-item control-item-divider">
      <div class="control-item-assets-container">
        <input class="control-item-indicator" aria-invalid="true" type="checkbox" value="" id="checkboxInvalid2" aria-describedby="checkboxInvalid2Description checkboxInvalidErrorText" checked />
      </div>
      <div class="control-item-text-container">
    ...
    <div class="checkbox-item control-item-divider">
      <div class="control-item-assets-container">
        <input class="control-item-indicator" aria-invalid="true" type="checkbox" value="" id="checkboxInvalidIndeterminate" aria-describedby="checkboxInvalidIndeterminateDescription checkboxInvalidErrorText" />
      </div>
      <div class="control-item-text-container">
...
<BootstrapCompatibility>
To display an invalid checkbox, add `aria-invalid="true"` to a `.form-check-input`.
...
<Example buttonLabel="Bootstrap compatibility: invalid checkboxes" class="bd-example-indeterminate" addStackblitzJs code={`<div class="form-check">
    <input class="form-check-input" aria-invalid="true" type="checkbox" value="" id="checkInvalid" />
...
<Example buttonLabel="invalid checkboxes in an horizontal layout" code={`<fieldset class="control-items-list">
    <div class="d-flex flex-row gap-small w-50">
      <div class="checkbox-item flex-fill">
        <div class="control-item-assets-container">
          <input class="control-item-indicator" aria-invalid="true" type="checkbox" value="" id="checkboxLayoutRowInvalid1" aria-describedby="checkboxLayoutRowInvalidErrorText" />
        </div>
        <div class="control-item-text-container">
      ...
      <div class="checkbox-item flex-fill">
        <div class="control-item-assets-container">
          <input class="control-item-indicator" aria-invalid="true" type="checkbox" value="" id="checkboxLayoutRowInvalid2" aria-describedby="checkboxLayoutRowInvalidErrorText" />
        </div>
        <div class="control-item-text-container">
...
<Example buttonLabel="invalid checkboxes with `<ul>`" class="bd-example-indeterminate" addStackblitzJs code={`<ul class="control-items-list">
    <li class="checkbox-item control-item-divider">
      <div class="control-item-assets-container">
        <input class="control-item-indicator" aria-invalid="true" type="checkbox" value="" id="checkboxInvalidUl" aria-describedby="checkboxInvalidUlDescription checkboxInvalidUlErrorText" />
      </div>
      <div class="control-item-text-container">
    ...
    <li class="checkbox-item control-item-divider">
      <div class="control-item-assets-container">
        <input class="control-item-indicator" aria-invalid="true" type="checkbox" value="" id="checkboxInvalidUl2" aria-describedby="checkboxInvalidUl2Description checkboxInvalidUlErrorText" />
      </div>
      <div class="control-item-text-container">
...
<Example buttonLabel="invalid unique checkbox" code={`<div class="checkbox-item-container">
    <div class="checkbox-item">
      <div class="control-item-assets-container">
        <input class="control-item-indicator" aria-invalid="true" type="checkbox" value="" id="checkboxUniqueInvalid" aria-describedby="checkboxUniqueInvalidErrorText" />
      </div>
      <div class="control-item-text-container">
...
Use the class `.is-required` if you want to add a red asterisk after the legend.

For general rules about when to add mandatory fields indication, please refer to the [checkbox design guidelines](https://r.orange.fr/r/S-ouds-doc-checkbox) and to the [form validation documentation]([[docsref:/foundation/form-validation#mandatory-fields-indication]]).


<Example buttonLabel="mandatory checkboxes in a fieldset" code={`<fieldset class="control-items-list">
    <legend class="is-required">Mandatory checkboxes example</legend>
    <div class="checkbox-item">
      <div class="control-item-assets-container">
        <input class="control-item-indicator" type="checkbox" value="" id="requiredCheckbox1" required aria-describedby="checkboxesInvalidErrorText"/>
      </div>
      <div class="control-item-text-container">
        <label class="control-item-label" for="checkboxDefault">Default checkbox</label>
      </div>
    ...
    <div class="checkbox-item">
      <div class="control-item-assets-container">
        <input checked class="control-item-indicator" type="checkbox" value="" id="requiredCheckbox2" required aria-describedby="checkboxesInvalidErrorText"/>
      </div>
      <div class="control-item-text-container">
        <label class="control-item-label" for="checkboxDefault2">Checked checkbox</label>
      </div>
...
<Example buttonLabel="mandatory unique checkbox" code={`<div class="checkbox-item-container">
    <div class="checkbox-item">
      <div class="control-item-assets-container">
        <input class="control-item-indicator" type="checkbox" value="" id="checkboxUniqueInvalid" aria-describedby="checkboxUniqueInvalidErrorText" />
      </div>
      <div class="control-item-text-container">
        <label class="control-item-label is-required" for="checkboxUniqueInvalid">Accept terms and conditions</label>
      </div>
    </div>
  </div>`} />
