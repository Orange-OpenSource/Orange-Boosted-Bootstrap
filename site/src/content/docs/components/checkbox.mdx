---
title: Checkbox
description: Checkbox is a UI element that allows to select multiple options from a set of mutually non exclusive choices.
aliases:
  - "/docs/forms/checks/"
...
Checkbox item is a UI element that allows to select multiple options from a set of mutually non exclusive choices.
