...
<Example buttonLabel="invalid checkboxes with ul element" class="bd-example-indeterminate" addStackblitzJs code={`<ul class="control-items-list">
...
<Example buttonLabel="mandatory checkboxes indication" code={`<div class="checkbox-item-container">
    <div class="checkbox-item">
      <div class="control-item-assets-container">
        <input class="control-item-indicator" type="checkbox" value="" id="checkboxUniqueMandatory" name="mandatoryCheckbox" required />
      </div>
      <div class="control-item-text-container">
