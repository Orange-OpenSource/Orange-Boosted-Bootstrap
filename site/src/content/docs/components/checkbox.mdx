---
title: Checkbox
description: A checkbox is a UI element that enables users to select multiple options from a set of mutually non-exclusive choices.
aliases:
  - "/docs/forms/checks/"
...
Checkbox item is a UI element that allows users to select multiple options from a set of mutually non-exclusive choices.

Unlike the [checkbox](#standalone), the checkbox item accommodates a broader range of contexts by enabling the toggling of visibility of additional text labels and icon assets.
...
<SkeletonRedirect component="checkbox item" />

<Example buttonLabel="checkbox item skeleton" code={`<div aria-busy="true" inert>
    <div class="checkbox-item">
      <div class="control-item-assets-container">
        <input class="control-item-indicator" type="checkbox" value="" id="checkboxSkeleton" />
      </div>
      <div class="control-item-text-container">
        <label class="control-item-label" for="checkboxSkeleton">Skeleton checkbox</label>
      </div>
    </div>
  </div>`} />
...
Checkbox is a UI element that enables users to select multiple options from a set of mutually non-exclusive choices.

Checkbox, that lacks an additional icon asset or text label, offers greater flexibility when designing other components that incorporate a checkbox.
