...
To indicate that some checkboxes are mandatory in a form, add the class `.is-required` to display a red asterisk at the end of the legend of a group of checkboxes, or at the end of the label of a checkbox.

For general rules about when to add mandatory fields indication, please refer to the [checkbox design guidelines](https://r.orange.fr/r/S-ouds-doc-checkbox) and to the [form validation documentation]([[docsref:/foundation/form-validation#mandatory-fields-indication]]). In particular, do not forget to handle error messages.
...
<Example buttonLabel="mandatory checkboxes indication" code={`<div class="checkbox-item-container">
    <div class="checkbox-item">
      ...
      <div class="control-item-text-container">
        <label class="control-item-label is-required" for="checkboxUniqueInvalid">Mandatory unique checkbox</label>
      </div>
    </div>
  </div>
  <hr class="my-2xlarge">
