...
<Code buttonLabel="JavaScript to set a checkbox as indeterminate" lang="js" showPreview="false" code={`const checkbox = document.getElementById('checkboxIndeterminate')
