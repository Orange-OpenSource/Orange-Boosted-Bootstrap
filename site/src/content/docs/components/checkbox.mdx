...
<Callout type="info" name="input-invalid" />
 ...
 You can display an invalid checkbox by adding `.is-invalid` to a `.control-item-indicator`. Please take a look at our [Validation]([[docsref:/components/validation]]) page to know more about this.
