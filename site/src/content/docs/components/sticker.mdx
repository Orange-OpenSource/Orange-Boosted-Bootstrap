...
<ScssDocs name="sticker-fs-3xl" file="site/assets/scss/_component-examples.scss" />
...
<ScssDocs name="sticker-fs-4xl" file="site/assets/scss/_component-examples.scss" />
...
<ScssDocs name="sticker-fs-xl" file="site/assets/scss/_component-examples.scss" />
...
<ScssDocs name="sticker-fs-l-3xl" file="site/assets/scss/_component-examples.scss" />
