  ...
  <li class="col">
    <div class="card position-relative h-100">
      ...
      <div class="card-body border-default border-thin border-top">
        <a class="stretched-link" href="#chip-filter">Chip filter</a> is a filter option that can be selected or deselected by the user.
      </div>
    </div>
  </li>
  <li class="col">
    <div class="card position-relative h-100">
      ...
      <div class="card-body border-default border-thin border-top">
        <a class="stretched-link" href="#suggestion-chip">Suggestion chip</a> is a recommended or predictive option based on user input or context.
      </div>
    </div>
  </li>
</ul>
