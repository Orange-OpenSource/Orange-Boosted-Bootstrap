...
For visually impaired and blind users, the visual context is inaccessible. Thus, they cannot understand the purpose of the chips on the page. So it's mandatory to add a hidden text to explain the use of chips without context. Don’t forget to adapt and translate this text to your use case.
...
<Example code={`<ul class="chip-container" aria-label="Filter bar">
...
<Example code={`<ul class="chip-container" aria-label="Suggestion bar">
...
<Example code={`<ul class="chip-container flex-wrap" aria-label="Filter bar">
    <li class="chip chip-filter">
      <button class="chip-interactive" data-bs-toggle="button">
        <span class="visually-hidden">Filter by</span>
        Quite long label
...
<Example code={`<ul class="chip-container flex-wrap" aria-label="Filter bar" style="max-height: 115px;">
    <li class="chip chip-filter">
      <button class="chip-interactive" data-bs-toggle="button">
        <span class="visually-hidden">Filter by</span>
        Quite long label
