...
The label is optional from a visual perspective, but for accessibility reasons, it is mandatory to keep a `.visually-hidden` label.

<Callout type="negative">
  Hiding the label should be reserved when the purpose of the text area is obvious thanks to a placeholder or contextual icon.
</Callout>
...
<Example buttonLabel="text area with hidden label" code={`<div class="text-area">
    <div class="text-area-container">
      ...
      <textarea id="textAreaWithoutLabel" class="text-area-field" placeholder="Please enter a comment"></textarea>
    </div>
  </div>`} />
...
<Example buttonLabel="mandatory text area indication" code={`<div class="text-area mb-medium">
    <div class="text-area-container">
      <label for="mandatoryTextArea" class="is-required">Additional comments Additional comments Additional commentsAdditional comments Additional comments Additional commentsAdditional comments Additional comments Additional comments</label>
