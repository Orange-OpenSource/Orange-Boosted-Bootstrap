...
The label is optional from a visual perspective, but for accessibility reasons, it is mandatory to keep a `.visually-hidden` label. Hiding the label should be reserved when the purpose of the text area is obvious thanks to a placeholder or contextual icon.
