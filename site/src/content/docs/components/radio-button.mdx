---
title: Radio button
description: A radio button is a UI element that allows the selection of a single option from a set of mutually exclusive choices.
aliases:
  - "/docs/forms/radio/"
...
Radio button item is a UI element that allows users to select a single option from a set of mutually exclusive choices.

Unlike the [radio button](#standalone), the radio button item accommodates a broader range of contexts by enabling the toggling of visibility of additional text labels and icon assets.
...
To manually mark a radio button as invalid, add the `aria-invalid="true"` attribute to a `.control-item-indicator`. An error icon will be automatically shown, if there is a decorative icon specified it will be hidden.
...
To display an invalid radio button, add `aria-invalid="true"` to a `.form-check-input`.

<Example buttonLabel="Bootstrap compatibility: invalid radio buttons" code={`<div class="form-check">
    <input class="form-check-input" aria-invalid="true" type="radio" value="" id="radioInvalidBootstrap" />
...
<SkeletonRedirect component="radio button item" />

<Example buttonLabel="radio button item skeleton" code={`<div aria-busy="true" inert>
    <fieldset class="control-items-list">
      <div class="radio-button-item">
        <div class="control-item-assets-container">
...
Radio button is a UI element that allows users to select a single option from a set of mutually exclusive choices.

Radio button, that lacks an additional icon asset or text label, provides greater flexibility when designing other components that incorporate a radio button.
