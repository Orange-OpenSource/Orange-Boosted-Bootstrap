...
<Example code={`<div class="radio-button-item radio-button-item-outlined control-item-divider">
    <div class="control-item-assets-container">
...
<Callout type="info" name="input-invalid" />
 ...
 You can display an invalid radio button by adding `.is-invalid` to a `.control-item-indicator`. Please take a look at our [Validation]([[docsref:/components/validation]]) page to know more about this.
