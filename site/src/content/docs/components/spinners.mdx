...
<Example code={[
  ...getData('theme-colors').map((themeColor) => `<div class="spinner-border text-${themeColor.name}" role="status">
    <span class="visually-hidden">Loading...</span>
  </div>`)
]} />
</details>
...
<Example code={[
  ...getData('theme-colors').map((themeColor) => `<div class="spinner-grow text-${themeColor.name}" role="status">
    <span class="visually-hidden">Loading...</span>
  </div>`)
]} />
</details>
...
<ScssDocs name="spinner-border-lg-css-vars" file="scss/_spinners.scss" />
