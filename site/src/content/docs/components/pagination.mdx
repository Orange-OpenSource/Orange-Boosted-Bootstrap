...
<Example code={`<nav aria-label="Page navigation example with icons">
    <ul class="pagination">
...
<CalloutDeprecatedDarkVariants component="pagination" />
...
<ScssDocs name="pagination-max-items-mixin" file="scss/mixins/_pagination.scss" />
