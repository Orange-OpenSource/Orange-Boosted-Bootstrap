...
<Example buttonLabel="text inoputs max width" code={`<div class="text-input component-max-width mb-medium">
    <div class="text-input-container">
...
<BootstrapCompatibility>
  ...
  <Example buttonLabel="Bootstrap compatibility: readonly text inputs" code={`<input class="form-control" type="text" value="Readonly input here..." aria-label="readonly input example" readonly>`} />
</BootstrapCompatibility>
