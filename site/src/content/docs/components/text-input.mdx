...
<Callout type="warning">
  Please note that a known issue can prevent floating labels from working in all browsers with the default configuration. We suggest using our <code>.browserslistrc</code> file to ensure compatibility. Please refer to the [Browsers and devices documentation]([[docsref:/getting-started/browsers-devices]]) for more details.
</Callout>
