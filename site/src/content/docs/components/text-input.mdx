...
<Callout type="warning">
  Please note an issue prevents floating labels to work on all browsers by default. We suggest using our <code>.browserslistrc</code> file to ensure compatibility. Please refer to the [browsers and devices documentation]([[docsref:/getting-started/browsers-devices]]) for more details.
</Callout>
