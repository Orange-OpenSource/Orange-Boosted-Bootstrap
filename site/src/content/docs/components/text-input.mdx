...
To display an invalid input, add `aria-invalid="true"` to a `.text-input-field` within the `.text-input-container`. Please take a look at our [Validation page to learn more]([[docsref:/foundation/form-validation]]).
