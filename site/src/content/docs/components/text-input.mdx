---
title: Text input
description: Text input is a UI element that enables users to type, edit, or select a single line of text, such as names, emails, or search queries.
aliases:
...
Text is a UI element that enables users to type, edit, or select a single line of text, such as names, emails, or search queries.

Text input features labels, placeholders, icons, helper messages, and validation feedback to provide visual and interactive cues.
...
<BootstrapCompatibility>
  <Example buttonLabel="Bootstrap compatibility: outlined text input" code={`<div>
...
<Example buttonLabel="text input with helper text" code={`<div class="text-input">
  ...
  <Example buttonLabel="Bootstrap compatibility: text input with helper text" code={`<label for="inputPassword5" class="form-label">Password</label>
  ...
  <Example buttonLabel="Bootstrap compatibility: text input with inline helper text" code={`<div class="row g-large align-items-center">
    <div class="col-auto">
...
<Example buttonLabel="text input max width" code={`<div class="text-input component-max-width mb-medium">
    <div class="text-input-container">
...
<BootstrapCompatibility>
  ...
  <Example buttonLabel="Bootstrap compatibility: disabled text input" code={`<input class="form-control" type="text" placeholder="Disabled input" aria-label="Disabled input example" disabled>
...
<BootstrapCompatibility>
  ...
  <Example buttonLabel="Bootstrap compatibility: readonly text input" code={`<input class="form-control" type="text" value="Readonly input here..." aria-label="readonly input example" readonly>`} />
</BootstrapCompatibility>
...
<MandatoryFieldIndication componentName="text input" />
<Example buttonLabel="mandatory text input indication" code={`<div class="text-input component-max-width mb-large">
    <div class="text-input-container">
      <label for="username" class="is-required">Username</label>
      <input type="text" class="text-input-field" id="username" placeholder=" " required>
    </div>
  </div>`} />
...
<Example buttonLabel="mandatory text input indication" code={`<div class="text-input component-max-width mb-large">
    <div class="text-input-container">
      <label for="username1" class="is-required">Quatenus in rem Numne Vecellinum cum si num num Vecellinum si debuerunt si patriam cum rem si si debuerunt id primum contra num debuerunt placet primum Maelium arma amor id Maelium amici videamus quatenus cum num Vecellinum Vecellinum progredi si.</label>
      <input type="text" class="text-input-field" id="username1" placeholder=" " required>
    </div>
  </div>
  <div class="text-input component-max-width mb-large">
    <div class="text-input-container">
      <label for="username11" class="is-required">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</label>
      <input type="text" class="text-input-field" id="username11" placeholder=" " required aria-invalid="true">
    </div>
  </div>
  <div class="text-input component-max-width mb-large">
    <div class="text-input-container">
      <label for="username2" class="is-required">Delectari studiorum multis admodum non inanimis delectari delectari rebus Nihil eo studiorum Nihil enim admodum vestitu ut ut iucundius honore ita rebus ut amare non Nihil corporis iucundius enim virtute tam Nihil officiorumque aedificio remuneratione benevolentiae virtute enim benevolentiae delectari.</label>
      <input type="text" class="text-input-field" id="username2" placeholder="ici on a un placeholder" required>
    </div>
  </div>
  <div class="text-input component-max-width mb-large">
    <div class="text-input-container">
      <label for="username2l" class="is-required">Delectari studiorum multis admodum non inanimis delectari delectari rebus Nihil eo studiorum Nihil enim admodum vestitu ut ut iucundius honore ita rebus ut amare non Nihil corporis iucundius enim virtute tam Nihil officiorumque aedificio remuneratione benevolentiae virtute enim benevolentiae delectari.</label>
      <input disabled type="text" class="text-input-field loading-indeterminate" id="username2l" placeholder="ici on a un placeholder" required>
      <svg viewBox='0 0 40 40' xmlns='http://www.w3.org/2000/svg' class="loader" aria-hidden="true">
        <circle class="loader-inner" cx="20" cy="20" r="17"></circle>
      </svg>
      <span role="status" id="loading-msg-l" class="visually-hidden d-none">Loading message</span>
    </div>
  </div>
  <div class="text-input component-max-width mb-large">
    <div class="text-input-container">
      <label for="username2ll" class="is-required">Delectari studiorum multis admodum non inanimis delectari delectari rebus Nihil eo studiorum Nihil enim admodum vestitu ut ut iucundius honore ita rebus ut amare non Nihil corporis iucundius enim virtute tam Nihil officiorumque aedificio remuneratione benevolentiae virtute enim benevolentiae delectari.</label>
      <input disabled type="text" class="text-input-field loading-indeterminate" id="username2ll" placeholder="ici on a un placeholder" required aria-invalid="true">
      <svg viewBox='0 0 40 40' xmlns='http://www.w3.org/2000/svg' class="loader" aria-hidden="true">
        <circle class="loader-inner" cx="20" cy="20" r="17"></circle>
      </svg>
      <span role="status" id="loading-msg-ll" class="visually-hidden d-none">Loading message</span>
    </div>
  </div>
  <div class="text-input component-max-width mb-large">
    <div class="text-input-container">
      <label for="username21" class="is-required">Suis leges gentium superbas fundamenta et oppressas et velut parens.</label>
      <input type="text" class="text-input-field" id="username21" placeholder="ici on a un placeholder" required aria-invalid="true">
    </div>
  </div>
  <div class="text-input component-max-width mb-large">
    <div class="text-input-container">
      <label for="username3" class="is-required">Username</label>
      <input type="text" class="text-input-field" id="username3" placeholder=" " required>
    </div>
  </div>
  <div class="text-input component-max-width mb-large">
    <div class="text-input-container">
      <label for="username31" class="is-required">Username</label>
      <input type="text" class="text-input-field" id="username31" placeholder=" " required aria-invalid="true">
    </div>
  </div>
  <div class="text-input component-max-width mb-large">
    <div class="text-input-container">
      <label for="username4" class="is-required">Username</label>
      <input type="text" class="text-input-field" id="username4" placeholder="ici on a un placeholder" required>
    </div>
  </div>
  <div class="text-input component-max-width mb-large">
    <div class="text-input-container">
      <label for="username41" class="is-required">Username</label>
      <input type="text" class="text-input-field" id="username41" placeholder="ici on a un placeholder" required aria-invalid="true">
    </div>
  </div>`} />
