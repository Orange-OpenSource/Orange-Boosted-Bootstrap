...
<Callout type="info" name="info-floating-label-browserslist" action="Please refer to the Browsers documentation for more details." actionHref={getVersionedDocsPath('/getting-started/browsers-devices')} />
...
<Example buttonLabel="text input with helper text" code={`<div class="text-input">
  ...
  <Example buttonLabel="Bootstrap compatibility: inline text input with helper text" code={`<div class="row g-large align-items-center">
    <div class="col-auto">
...
Since the helper link is the direct next element after the text input, it is not necessary to use the `aria-describedby` attribute on the text input for the helper link.
...
<Example buttonLabel="text inputs with helper link" code={`<div class="text-input mb-medium">
  ...
  <div class="text-input">
    <div class="text-input-container">
      ...
      <input type="text" id="inputTextWithHelperLink" class="text-input-field" placeholder=" ">
    </div>
...
<Example buttonLabel="disabled text inputs" code={`<div class="text-input mb-medium">
  ...
  <div class="text-input">
    <div class="text-input-container">
      ...
      <button disabled class="btn btn-minimal btn-icon" type="button">
        <svg aria-hidden="true">
          <use xlink:href="${getVersionedDocsPath('/assets/img/ouds-web-sprite.svg#heart-empty')}"/>
        </svg>
        <span class="visually-hidden">Add to favorites</span>
...
<BootstrapCompatibility>
  ...
  <Example buttonLabel="Bootstrap compatibility: disabled text inputs" code={`<input class="form-control" type="text" placeholder="Disabled input" aria-label="Disabled input example" disabled>
...
<Example buttonLabel="loading button inside input" code={`<div class="text-input mb-medium">
    <div class="text-input-container">
      ...
      <button disabled class="btn btn-minimal btn-icon loading-indeterminate" type="button">
        <svg aria-hidden="true">
          <use xlink:href="${getVersionedDocsPath('/assets/img/ouds-web-sprite.svg#heart-empty')}"/>
        </svg>
        <span class="visually-hidden">Add to favorites</span>
