...
<Example buttonLabel="supra bar" class="p-none" code={`<nav class="navbar navbar-expand-lg supra" aria-label="Supra navigation - With an additional languages navbar example">
    <div class="container-fluid container-max-width">
