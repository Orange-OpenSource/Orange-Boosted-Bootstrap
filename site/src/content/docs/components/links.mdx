...
Links are available in two sizes and two densities. Add `.link-small` for small size link. Add `.link-compact` for compact density link. You can combine both classes to have a small and compact link.
