...
<Example code={`<a class="link" href="#">This is an example of link</a>`} />
...
<Example code={`<button class="link" type="submit">Button link</button>`} />
...
<Example class="p-none bd-first-rounded" code={`<div class="bg-surface-brand-primary p-large">
...
<Example code={`<div><a class="link link-chevron" href="#">Link with chevron</a></div>
...
<Example code={`<div><a class="link" aria-disabled="true">This is an example of a disabled link</a></div>
...
<Example code={`<div><a href="#" class="link" tabindex="-1" aria-disabled="true">Disabled link without any useful information</a></div>
...
<Example code={`<div><a class="link" href="#">This is an example of a link</a></div>
