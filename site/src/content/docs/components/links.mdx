...
<Example buttonLabel="standard variant" code={`<a class="link" href="#">This is an example of link</a>`} />
...
<Example buttonLabel="variants on colored background" class="p-none" code={`<div class="bg-brand-primary p-lg">
...
<Example buttonLabel="link chevron" code={`<div><a class="link link-chevron" href="#">Link with chevron</a></div>
...
<Example buttonLabel="icon link" code={`<div>
...
<Example buttonLabel="link sizes" code={`<div><a class="link" href="#">This is an example of a link</a></div>
...
<Example buttonLabel="link with other tags" code={`<div><button class="link link" type="submit">Button link</button></div>
...
<Example buttonLabel="disabled state" code={`<div><a class="link" aria-disabled="true">This is an example of a disabled link</a></div>
...
<Example buttonLabel="disabled state while keeping `href`" code={`<div><a href="#" class="link" tabindex="-1" aria-disabled="true">Disabled link without any useful information</a></div>
