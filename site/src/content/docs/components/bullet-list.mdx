...
<Example code={`<style>
    .bullet-list-heart {
      --bs-bullet-list-custom-marker: ${getConfig().brand === 'orange'
...
<Example code={`<ul class="bullet-list" style="--bs-bullet-list-custom-marker: url(${getConfig().brand === 'orange'
...
<Example code={`<style>
    .marker-calendar {
      --bs-bullet-list-custom-marker: url(${getConfig().brand === 'orange'
