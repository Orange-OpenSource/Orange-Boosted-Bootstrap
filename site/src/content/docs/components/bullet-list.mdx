---
title: Bullet list
description: Bullet list is a UI element that allows users to view related individual text items grouped together, with items typically starting with a number or a bullet.
aliases:
...
Bullet list is a UI element that allows users to view related individual text items grouped together, with items typically starting with a number or a bullet.
...
Bullet list can be [unordered](#unordered-lists), [ordered](#ordered-lists), [bare](#bare-lists) or a [mix](#mixed-lists). All types are based on the class `.bullet-list` applied to an `ul` or `ol` element.
...
<Example buttonLabel="basic bullet list" code={`<ul class="bullet-list">
    <li>Item</li>
    <li>Item</li>
    <li>Item</li>
  </ul>`} />
...
<Example buttonLabel="nested unordered bullet list" code={`<ul class="bullet-list">
    <li>Bullet lists</li>
    <li>Can have:
      <ul>
        <li>Nested lists</li>
...
<Example buttonLabel="default body color for bullet list marker" code={`<ul class="bullet-list bullet-list-default-color">
    <li>Item</li>
    <li>Item
      <ul>
        <li>Sub item</li>
...
<Example buttonLabel="brand color and default body color for bullet list markers" code={`<ul class="bullet-list bullet-list-default-color">
    <li>Item</li>
    <li>Item
...
<Example buttonLabel="custom bullet list marker using CSS class" code={`<style>
    .bullet-list-heart {
...
<Example buttonLabel="custom bullet list marker using inline SVG" code={`<ul class="bullet-list" style="--bs-bullet-list-custom-marker: url(${getConfig().brand === 'orange' || getConfig().brand === 'orange-compact'
...
<Example buttonLabel="different custom bullet list markers" code={`<style>
    .marker-calendar {
...
<Example buttonLabel="tick bullet list marker using SCSS" class="bd-bullet-list" code={`<!--
...
<Example buttonLabel="tick bullet list marker using a custom marker" code={`<style>
    .bullet-with-tick {
      --bs-bullet-list-custom-marker: ${getConfig().brand === 'orange' || getConfig().brand === 'orange-compact'
        ? `url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 20'><path fill-rule='evenodd' d='M15.474 9.514 10 15.577 4.526 9.514l-.002-.003A2.868 2.868 0 0 1 8.69 5.572l.838.796.472.455.472-.455.838-.796.008-.008a2.868 2.868 0 0 1 4.159 3.947l-.003.003Zm1.251-5.302A4.78 4.78 0 0 0 10 4.18a4.78 4.78 0 0 0-6.815 6.7L10 18.393l6.815-7.514a4.78 4.78 0 0 0-.09-6.667Z'/></svg>")`
...
<Example buttonLabel="basic ordered list" code={`<ol class="bullet-list">
    <li>Step</li>
    <li>Step</li>
    <li>Step</li>
    <li>Step</li>
...
<Example buttonLabel="nested ordered lists" code={`<ol class="bullet-list">
    <li>Category</li>
    <li>Category
      <ol>
        <li>Subcategory</li>
...
<Example buttonLabel="mixed lists" code={`<ol class="bullet-list">
...
<Example buttonLabel="mixed lists" code={`<ul class="bullet-list bullet-list-bare">
...
<Example buttonLabel="body medium bullet list" code={`<ul class="bullet-list fs-bm">
...
<Example buttonLabel="font weight normal bullet list" code={`<ul class="bullet-list fw-normal">
    <li>This is a list</li>
...
<Example buttonLabel="unstyled list" code={`<ul class="list-unstyled">
    <li>This is a list.</li>
...
<Example buttonLabel="inline list" code={`<ul class="list-inline">
...
<Example buttonLabel="native list" showMarkup={false} code={`<ul>
...
<SkeletonRedirect component="bullet list" />

<Example buttonLabel="bullet list skeleton" code={`<div aria-busy="true" inert>
    <ul class="bullet-list">
      <li>Item</li>
      <li>Item</li>
      <li>Item</li>
