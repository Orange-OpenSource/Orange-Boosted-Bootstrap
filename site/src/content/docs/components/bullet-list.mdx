...
The tick marker is not shipped by default in the OUDS Web CSS, you can set the [`$enable-bullet-list-tick` variable]([[docsref:/foundation/options]]) to `true` if you are using OUDS Web Sass source files.
