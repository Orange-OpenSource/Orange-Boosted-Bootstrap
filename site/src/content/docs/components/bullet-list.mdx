...
<Example code={`<style>
    .bullet-list-heart {
      --bs-bullet-list-custom-marker: ${getConfig().brand === 'orange' || getConfig().brand === 'orange-business-tools'
...
<Example code={`<ul class="bullet-list" style="--bs-bullet-list-custom-marker: url(${getConfig().brand === 'orange' || getConfig().brand === 'orange-business-tools'
...
<Example code={`<style>
    .marker-calendar {
      --bs-bullet-list-custom-marker: url(${getConfig().brand === 'orange' || getConfig().brand === 'orange-business-tools'
