...
<Example buttonLabel="brand color and default body color for markers" code={`<ul class="bullet-list bullet-list-default-color">
    <li>Item</li>
    <li>Item
...
<Example buttonLabel="custom marker using CSS class" code={`<style>
    .bullet-list-heart {
...
<Example buttonLabel="custom marker using inline SVG" code={`<ul class="bullet-list" style="--bs-bullet-list-custom-marker: url(${getConfig().brand === 'orange' || getConfig().brand === 'orange-compact'
...
<Example buttonLabel="different custom markers" code={`<style>
    .marker-calendar {
...
<Example buttonLabel="tick marker using SCSS" class="bd-bullet-list" code={`<!--
...
<Example buttonLabel="tick marker using a custom marker" code={`<style>
    .bullet-with-tick {
      --bs-bullet-list-custom-marker: ${getConfig().brand === 'orange' || getConfig().brand === 'orange-compact'
        ? `url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 20'><path fill-rule='evenodd' d='M15.474 9.514 10 15.577 4.526 9.514l-.002-.003A2.868 2.868 0 0 1 8.69 5.572l.838.796.472.455.472-.455.838-.796.008-.008a2.868 2.868 0 0 1 4.159 3.947l-.003.003Zm1.251-5.302A4.78 4.78 0 0 0 10 4.18a4.78 4.78 0 0 0-6.815 6.7L10 18.393l6.815-7.514a4.78 4.78 0 0 0-.09-6.667Z'/></svg>")`
