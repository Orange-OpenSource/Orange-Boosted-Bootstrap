...
<Example code={`<ul role="tablist" aria-owns="nav-tab1 nav-tab2 nav-tab3 nav-tab4" class="nav nav-tabs" id="nav-tab-with-nested-tabs">
...
<Example code={`<ul class="nav nav-underline nav-fill">
    <li class="nav-item">
      <a class="nav-link active" aria-current="page" href="#">Active</a>
    </li>
    <li class="nav-item">
...
<Example code={`<nav class="nav nav-underline nav-fill">
    <a class="nav-link active" aria-current="page" href="#">Active</a>
    <a class="nav-link" href="#">Much longer nav link</a>
    <a class="nav-link" href="#">Link</a>
    <a class="nav-link disabled" aria-disabled="true">Disabled</a>
...
<Example code={`<ul class="nav nav-underline nav-justified">
    <li class="nav-item">
      <a class="nav-link active" aria-current="page" href="#">Active</a>
    </li>
    <li class="nav-item">
...
<Example code={`<nav class="nav nav-underline nav-justified">
    <a class="nav-link active" aria-current="page" href="#">Active</a>
    <a class="nav-link" href="#">Much longer nav link</a>
    <a class="nav-link" href="#">Link</a>
    <a class="nav-link disabled" aria-disabled="true">Disabled</a>
...
<Example code={`<nav class="nav nav-underline flex-column flex-sm-row">
...
<ScssDocs name="tab-content-css-vars" file="scss/_nav.scss" />
...
<Example showMarkup={false} code={`<ul class="nav nav-tabs" id="myTab" role="tablist">
    <li class="nav-item" role="presentation">
...
<Example showMarkup={false} code={`<nav>
...
<Example showMarkup={false} code={`<ul class="nav nav-underline mb-3" id="pills-tab" role="tablist">
    <li class="nav-item" role="presentation">
...
<Example showMarkup={false} code={`<div class="d-flex align-items-start">
