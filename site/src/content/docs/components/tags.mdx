...
<Example buttonLabel="colored tags" code={`<ul class="list-unstyled d-flex flex-wrap column-gap-xsmall row-gap-md" aria-label="Muted colors">
  ...
  <ul class="list-unstyled d-flex flex-wrap column-gap-xsmall row-gap-md" aria-label="Emphasized colors">
...
<Example buttonLabel="squared tags" code={`<ul class="list-unstyled d-flex flex-wrap column-gap-xsmall row-gap-md" aria-label="Keywords">
...
<Example showMarkup={false} code={`<ul class="list-unstyled d-flex flex-wrap column-gap-xsmall row-gap-md" aria-label="Muted bullet tag examples">
  ...
  <ul class="list-unstyled d-flex flex-wrap column-gap-xsmall row-gap-md" aria-label="Emphasized bullet tag examples">
...
<Example buttonLabel="bullet tags" showPreview={false} code={`<ul class="list-unstyled d-flex flex-wrap column-gap-xsmall row-gap-md" aria-label="...">
    ...
    <li class="tag text-bg-status-neutral-muted">
      <span class="tag-bullet"></span>
      Neutral muted
...
<Example buttonLabel="functional status tags" showMarkup={true} code={`<ul class="list-unstyled d-flex flex-wrap column-gap-xsmall row-gap-md" aria-label="Functional muted statuses">
    <li class="tag text-bg-status-positive-muted">
  ...
  <ul class="list-unstyled d-flex flex-wrap column-gap-xsmall row-gap-md" aria-label="Functional emphasized statuses">
    <li class="tag text-bg-status-positive-emphasized">
      <span class="tag-status-icon"></span>
...
<Example  buttonLabel="non-functional status tags" showMarkup={true} code={`<ul class="list-unstyled d-flex flex-wrap column-gap-xsmall row-gap-md" aria-label="Non-functional muted statuses">
    <li class="tag text-bg-status-neutral-muted">
  ...
  <ul class="list-unstyled d-flex flex-wrap column-gap-xsmall row-gap-md" aria-label="Non-functional emphasized statuses">
    <li class="tag text-bg-status-neutral-emphasized">
      <svg aria-hidden="true" class="tag-icon">
        <use xlink:href=${getVersionedDocsPath('assets/img/ouds-web-sprite.svg#heart-empty')} />
      </svg>
...
<Example buttonLabel="disabled tags" showMarkup={true} code={`<div class="disabled mb-md">
...
<Example buttonLabel="small tags" code={`<ul class="list-unstyled d-flex flex-wrap column-gap-xsmall row-gap-md" aria-label="Mobile coverage">
...
<Example buttonLabel="tags layout" code={`<ul class="list-unstyled d-flex column-gap-xs" aria-label="Mobile coverage">
    <li class="tag">Roaming</li>
    <li class="tag">5G Ready</li>
    <li class="tag">4G</li>
  </ul>
...
<Example buttonLabel="tags list layout" code={`<ul class="list-unstyled d-flex flex-wrap col-4 column-gap-xsmall row-gap-md" aria-label="Keywords">
...
<Example buttonLabel="input tags" code={`<ul class="list-unstyled d-flex flex-wrap column-gap-xs" aria-label="Selected mobile coverage">
    <li>
...
<Example buttonLabel="disabled input tags" code={`<ul class="list-unstyled d-flex flex-wrap column-gap-xs" aria-label="Selected mobile coverage">
    <li>
...
<Example buttonLabel="input tags layout" code={`<ul class="list-unstyled d-flex flex-wrap col-4 column-gap-xs" aria-label="Selected keywords">
