...
<Example code={`<ul class="list-unstyled m-0 d-flex gap-2 flex-wrap m-0">
...
<Example code={`<ul class="list-unstyled d-flex gap-2 flex-wrap m-0">
    <li>
...
<Example code={`<ol class="list-unstyled d-flex gap-2 flex-wrap m-0">
...
<Example class="d-flex gap-2 align-items-center" code={`<ul class="list-unstyled d-flex gap-2 flex-wrap m-0">
...
<CalloutDeprecatedDarkVariants component="tag" />
...
<Example class="d-flex flex-wrap gap-2 align-items-center" code={`<h3 class="visually-hidden">Small tag variant</h3>
...
<Example class="d-flex flex-wrap gap-2 align-items-center" code={`<h3 class="visually-hidden">Disabled tags for the different variants</h3>
...
<ScssDocs name="tag-css-vars" file="scss/_tags.scss" />
...
<ScssDocs name="tag-sm-css-vars" file="scss/_tags.scss" />

### Sass Variables

Variables for all tags:

<ScssDocs name="tag-variables" file="scss/_variables.scss" />

Variables for the [small tag](#sizes):

<ScssDocs name="tag-sm-variables" file="scss/_variables.scss" />
