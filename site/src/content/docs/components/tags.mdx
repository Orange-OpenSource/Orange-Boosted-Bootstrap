...
When inserting tags into a list, wrap the list in a semantic container (usually a `<ul>` or `<ol>`). If the purpose of the tags is not clear enough (especially without visually context), an `aria-label` must be added to the container to explain the function of the tags.
</Callout>
...
<Example code={`<ul class="list-unstyled d-flex flex-wrap col-4 column-gap-xs" aria-label="Selected keywords">
    <li><button type="button" class="tag tag-input">Label 1<span class="visually-hidden">Remove this tag</span></li></button></li>
    <li><button type="button" class="tag tag-input">Label 2<span class="visually-hidden">Remove this tag</span></li></button></li>
    <li><button type="button" class="tag tag-input">Label 3<span class="visually-hidden">Remove this tag</span></li></button></li>
    <li><button type="button" class="tag tag-input">Label 4<span class="visually-hidden">Remove this tag</span></li></button></li>
    <li><button type="button" class="tag tag-input">Label 5<span class="visually-hidden">Remove this tag</span></li></button></li>
    <li><button type="button" class="tag tag-input">Label 6<span class="visually-hidden">Remove this tag</span></li></button></li>
  </ul>`} />
