...
<Example buttonLabel="squared tags" code={`<ul class="list-unstyled d-flex flex-wrap column-gap-xs row-gap-md" aria-label="Keywords">
...
<Example buttonLabel="bullet tags" showMarkup={false} code={`<ul class="list-unstyled d-flex flex-wrap column-gap-xs row-gap-md" aria-label="Muted bullet tag examples">
...
<Example buttonLabel="bullet tags" showPreview={false} code={`<ul class="list-unstyled d-flex flex-wrap column-gap-xs row-gap-md" aria-label="...">
    ...
    <li class="tag text-bg-status-neutral-muted">
      <span class="tag-bullet"></span>
      Neutral muted
...
<Example buttonLabel="functional status tags" showMarkup={true} code={`<ul class="list-unstyled d-flex flex-wrap column-gap-xs row-gap-md" aria-label="Functional muted statuses">
    <li class="tag text-bg-status-positive-muted">
...
<Example  buttonLabel="non-functional status tags" showMarkup={true} code={`<ul class="list-unstyled d-flex flex-wrap column-gap-xs row-gap-md" aria-label="Non-functional muted statuses">
    <li class="tag text-bg-status-neutral-muted">
...
<Example buttonLabel="small tags" code={`<ul class="list-unstyled d-flex flex-wrap column-gap-xs row-gap-md" aria-label="Mobile coverage">
...
<Example buttonLabel="tags list layout" code={`<ul class="list-unstyled d-flex flex-wrap col-4 column-gap-xs row-gap-md" aria-label="Keywords">
