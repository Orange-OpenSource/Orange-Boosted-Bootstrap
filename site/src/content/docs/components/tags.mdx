...
<Example buttonLabel="colored tags" code={`<ul class="list-unstyled d-flex flex-wrap column-gap-xsmall row-gap-medium" aria-label="Muted colors">
  ...
  <ul class="list-unstyled d-flex flex-wrap column-gap-xsmall row-gap-medium" aria-label="Emphasized colors">
...
<Example showMarkup={false} code={`<ul class="list-unstyled d-flex flex-wrap column-gap-xsmall row-gap-medium" aria-label="Muted bullet tag examples">
...
<Example buttonLabel="bullet tags" showPreview={false} code={`<ul class="list-unstyled d-flex flex-wrap column-gap-xsmall row-gap-medium" aria-label="...">
    ...
    <li class="tag text-bg-status-neutral-muted">
      <span class="tag-bullet"></span>
      Neutral muted
...
<Example buttonLabel="functional status tags" showMarkup={true} code={`<ul class="list-unstyled d-flex flex-wrap column-gap-xsmall row-gap-medium" aria-label="Functional muted statuses">
    <li class="tag text-bg-status-positive-muted">
  ...
  <ul class="list-unstyled d-flex flex-wrap column-gap-xsmall row-gap-medium" aria-label="Functional emphasized statuses">
    <li class="tag text-bg-status-positive-emphasized">
      <span class="tag-status-icon"></span>
...
<Example  buttonLabel="non-functional status tags" showMarkup={true} code={`<ul class="list-unstyled d-flex flex-wrap column-gap-xsmall row-gap-medium" aria-label="Non-functional muted statuses">
    <li class="tag text-bg-status-neutral-muted">
  ...
  <ul class="list-unstyled d-flex flex-wrap column-gap-xsmall row-gap-medium" aria-label="Non-functional emphasized statuses">
    <li class="tag text-bg-status-neutral-emphasized">
      <svg aria-hidden="true" class="tag-icon">
        <use xlink:href=${getVersionedDocsPath('assets/img/ouds-web-sprite.svg#heart-empty')} />
      </svg>
...
For example, before loading, your tag could be like this:
  ...
  <Example buttonLabel="loading tag" code={`<p class="tag text-bg-status-accent-emphasized">
...
<Example buttonLabel="currently loading tag" code={`<p class="tag text-bg-status-accent-emphasized loading">
    <svg viewBox='0 0 40 40' xmlns='http://www.w3.org/2000/svg' class="tag-loader" aria-hidden="true">
      <circle class="tag-loader-inner" cx="20" cy="20" r="15"></circle>
    </svg>
...
<Example buttonLabel="small tags" code={`<ul class="list-unstyled d-flex flex-wrap column-gap-xsmall row-gap-medium" aria-label="Mobile coverage">
    ...
    <li class="tag text-bg-status-accent-emphasized tag-small loading">
      <svg viewBox='0 0 40 40' xmlns='http://www.w3.org/2000/svg' class="tag-loader" aria-hidden="true">
        <circle class="tag-loader-inner" cx="20" cy="20" r="15"></circle>
      </svg>
      <span role="status" class="visually-hidden">Loading</span>
...
<Callout type="warning">
Input tags lists must be wrapped in a semantic container (usually a `<ul>` or `<ol>`). *If possible, display a semantically informative text to describe the tags' list purpose*, otherwise an `aria-label` must be added to the container to explain the function of the tags, [more information here](#accessibility).
</Callout>
