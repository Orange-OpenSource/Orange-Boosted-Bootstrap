---
title: Tags
description: Tag is a UI element that displays short information such as a label, a keyword or a category.
aliases:
  ...
  <li class="col">
    <div class="card position-relative h-100">
      ...
      <div class="card-body border-default border-thin border-top">
        <a class="stretched-link" href="#tag">Tag</a> is a UI element that displays short information such as a label, a keyword or a category.
      </div>
    </div>
  </li>
  <li class="col">
    <div class="card position-relative h-100">
      ...
      <div class="card-body border-default border-thin border-top">
        <a class="stretched-link" href="#input-tag">Input tag</a> is a UI element that allows to render an inputted value as a tag, in order to display short information such as a label, a keyword or a category.
      </div>
    </div>
  </li>
</ul>
...
Tag helps users quickly find, group, or understand content. Tags can stay in place or be removed, and can include icons or actions like “close” or “edit”.
...
Input tag is a UI element that allows to render an inputted value as a tag, in order to display short information such as a label, a keyword or a category.

Input tag helps users type and submit values (usually by pressing enter, comma, or tab), and see each value transformed into a tag.
