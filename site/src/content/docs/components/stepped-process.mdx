...
<Example code={`<nav class="stepped-process" aria-label="Checkout process">
...
<CalloutDeprecatedDarkVariants component="stepped-process" />
...
<ScssDocs name="stepped-process-css-vars" file="scss/_stepped-process.scss" />

### Sass variables

<ScssDocs name="stepped-process" file="scss/_variables.scss" />
