...
<Example code={`<div class="progress" role="progressbar" aria-label="Example 20px high" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" style="height: 20px">
    <div class="progress-bar" style="width: 25%"></div>
  </div>`} />
...
<Example code={`<div class="progress progress-xs" role="progressbar" aria-label="Extra small example" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
    <div class="progress-bar" style="width: 25%"></div>
  </div>
...
<ScssDocs name="progress-border-xs-css-vars" file="scss/_progress.scss" />

And the `.progress-sm`:

<ScssDocs name="progress-border-sm-css-vars" file="scss/_progress.scss" />
