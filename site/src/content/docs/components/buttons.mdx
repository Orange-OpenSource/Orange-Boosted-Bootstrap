...
<ul class="list-unstyled row row-cols-1 sm:row-cols-2 xl:row-cols-3">
  ...
  <li class="col">
    <div class="card position-relative h-100">
      <div class="card-top bg-secondary">
        <div class="d-flex align-items-center justify-content-center ratio-16x9" inert>
          <a class="btn btn-assistant" href="#">Default</a>
        </div>
      </div>
...
<Example buttonLabel="navigation buttons with wrapped text" class="bd-btn-example d-flex flex-column align-items-start" code={`<button class="btn btn-default btn-next" type="button">The label remains centered in<br/>multiline mode with an icon</button>
  <button class="btn btn-default btn-previous" type="button">In small contexts the button text wraps automatically to adapt its behavior</button>`} />
...
<Example buttonLabel="basic Assistant buttons" class="bd-btn-example" code={`<a class="btn btn-assistant" href="#">Default</a>

  <button type="button" class="btn btn-assistant">Default</button>`} />
...
<Example buttonLabel="rounded Assistant buttons" class="bd-btn-example" code={`<div class="use-rounded-corner-buttons">
    ...
    <button class="btn btn-assistant">Default</button>
...
<Example buttonLabel="disabled Assistant buttons using `<button>` tag" class="bd-btn-example" code={`<button type="button" class="btn btn-assistant" disabled>Default</button>
...
<Example buttonLabel="navigation buttons with wrapped text" class="bd-btn-example d-flex flex-column align-items-start" code={`<button class="btn btn-assistant" type="button">The label remains centered in<br/>multiline mode with an icon</button>
  <button class="btn btn-assistant" type="button">In small contexts the button text wraps automatically to adapt its behavior</button>`} />
