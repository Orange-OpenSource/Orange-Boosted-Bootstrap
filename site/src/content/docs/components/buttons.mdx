...
<AccessibilityTagsNotice
  className="btn"
  additionalTagsText={`or <code>input </code> (with <code>type</code> equal to  <code>button</code>, <code>reset</code>, or <code>submit</code>)`}
  componentTypeSpecificsText={`For the <a href="#navigation-button">navigation button component</a>, we have used <code>&lt;a&gt;</code> elements in our examples, but this could be adapted to your own context.`}
/>
...
<DisabledState name="buttons">
  <Example slot="buttonExample" buttonLabel="disabled buttons" class="p-none bd-btn-example" code={`<div class="p-large d-flex gap-xsmall flex-wrap">
  ...
  <Example slot="anchorExample" buttonLabel="disabled button links" class="p-none bd-btn-example" code={`<div class="p-large d-flex gap-xsmall flex-wrap">
...
<LoadingState name="button" loadingTimeVariable="bs-btn-loading-time">
  <Example slot="beforeLoading" buttonLabel="loading button before loading" code={`<button type="button" class="btn btn-default" id="loading-btn-0">
    Download file
  ...
  <Example slot="loading" buttonLabel="loading buttons currently loading" class="p-none bd-btn-example" code={`<div class="p-large d-flex gap-xsmall flex-wrap">
...
<LoadingState name="navigation button" referralVersion={true} baseComponentName="button">
  <Example slot="loading" buttonLabel="loading navigation buttons" class="bd-btn-example" code={`<a class="btn btn-next btn-default loading-indeterminate" id="loading-nav-btn-1" aria-disabled="true">
    Next
    <svg viewBox='0 0 40 40' xmlns='http://www.w3.org/2000/svg' class="loader" aria-hidden="true">
      <circle class="loader-inner" cx="20" cy="20" r="17"></circle>
    </svg>
...
<LoadingState name="assistant button" referralVersion={true} baseComponentName="button">
  <Example slot="loading" buttonLabel="loading assistant buttons" class="bd-btn-example" code={`<button type="button" class="btn btn-assistant loading-indeterminate" id="loading-ai-btn-1" disabled>
    Assistant
    <svg viewBox='0 0 40 40' xmlns='http://www.w3.org/2000/svg' class="loader" aria-hidden="true">
      <circle class="loader-inner" cx="20" cy="20" r="17"></circle>
    </svg>
