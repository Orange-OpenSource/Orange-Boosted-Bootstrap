...
<Callout type="warning" title="Transparency and older browsers">
  Due to technical limitations, an assistant button does not have a transparent background on older browsers and Firefox.
...
<Example buttonLabel="assistant button simulated transparent background" class="bd-btn-example" code={`<div class="bg-tertiary">
    ...
    <button class="btn btn-assistant">
      Assistant
    </button>

    <button class="btn btn-assistant" style="--bs-btn-bg: var(--bs-color-bg-tertiary);">
      Assistant
    </button>
...
<Example buttonLabel="assistant button icon-only" class="bd-btn-example" code={`<button class="btn btn-assistant btn-icon">
...
<Example buttonLabel="loading assistant buttons" class="bd-btn-example" code={`<button class="btn btn-assistant loading-indeterminate" id="loading-ai-btn-1" disabled>
    Assistant
    <svg viewBox='0 0 40 40' xmlns='http://www.w3.org/2000/svg' class="loader" aria-hidden="true">
      <circle class="loader-inner" cx="20" cy="20" r="17"></circle>
    </svg>
  ...
  <button class="btn btn-assistant btn-icon loading-indeterminate" id="loading-ai-btn-2" disabled>
    <svg viewBox='0 0 40 40' xmlns='http://www.w3.org/2000/svg' class="loader" aria-hidden="true">
      <circle class="loader-inner" cx="20" cy="20" r="17"></circle>
    </svg>
...
<Example buttonLabel="assistant buttons with wrapped text" class="bd-btn-example d-flex flex-column align-items-start" code={`<button class="btn btn-assistant" type="button">
    The label remains centered in<br/>multiline mode with an icon
  </button>

  <button class="btn btn-assistant" type="button">
    In small contexts the button text wraps automatically to adapt its behavior
  </button>`} />
