...
<Example class="bd-btn-example" code={`<a class="btn btn-default" href="#" role="button">Link</a>
  <input class="btn btn-default" type="reset" value="Reset" />`} />

## Variants

OUDS Web includes several button variants, each serving its own semantic purpose, with a few extras thrown in for more control. Please follow the [Button design specifications](https://r.orange.fr/r/S-ouds-doc-checkbox) to choose the right button for the right action.
