...
By default, a button's width won't exceed `30rem` and will automatically wrap if necessary.  It also natively supports `<br/>` tags to break the text into multiple lines. Read more about text wrapping in a [button](https://unified-design-system.orange.com/472794e18/p/689c55-button/t/b29aae8b37), [navigation button](https://unified-design-system.orange.com/472794e18/p/1469c4-navigation-button/t/99e6bc9526) and [assistant button](https://unified-design-system.orange.com/472794e18/p/689c55-button/t/b29aae8b37).

<Example buttonLabel="buttons with wrapped text" class="bd-btn-example d-flex flex-column align-items-start" code={`<button type="button" class="btn btn-default">
  ...
  <button type="button" class="btn btn-default">
    ...
    The label remains centered with the icon when it wraps automatically
  </button>
  <button type="button" class="btn btn-default btn-assistant">
    In assistant button too, the text will be automatically centered when the text is very long
  </button>


  <button type="button" class="btn btn-default">
    You can force break line<br/>where you want it
  </button>
  <button type="button" class="btn btn-default">
    <svg aria-hidden="true">
      <use xlink:href="${getVersionedDocsPath('/assets/img/ouds-web-sprite.svg#heart-empty')}"/>
    </svg>
    When forcing break line, the label<br/>remains centered with the icon
  </button>
  <button type="button" class="btn btn-default btn-previous">
    In navigation<br/>button too
  </button>
  ...
  <button type="button" class="btn btn-default">
    ...
    When forcing break line, the label remains centered with the icon
  </button>
  <button type="button" class="btn btn-default btn-previous">
    In navigation button too
  </button>`} />
