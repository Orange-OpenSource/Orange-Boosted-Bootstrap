...
<Example class="p-none bd-btn-example" code={`<div class="bg-brand-primary p-lg">
...
<Example class="p-none bd-btn-example" code={`<div class="p-lg d-flex gap-xs flex-wrap">
...
<Example class="bd-btn-example" code={`<div class="p-lg d-flex gap-xs flex-wrap">
...
<Example class="bd-btn-example" code={`<div class="d-grid gap-sm">
...
<Example class="bd-btn-example" code={`<div class="d-grid gap-sm d-md-block">
    <button class="btn btn-default" type="button">Button</button>
    <button class="btn btn-default" type="button">Button</button>
  </div>`} />
...
<Example class="bd-btn-example" code={`<div class="d-grid gap-sm col-6 mx-auto">
    <button class="btn btn-default" type="button">Button</button>
    <button class="btn btn-default" type="button">Button</button>
  </div>`} />
...
<Example class="bd-btn-example" code={`<div class="d-grid gap-sm d-md-flex justify-content-md-end">
