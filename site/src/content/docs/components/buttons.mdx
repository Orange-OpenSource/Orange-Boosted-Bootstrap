...
<Example code={`<button type="button" class="btn btn-primary">Primary</button>
...
<Example code={`<button type="button" class="btn btn-primary btn-sm">
...
<Example code={`<button type="button" class="btn btn-icon btn-outline-secondary btn-sm">
...
<Example code={`<button type="button" class="btn btn-icon btn-no-outline btn-sm">
    <svg width="1rem" height="1rem" fill="currentColor" aria-hidden="true">
      <use xlink:href="/docs/${getConfig().docs_version}/assets/img/boosted-sprite.svg#tick-confirmation"/>
    </svg>
...
<Example code={`<a href="#" class="btn btn-icon btn-social btn-twitter"><span class="visually-hidden">Twitter</span></a>
...
<ScssDocs name="social-buttons" file="scss/_variables.scss" />

## Dark variant

<DeprecatedIn version="5.3.3" />

<CalloutDeprecatedDarkVariants component="btn" />
...
<Example code={`<button type="button" class="btn btn-outline-secondary">Secondary</button>`} />
...
<ScssDocs name="btn-icon" file="scss/mixins/_buttons.scss" />
