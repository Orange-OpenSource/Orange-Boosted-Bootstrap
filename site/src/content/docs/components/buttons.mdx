...
<Example buttonLabel="button base class" code={`<button type="button" class="btn">Base class</button>`} />
...
<Example buttonLabel="standard button variants" class="bd-btn-example" code={`<button type="button" class="btn btn-default">Default</button>
...
<Example buttonLabel="variants on colored backgrounds" class="p-none bd-btn-example" code={`<div class="bg-brand-primary p-lg">
    <div data-bs-theme="${getMode('modes-on-brand-primary')}" class="d-flex gap-xs flex-wrap">
  ...
  <div class="bg-status-negative-emphasized p-lg">
    <div data-bs-theme="${getMode('modes-on-status-negative-emphasized')}" class="d-flex gap-xs flex-wrap">
      <button type="button" class="btn btn-default btn-on-colored-bg">Default</button>
      <button type="button" class="btn btn-strong btn-on-colored-bg">Strong</button>
      <button type="button" class="btn btn-minimal btn-on-colored-bg">Minimal</button>
      <!-- BEWARE: \`.btn-negative\` and \`.btn-brand\` should never be used on colored backgrounds! -->
...
<Callout type="warning">
Icons in text and icon buttons are considered purely decorative, so they should be hidden from assistive technologies using `aria-hidden="true"`, as we’ve done in our examples. See [icons accessibility]([[docsref:/extend/icons#icons-accessibility]]) for more info.
</Callout>
...
<Example buttonLabel="text and icon buttons" class="p-none bd-btn-example" code={`<div class="p-lg d-flex gap-xs flex-wrap">
...
<Callout type="warning">
For icon only buttons, we chose to keep the icon hidden from assistive technologies and add a visually hidden label. See [icons accessibility]([[docsref:/extend/icons#icons-accessibility]]) for more info.
</Callout>

{/* TODO: Add a paragraph about tooltip and/or title */}

<Example buttonLabel="icon only buttons" class="p-none bd-btn-example" code={`<div class="p-lg d-flex gap-xs flex-wrap">
...
<Example buttonLabel="buttons with other tags" class="bd-btn-example" code={`<a class="btn btn-default" href="#" role="button">Link</a>
  <button class="btn btn-strong" type="submit">Button</button>
  <button class="btn btn-brand" type="submit">Button</button>
...
<Example buttonLabel="outline buttons" class="bd-btn-example" code={[
...
<Example buttonLabel="disabled state" class="p-none bd-btn-example" code={`<div class="p-lg d-flex gap-xs flex-wrap">
...
<Example buttonLabel="disabled state with `<a>` tag" class="p-none bd-btn-example" code={`<div class="p-lg d-flex gap-xs flex-wrap">
...
<Example buttonLabel="before loading state" code={`<button type="button" class="btn btn-default" id="loading-btn-0">
    Download file
...
<Example buttonLabel="currently loading state" class="p-none bd-btn-example" code={`<div class="p-lg d-flex gap-xs flex-wrap">
...
<Example buttonLabel="loading state with variants" class="bd-btn-example" code={`<div class="p-lg d-flex gap-xs flex-wrap">
...
<Example buttonLabel="block buttons" class="bd-btn-example" code={`<div class="d-grid gap-sm">
...
<Example buttonLabel="block buttons variation" class="bd-btn-example" code={`<div class="d-grid gap-sm d-md-block">
    <button class="btn btn-default" type="button">Button</button>
    <button class="btn btn-default" type="button">Button</button>
  </div>`} />
...
<Example buttonLabel="block buttons with grid system" class="bd-btn-example" code={`<div class="d-grid gap-sm col-6 mx-auto">
    <button class="btn btn-default" type="button">Button</button>
    <button class="btn btn-default" type="button">Button</button>
  </div>`} />
...
<Example buttonLabel="block buttons with flex utilities" class="bd-btn-example" code={`<div class="d-grid gap-sm d-md-flex justify-content-md-end">
