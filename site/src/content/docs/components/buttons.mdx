...
<ul class="list-unstyled row row-cols-1 row-cols-sm-2">
  ...
  <li class="col">
    <div class="card position-relative h-100">
      <div class="card-top bg-inverse-low" aria-hidden="true">
        <div class="d-flex align-items-center justify-content-center ratio-16x9" data-bs-theme={getMode('modes-on-bg-inverse-low')}>
          <button type="button" class="btn btn-default">Next todo</button>
        </div>
      </div>
...
<Example showToolbar={false} code={`<button type="button" class="btn btn-default">Next todo</button>`} />
...
For any navigation purpose, an `<a>` element should be used, and it must have an `href` attribute.

The visual rendering will remain the same anyway:

<Example class="bd-btn-example" code={`<a class="btn btn-default" href="#">Link</a>
...
<Example class="bd-btn-example" code={[
...
<Example class="p-none bd-btn-example bd-first-rounded" code={`<div class="bg-surface-brand-primary p-large">
...
<Example code={`<button type="button" class="btn btn-default" id="loading-btn-0">
    Download file
...
<Example class="bd-btn-example" code={`<div class="p-large d-flex gap-xsmall flex-wrap">
...
<Example class="bd-btn-example" code={`<div class="d-grid gap-small">
...
<Example class="bd-btn-example" code={`<div class="d-grid gap-small d-md-block">
    <button class="btn btn-default" type="button">Button</button>
    <button class="btn btn-default" type="button">Button</button>
  </div>`} />
...
<Example class="bd-btn-example" code={`<div class="d-grid gap-small col-6 mx-auto">
    <button class="btn btn-default" type="button">Button</button>
    <button class="btn btn-default" type="button">Button</button>
  </div>`} />
...
<Example class="bd-btn-example" code={`<div class="d-grid gap-small d-md-flex justify-content-md-end">
...
You can use `.btn-previous` and `.btn-next` classes to indicate backward and forward actions in a process or a flow. These classes will add a directional arrow to the left or right of the button text, respectively.

<Example class="bd-btn-example" code={`<a class="btn btn-default btn-previous" href="#">Previous</a>
    <a class="btn btn-default btn-next" href="#">Next</a>
    <button type="button" class="btn btn-default">Default</button>`} />

### Variants

OUDS Web includes several navigation button variants, each serving its own semantic purpose, with a few extras thrown in for more control. Please follow the [button design specifications](https://r.orange.fr/r/S-ouds-doc-button) to choose the right button for the right action.

<Example class="bd-btn-example" code={`<a class="btn btn-default btn-next" href="#">Next</a>
    <a class="btn btn-strong btn-next" href="#">Next</a>
    <a class="btn btn-brand btn-next" href="#">Next</a>
    <a class="btn btn-minimal btn-next" href="#">Next</a>
    <a class="btn btn-negative btn-next" href="#">Next</a>
    <button type="button" class="btn btn-strong">Strong</button>
    <button type="button" class="btn btn-brand">Brand</button>
    <button type="button" class="btn btn-minimal">Minimal</button>
    <button type="button" class="btn btn-negative">Negative</button>`} />
