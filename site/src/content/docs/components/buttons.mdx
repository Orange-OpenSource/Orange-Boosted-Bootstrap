...
<ul class="list-unstyled grid gap-medium">
  ...
  <li class="g-col-6">
    <div class="card position-relative h-100">
      <div class="card-top bg-secondary">
        <div class="d-flex align-items-center justify-content-center ratio-16x9" inert>
          <a class="btn btn-expand btn-default" href="#">Expand</a>
        </div>
      </div>
...
You can use `.btn-expand` class to indicate a [dropdown menu]([[docsref:/components/dropdown]]) can be expanded. This class will add a directional arrow to the left of the button text. As expand buttons generally indicate a dropdown menu, in our examples, we have used `<button>` elements, but this could be adapted to your own context.
