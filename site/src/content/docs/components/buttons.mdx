...
<ul class="list-unstyled row row-cols-1 row-cols-sm-2">
  <li class="col">
    <div class="card position-relative h-100">
      <div class="card-top bg-inverse-low">
        <div class="d-flex align-items-center justify-content-center ratio-16x9" data-bs-theme={getMode('modes-on-bg-inverse-low')} inert>
