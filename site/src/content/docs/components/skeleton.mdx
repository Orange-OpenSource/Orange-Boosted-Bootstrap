...
added:
  version: "1.2"
extra_js:
  - src: "[[docsref:/assets/js/skeleton.js]]"
    async: true
---
...
Everything that is a skeleton should be hidden either via `[inert]` attribute, or via `[aria-hidden]` attribute, `[tabindex="-1"]` attribute, and `pointer-events: none` CSS rule if possible. This is to prevent assistive technologies from reading the content of the skeleton, and to prevent users from interacting with it.
...
You can set size of the skeletons either via inline styles, via our [sizing utility]([[docsref:/utilities/sizing/]]), via our [ratio utility]([[docsref:/utilities/aspect-ratio/]]), or via our [columns utility]([[docsref:/layout/columns/]]).

<Example buttonLabel="Show skeleton" code={`<div class="skeleton" style="width: 100%; height: 150px;" inert></div>`} />
...
<JsDocs name="skeleton-first-example" file="site/static/[brand]/docs/[version]/assets/js/skeleton.js" />
...
<JsDocs name="skeleton-second-example" file="site/static/[brand]/docs/[version]/assets/js/skeleton.js" />
