...
<Example code={`<div id="carouselExamplePause" class="carousel slide" data-bs-ride="carousel" data-bs-pause="false">
...
<Example code={`<div id="carouselExampleNoWrap" class="carousel slide" data-bs-wrap="false" data-bs-ride="carousel">
    <div class="carousel-indicators">
...
<Example code={`<div id="carouselExampleNoRide" class="carousel slide is-static">
    <div class="carousel-indicators">
