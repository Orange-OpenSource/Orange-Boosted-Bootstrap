...
| ---- | ------- | ----------- |
| Ref design | {getData('_components-versions').find(component => component.name === frontmatter.title.toLowerCase()).value} | This represents the last implemented design version in OUDS Web. |
| Ref tokens | {''} | This represents the last implemented tokens version in OUDS Web. |
</BsTable>
