...
Badges - count is rendered as a colored shape, displaying numerical values; and its chosen size remains unchanged regardless of the changes of the interface size.
...
Badges - icon is rendered as a colored shape, displaying icon; and its chosen size remains unchanged regardless of the changes of the interface size.
