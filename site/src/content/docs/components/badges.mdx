---
title: Badges
description: Badge is a UI element that emphasizes system notifications, status, or the categorization of an information.
aliases:
...
<ul class="list-unstyled row row-cols-1 row-cols-sm-3">
  <li class="col">
    <div class="card position-relative h-100">
      ...
      <div class="card-body border-default border-thin border-top"><a class="stretched-link" href="#badge">Badge</a> is a UI element that emphasizes system notifications, status, or the categorization of an information, throughout color only.</div>
    </div>
  </li>
  <li class="col">
    <div class="card position-relative h-100">
      ...
      <div class="card-body border-default border-thin border-top"><a class="stretched-link" href="#badge---count">Badge - Count</a> is a UI element that emphasizes system notifications, status, or the categorization of an information, throughout color and numerical value.</div>
    </div>
  </li>
  <li class="col">
    <div class="card position-relative h-100">
      ...
      <div class="card-body border-default border-thin border-top"><a class="stretched-link" href="#badge---icon">Badge - Icon</a> is a UI element that emphasizes system notifications, status, or the categorization of an information, throughout color and iconography.</div>
    </div>
  </li>
</ul>
...
Badge is a UI element that emphasizes system notifications, status, or the categorization of an information, throughout color only.

Badge is rendered as a colored shape, without icon, text or number; and its chosen size remains unchanged regardless of the changes of the interface size.
...
Badge - count is a UI element that emphasizes system notifications, status, or the categorization of an information, throughout color and numerical value.

Badge - count is rendered as a colored shape, displaying numerical values; and its chosen size remains unchanged regardless of the changes of the interface size.
...
Badge - icon is a UI element that emphasizes system notifications, status, or the categorization of an information, throughout color and iconography.

Badge - icon is rendered as a colored shape, displaying icon; and its chosen size remains unchanged regardless of the changes of the interface size.
