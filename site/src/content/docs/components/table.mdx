...
<Example buttonLabel="table with checkboxes row selection" code={`<table class="table has-row-selection" id="tableWithCheckboxes">
...
<Example buttonLabel="table with radio buttons row selection" code={`<table class="table has-row-selection">
