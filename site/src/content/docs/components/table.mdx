...
- For vertical alignment, use the `.align-middle` class on the `<tr>` elements.
...
<Example buttonLabel="table with components and icons" class="table-responsive" code={`<table class="table">
    ...
    <tbody>
      <tr class="align-middle">
        ...
        <td>Much longer cell content which wraps to another line to show the vertical alignment</td>
        <td>
