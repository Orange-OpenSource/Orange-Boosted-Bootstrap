...
<Callout type="warning">
  ...
  <ul class="bullet-list fs-bm">
    <li>`.accordion-button` should have `.px-gridmargin` to align with the rest of the content, read [our documentation about it]([[docsref:/utilities/spacing#grid-measures]]).</li>
    <li>`.navbar-nav` inside the `.footer-nav` should have `.ps-large.ps-md-none` to better convey information.</li>
    <li>Already existing components should be replaced inside the footer, such as the text input and the buttons.</li>
  </ul>
</Callout>
...
<Example class="p-none" code={`<footer class="footer navbar" data-bs-theme="dark">
    ...
    <div class="container-fluid container-max-width footer-terms">
      <ul class="navbar-nav gap-md-large">
        <li class="fw-normal">© Orange 2025</li>
