---
title: Select input
description: Select input is a UI element that enables users to choose one or, in some cases, multiple options from a predefined list.
aliases:
  - "/docs/forms/select/"
  - "/docs/forms/select-input/"
  - "/docs/components/select-input/"
toc: true
---
...
Select input is a UI element that enables users to choose one or, in some cases, multiple options from a predefined list.

Select input appears as a dropdown that shows available options. It is used when the number of choices is limited and known ahead of time, allowing users to select from controlled or standardised values.
...
<Example buttonLabel="Bootstrap compatibility: selected select input" code={`<select class="form-select" aria-label="Default select example">
...
<Example buttonLabel="rounded select inputs" code={`<div class="use-rounded-corner-inputs">
...
<Example buttonLabel="select inputs with leading icon" code={`
  <div class="select-input mb-medium">
    <div class="select-input-container">
...
<Example buttonLabel="select input with helper text" code={`<div class="select-input">
    <div class="select-input-container">
...
Since the helper link is the direct next element after the select input, it is not necessary to use the `aria-describedby` attribute on the select input for the helper link.

<Example buttonLabel="select inputs with helper link" code={`<div class="select-input mb-medium">
    <div class="select-input-container">
...
<Example buttonLabel="disabled select inputs" code={`<div class="select-input mb-medium">
    <div class="select-input-container">
...
<Example buttonLabel="read only select input" code={`<div class="text-input mb-medium">
...
To manually mark a select as invalid, add `aria-invalid="true"` to a `.select-input-field` within the `.select-input-container`.
...
<Example buttonLabel="invalid select inputs" code={`<div class="select-input mb-medium">
    <div class="select-input-container">
      <label id="labelErrorSelect" for="exampleErrorSelect">Select example with error</label>
      <select class="select-input-field" aria-invalid="true" id="exampleErrorSelect" aria-describedby="numberFeedback">
        <option value="" disabled selected></option>
        <option value="1">One</option>
        <option value="2">Two</option>
        <option value="3">Three</option>
  ...
  <div class="was-validated">
    <div class="select-input mb-medium">
      <div class="select-input-container">
        ...
        <select class="select-input-field" aria-invalid="true" id="exampleErrorValidatedSelect" aria-describedby="validatedNumberFeedback">
          <option value="" disabled selected></option>
          <option value="1">One</option>
          <option value="2">Two</option>
          <option value="3">Three</option>
  ...
  <div class="select-input mb-medium">
    <div class="select-input-container select-input-container-outlined">
      ...
      <select class="select-input-field" aria-invalid="true" id="exampleErrorSelect2" aria-describedby="numberFeedback2">
        <option value="" disabled selected></option>
        <option value="1">One</option>
        <option value="2">Two</option>
        <option value="3">Three</option>
  ...
  <div class="select-input mb-medium">
    <div class="select-input-container">
      ...
      <select class="select-input-field" aria-invalid="true" id="exampleErrorSelect3" aria-describedby="numberFeedback3">
        <option value="" disabled selected></option>
        <option value="1">One</option>
        <option value="2">Two</option>
        <option value="3">Three</option>
...
The SVG must already be in the `.select-input-container` for it to work. You should also have a status `<span>` so assistive technologies can announce the loading message.
...
In case of an invalid select, you may remove the invalid state before the loading state.

<Example buttonLabel="loading select inputs" code={`<div class="select-input mb-medium">
    <div class="select-input-container">
      <svg aria-hidden="true">
        <use xlink:href="${getVersionedDocsPath('/assets/img/ouds-web-sprite.svg#heart-empty')}"/>
      </svg>
...
<SkeletonRedirect component="select input" />

<Example buttonLabel="select input skeleton" code={`<div aria-busy="true" inert>
    <div class="select-input">
      <div class="select-input-container">
        <label for="skeletonSelect">Skeleton select example</label>
        <select class="select-input-field" id="skeletonSelect">
          <option value="" disabled selected></option>
          <option value="1">One</option>
          <option value="2">Two</option>
          <option value="3">Three</option>
...
<Example buttonLabel="select input with multiple attribute" code={`<div class="select-input">
    <div class="select-input-container">
...
<Example buttonLabel="select input with size attribute" code={`<div class="select-input">
    <div class="select-input-container">
...
<Example buttonLabel="select input with optgroup" code={`<div class="select-input">
    <div class="select-input-container">
