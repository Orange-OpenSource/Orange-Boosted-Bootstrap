...
<Example buttonLabel="top alignment items" class="d-flex flex-column gap-medium" code={`<div class="item item-navigation item-top">
...
<Callout type="negative">
  The interactive slot should be avoided inside the navigation item as much as possible.
</Callout>

<Example buttonLabel="navigation card item with focusable slot" class="d-flex flex-column gap-medium" code={`<div class="item item-navigation">
    <div class="item-container">
      <div class="item-content">
        <div class="item-leading-container">
          <svg class="w-100 h-100" aria-hidden="true">
