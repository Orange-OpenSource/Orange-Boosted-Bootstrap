...
<Example code={`<nav class="local-nav" aria-label="Basic local navigation">
...
<CalloutDeprecatedDarkVariants component="local-nav" />
...
<ScssDocs name="local-nav-css-vars" file="scss/_local-navigation.scss" />

### Sass variables

<ScssDocs name="local-nav-variables" file="scss/_variables.scss" />
