...
OUDS Web includes a handful of options for including some or all of our compiled CSS. Bootstrap specificities are opted in.
...
| `ouds-web-bootstrap.css`<br /> `ouds-web-bootstrap.min.css`<br /> `ouds-web-bootstrap.rtl.css`<br /> `ouds-web-bootstrap.rtl.min.css` | Included with Bootstrap specificities | Included with Bootstrap specificities | Included with Bootstrap specificities | Included with Bootstrap specificities |
...
| `ouds-web-reboot.css`<br /> `ouds-web-reboot.rtl.css`<br /> `ouds-web-reboot.min.css`<br /> `ouds-web-reboot.rtl.min.css` | — | [Only Reboot]([[docsref:/foundation/reboot]]) | — | — |
</BsTable>
...
The `scss/` and `js/` are the source code for our CSS and JavaScript. The `dist/` folder includes everything listed in the compiled download section above. The `site/src/content/docs/` folder includes the source code for our hosted documentation, including our live examples of OUDS Web usage.
