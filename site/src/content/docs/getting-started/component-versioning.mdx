...
You can find [the components matrix here](https://unified-design-system.orange.com/472794e18/p/73c701-components).
    ...
    componentsDetails
      ...
      .map((component) => (
        <tr>
          ...
          <td>
            <a href={`https://r.orange.fr/r/S-ouds-doc-${component.slug ?? component.name.toLowerCase()}`}>
              Specifications
            </a>
          </td>
        </tr>
