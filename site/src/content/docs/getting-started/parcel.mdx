...
<img class="d-block mx-auto mb-4 img-fluid" src="/docs/[[config:docs_version]]/assets/img/parcel.png" alt="" loading="lazy" />
...
3. **And finally, we can start Parcel.** From the `my-project` folder in your terminal, run that newly added npm script:
   ...
   <img class="img-fluid" src="/docs/[[config:docs_version]]/assets/img/guides/parcel-dev-server.png" alt="Unbranded webpage with the title 'Hello, Boosted and Parcel!' and a default button"/>
...
1. **Let’s import Boosted’s fonts, limited to Orange brand usage**: [see `NOTICE.txt` for more information about Helvetica Neue license]([[config:repo]]/blob/v[[config:current_version]]/NOTICE.txt).
...
4. **And you’re done! 🎉** With Boosted’s source Sass and JS fully loaded, your local development server should now look like this:
   ...
   <img class="img-fluid" src="/docs/[[config:docs_version]]/assets/img/guides/parcel-dev-server-boosted.png" alt="Boosted-branded webpage with the title ’Hello, Boosted and Parcel!’ and an orange primary button"/>
