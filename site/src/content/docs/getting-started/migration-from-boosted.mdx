...
<Callout type="info">
  The [`@ouds/web-migrate`](https://npmx.dev/package/@ouds/web-migrate) CLI can help migrate from Boosted to OUDS Web. Run it against your project files and review the diff afterward:
