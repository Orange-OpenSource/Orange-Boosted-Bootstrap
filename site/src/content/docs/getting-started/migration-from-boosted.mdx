...
- <span class="badge text-bg-status-positive-emphasized">New</span> We provide two brand new themes that are <code>root</code> and <code>root-inverted</code>. They are complementary to `light` and `dark`. See more on our [color modes page]([[docsref:/foundation/color-modes]])
...
- <span class="badge text-bg-status-positive-emphasized">New</span> Body fonts’ sizes are now responsive and can change depending on the screen size. See [Typography]([[docsref:/foundation/typography]]) for more details.
...
- <span class="badge text-bg-status-negative-emphasized">Breaking</span> `.badge` is now rounded by default.
- <span class="badge text-bg-status-positive-emphasized">New</span> `.badge-disabled` has been added.
- <span class="badge text-bg-status-positive-emphasized">New</span> `.badge-xs`, `.badge-sm`, `.badge-lg` have been added to size the badge.
- <span class="badge text-bg-status-positive-emphasized">New</span> `.badge-count` has been added to display a numerical value in the badge.
...
- <span class="badge text-bg-status-positive-emphasized">New</span> The new color-background color helpers are now available. Visit our [color-bg page]([[docsref:/utilities/color-background]]) to see more.
...
- <span class="badge text-bg-status-info-emphasized">Info</span> `.icon-link` and `.link-chevron` are now documented in link component. See [icon link]([[docsref:/components/link#icon-link]]) and [link chevron]([[docsref:/components/link#link-chevron]]).
...
- <span class="badge text-bg-status-warning-emphasized">Warning</span> The vertical rule documentation has been merged into the new [Divider helper]([[docsref:/components/divider]]) documentation.
...
- <span class="badge text-bg-status-positive-emphasized">New</span> The new border color utilities are now available. Visit our [border page]([[docsref:/utilities/border#color]]) to see more.
...
- <span class="badge text-bg-status-positive-emphasized">New</span> The new text color utilities are now available. Visit our [color page]([[docsref:/utilities/color]]) to see more.
