...
- <span class="tag tag-small rounded-none tag-warning">Warning</span> `scss/vendor/rfs.scss` doesn’t exist anymore. You shouldn’t have used it anyway, but we removed it.
