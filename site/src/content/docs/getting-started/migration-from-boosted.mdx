...
- <span class="tag tag-small tag-negative"><span class="tag-status-icon"></span>Breaking</span> List group has changed a lot in its usages. There is still a static example and an interactive variant for navigation. This is not a action button anymore.
...
- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> An item is now fully customizable and can contain many content. New dedicated classes have been added to handle this.
