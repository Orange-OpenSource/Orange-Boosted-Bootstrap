...
3. **Hello, world!** Open the page in your browser of choice to see your OUDS Web page. Now you can start building with OUDS Web by creating your own [layout]([[docsref:/layout/grid]]), adding dozens of [components]([[docsref:/components/button]]), and utilizing [our official examples]([[docsref:/examples]]).
