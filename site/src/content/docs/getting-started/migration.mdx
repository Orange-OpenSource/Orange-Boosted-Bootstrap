...
- <span class="tag tag-small tag-info"><span class="tag-status-icon"></span>Info</span> Password input component have been updated to 1.3.0 with no outward changes. Read more in the [design changelog](https://r.orange.fr/r/S-ouds-doc-password-input_changelog).

- <span class="tag tag-small tag-info"><span class="tag-status-icon"></span>Info</span> Text input component have been updated to 1.4.0 with no outward changes. Read more in the [design changelog](https://r.orange.fr/r/S-ouds-doc-text-input_changelog).
