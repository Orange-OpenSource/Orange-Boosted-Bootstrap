...
- <span class="tag tag-small tag-warning"><span class="tag-status-icon"></span>Warning</span> OUDS Web now supports a draft dropdown menu component. It comes from Boosted directly. It is intended as a placeholder for projects that need it urgently but be aware that it will change in the future. Read more in our [dropdown page]([[docsref:/components/dropdown]]).
...
- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Expand button has been implemented. Read more in our [buttons page]([[docsref:/components/buttons#expand-button]]).
...
- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Filter chip expand has been implemented. Read more in our [chips page]([[docsref:/components/chips#filter-chip-expand]]).
...
1. Update `@ouds/web-common` and `@ouds/web-[theme]` to v1.5.0.
2. Remove `@import "boosted/scss/dropdown";` from the Boosted custom import stack.
