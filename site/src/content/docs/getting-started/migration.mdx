...
- <span class="tag tag-small tag-negative"><span class="tag-status-icon"></span>Breaking</span> `.badge-disabled` has been replaced by `.disabled`. Read more in our [badges page]([[docsref:/components/badges#disabled]]).
