...
- <span class="tag tag-small rounded-none tag-positive">New</span> Navigation button has been implemented. Read more in our [buttons page]([[docsref:/components/buttons]]).

#### Skeleton

- <span class="tag tag-small rounded-none tag-positive">New</span> Skeleton component has been implemented. Read more in our [skeleton page]([[docsref:/components/skeleton]]). We also added a skeleton state on every component that supports it.
...
- <span class="tag tag-small rounded-none tag-positive">New</span> Orange Compact brand has been added.

### Forms

#### Validation

- <span class="tag tag-small rounded-none tag-negative">Breaking</span> `.was-validated` and `.is-invalid` have been removed, form validation is now based on `:user-invalid` for browser validation and `aria-invalid=true` for manual validation. Read more about [form validation]([[docsref:/foundation/form-validation]]).

### Components

#### Alerts

- <span class="tag tag-small rounded-none tag-positive">New</span> Alert message and inline alert has been implemented. Read more in our [alerts page]([[docsref:/components/alerts]]).

### Helpers

#### Clearfix

- <span class="tag tag-small rounded-none tag-negative">Breaking</span> `.clearfix` helper and `clearfix()` mixin have been removed in favor of `.d-flow-root`.
...
- <span class="tag tag-small rounded-none tag-positive">New</span> `.d-flow-root` utility has been added to replace `.clearfix`. Read more about this [display utility for clearfix]([[docsref:/utilities/display#clearfix]]).

#### Spacing

- <span class="tag tag-small rounded-none tag-positive">New</span> Several spacing utilities based on grid measures have been added. These utilities can be used for specific layout tweaks like edge to edge containers. Read more about [grid measures spacing utilities]([[docsref:/utilities/spacing#grid-measures]]).
...
- <span class="tag tag-small rounded-none tag-positive">New</span> OUDS Web now uses custom fonts loaded from a CDN for consistency in visual rendering across environments. Read more about the [font stack]([[docsref:/foundation/reboot#font-stack]]).

### Forms

- <span class="tag tag-small rounded-none tag-positive">New</span> `.component-max-width` has been added for all control items, textual input and select input.

#### Checkboxes

- <span class="tag tag-small rounded-none tag-warning">Warning</span> Checkbox component has been updated to 2.4.0. Read more in our [checkbox page]([[docsref:/components/checkbox]]).
...
- <span class="tag tag-small rounded-none tag-positive">New</span> Password input has been implemented. Read more in our [password input page]([[docsref:/components/password-input]]).

#### Radio buttons

- <span class="tag tag-small rounded-none tag-warning">Warning</span> Radio button component has been updated to 1.4.0. Read more in our [radio button page]([[docsref:/components/radio-button]]).

- <span class="tag tag-small rounded-none tag-positive">New</span> `.control-items-list` and `.control-item-error-message` has been added.

#### Select input

- <span class="tag tag-small rounded-none tag-positive">New</span> Select Input has been implemented. Read more in our [text area page]([[docsref:/components/select-input]]).

#### Switches

- <span class="tag tag-small rounded-none tag-warning">Warning</span> Switch component has been updated to 1.5.0. Read more in our [switch page]([[docsref:/components/switch]]).

- <span class="tag tag-small rounded-none tag-positive">New</span> `.control-items-list`, `.switch-item-container` and `.control-item-error-message` has been added.

#### Text area

- <span class="tag tag-small rounded-none tag-positive">New</span> Text area has been implemented. Read more in our [text area page]([[docsref:/components/text-area]]).

#### Text input

- <span class="tag tag-small rounded-none tag-negative">Breaking</span> `.text-input-container-rounded` has been replaced by a global `.use-rounded-corner-inputs`. Read more in our [text input page]([[docsref:/components/text-input#rounded]]).
...
- <span class="tag tag-small rounded-none tag-negative">Breaking</span> Some background utilities have been renamed as follows:
...
- <span class="tag tag-small rounded-none tag-positive">New</span> New background utilities: `.bg-surface-primary`, `.bg-surface-secondary`, `.bg-surface-tertiary`, `.bg-surface-inverse-high`, `.bg-surface-inverse-low`. Read more in our [background page]([[docsref:/utilities/background]]).

#### Borders

- <span class="tag tag-small rounded-none tag-positive">New</span> Border color `.border-minimal` has been added.

#### Opacity

- <span class="tag tag-small rounded-none tag-positive">New</span> `.opacity-weakest` is now available.

- <span class="tag tag-small rounded-none tag-warning">Warning</span> Opacity levels values have been changed. Read more in our [opacity page]([[docsref:/utilities/opacity]]).
...
- <span class="tag tag-small rounded-none tag-positive">New</span> Text input has been implemented. Read more in our [text input page]([[docsref:/components/text-input]]).

### Components

#### Badges

- <span class="tag tag-small rounded-none tag-negative">Breaking</span> Badges have been updated to v1.2. Default `badge` now carries a negative functional status. Badges now use dedicated classes such as `.badge-neutral`, `.badge-accent`, `.badge-positive`, `.badge-info` and `.badge-warning`.
- <span class="tag tag-small rounded-none tag-negative">Breaking</span> All badges sizing classes have been renamed: `.badge-xs` is `.badge-xsmall`, `.badge-sm` is `.badge-small` and `.badge-lg` is `.badge-large`.
- <span class="tag tag-small rounded-none tag-negative">Breaking</span> `.badge-icon` and `.badge-status-icon` have been added to handle badges with icons' styling.

#### Button

- <span class="tag tag-small rounded-none tag-negative">Breaking</span> Button CSS variables have been changed. `--bs-button-mono-color-bg-minimal-loading` is no longer available.
- <span class="tag tag-small rounded-none tag-positive">New</span> `.btn-rounded` is now available.
- <span class="tag tag-small rounded-none tag-positive">New</span> `.btn-brand` is now available.

#### Chips

- <span class="tag tag-small rounded-none tag-positive">New</span> Chips components have been implemented. Read more in our [chips page]([[docsref:/components/chips]]).

#### Link

- <span class="tag tag-small rounded-none tag-negative">Breaking</span> Link sizing class has been renamed from `.link-sm` to `.link-small`.

- <span class="tag tag-small rounded-none tag-negative">Breaking</span> Link CSS variables have been changed. All the variables containing `arrow` have been renamed the same with `chevron` instead.

#### Tags

- <span class="tag tag-small rounded-none tag-positive">New</span> Tags components have been implemented. Read more in our [tags page]([[docsref:/components/tags]]).

### Helpers

#### Color background

- <span class="tag tag-small rounded-none tag-negative">Breaking</span> All `.text-bg-*` helpers have been removed.

### Utilities

#### Background

- <span class="tag tag-small rounded-none tag-positive">New</span> `.bg-opacity-lower` and `.bg-opacity-lowest` background color utilities have been added. Visit our [background page]([[docsref:/utilities/background]]) to read more.

- <span class="tag tag-small rounded-none tag-positive">New</span> `[data-bs-theme]` now use a `--bs-color-local` to set the color if it has been defined by a specific `.bg-*` utility.

#### Borders

- <span class="tag tag-small rounded-none tag-warning">Warning</span> `.rounded-small` and `.rounded-medium` have been updated to respectively 4px and 8px. All components have been updated accordingly. It shouldn’t bother you too much since it’s handled on OUDS Web side.

#### Colors

- <span class="tag tag-small rounded-none tag-warning">Warning</span> Dark mode values of our `.text-status-info`, `.text-status-positive`, `.text-status-warning` and `.text-status-danger` have been tweaked. It shouldn’t bother you too much since it’s handled on OUDS Web side.

#### Shadow

- <span class="tag tag-small rounded-none tag-positive">New</span> `.shadow-sticky` shadow utility have been added. Visit our [shadows page]([[docsref:/utilities/shadow]]) to read more.

- <span class="tag tag-small rounded-none tag-negative">Breaking</span> `.shadow-sticky-default`, `.shadow-sticky-emphasized` and `.shadow-sticky-navigation-scrolled` shadow utilities have been removed. Visit our [shadows page]([[docsref:/utilities/shadow]]) to read more.

#### Spacings

- <span class="tag tag-small rounded-none tag-negative">Breaking</span> Spacing utilities (padding, margin, gap, ...) sizes have been renamed as follows:
...
- <span class="tag tag-small rounded-none tag-positive">New</span> Read only state has been implemented.

### Components

#### Badges

- <span class="tag tag-small rounded-none tag-positive">New</span> Badges components has been implemented. Read more in our [badges page]([[docsref:/components/badges]]).

#### Breadcrumb

- <span class="tag tag-small rounded-none tag-positive">New</span> Breadcrumb component has been implemented. Read more in our [breadcrumb page]([[docsref:/components/breadcrumb]]).

#### Bullet list

- <span class="tag tag-small rounded-none tag-positive">New</span> Bullet list component has been implemented. Read more in our [bullet list page]([[docsref:/components/bullet-list]]).

### Extend

#### Icons

- <span class="tag tag-small rounded-none tag-positive">New</span> Icons’ sizes for decorative standalone icons have been added: `.decorative-4xs-icon`, `decorative-3xs-icon`.

### Utilities

#### Border

- <span class="tag tag-small rounded-none tag-negative">Breaking</span> Border radius utilities sizes `short` and `tall` have been renamed to `small` and `large` respectively.
...
- <span class="tag tag-small rounded-none tag-positive">New</span> Color utilities for text on status colors have been added:
...
- <span class="tag tag-small rounded-none tag-negative">Breaking</span> Some design tokens prefix have been changed to follow the new naming convention.
...
- <span class="tag tag-small rounded-none tag-negative">Breaking</span> A parameter from the `focus-visible()` mixin has been removed. If you use the `focus-visible()` mixin in your scss files with a `z-index` as a parameter, please adapt your code.
...
- <span class="tag tag-small rounded-none tag-positive">New</span> Checkbox component has been implemented. Read more in our [checkbox page]([[docsref:/components/checkbox]]).

#### Radio buttons

- <span class="tag tag-small rounded-none tag-positive">New</span> Radio button component has been implemented. Read more in our [radio button page]([[docsref:/components/radio-button]]).

#### Switches

- <span class="tag tag-small rounded-none tag-positive">New</span> Switch component has been implemented. Read more in our [switch page]([[docsref:/components/switch]]).

### Helpers

#### Divider

- <span class="tag tag-small rounded-none tag-positive">New</span> Horizontal and vertical rule helpers to create dividers. Read more in our [divider page]([[docsref:/components/divider]]).

### CSS and Sass variables

- <span class="tag tag-small rounded-none tag-positive">New</span> A new file containing composite tokens has been added. If you were using the Sass compilation, you must import the new Sass file between the semantic and component files.
...
- <details class="mb-small">
    <summary><span class="tag tag-small rounded-none tag-negative">Breaking</span> Removed Sass variables:</summary>
    <ul>
...
- <span class="tag tag-small rounded-none tag-positive">New</span> Default link styles has been updated.

### Components

#### Links

- <span class="tag tag-small rounded-none tag-positive">New</span> Link component has been implemented. Read more in our [links page]([[docsref:/components/links]]).

### Helpers

#### Icon link

- <span class="tag tag-small rounded-none tag-negative">Breaking</span> Colors links are unstyled in OUDS Web, the documentation is only kept for Bootstrap compatibility.

- <span class="tag tag-small rounded-none tag-warning">Warning</span> The icon link documentation has been merged into is the new [Link component]([[docsref:/components/links]]) documentation and removed from helpers section.

### Utilities

#### Border

- <span class="tag tag-small rounded-none tag-positive">New</span> Border color: `.border-muted`.

#### Link

- <span class="tag tag-small rounded-none tag-negative">Breaking</span> Link utilities are no more used in OUDS Web and the following classes have been removed: <code>.link-opacity-{'{number}'}</code>, <code>.link-offset-{'{number}'}</code>, <code>.link-underline-{'{number}'}</code>, .<code>link-underline-opacity-{'{number}'}</code>
...
- <span class="tag tag-small rounded-none tag-positive">New</span> Button component has been implemented. Read more in our [buttons page]([[docsref:/components/buttons]]).
...
- <span class="tag tag-small rounded-none tag-positive">New</span> `$enable-button-pointers` (default <code>true</code>) has been introduced. It is used to add a "hand" cursor to non-disabled button elements.

- <span class="tag tag-small rounded-none tag-positive">New</span> `$enable-gradients` (default <code>false</code>) has been introduced. It is used to enable predefined gradients via `background-image` styles on various components.

- <span class="tag tag-small rounded-none tag-positive">New</span> `$enable-rounded` (default <code>true</code>) has been introduced. It allows you to set rounded or flat corners on components.
...
- <span class="tag tag-small rounded-none tag-positive">New</span> We provide four brand new themes that are <code>light</code>, <code>dark</code>,  <code>root</code> and <code>root-inverted</code>. Read more on our [color modes page]([[docsref:/foundation/color-modes]])

### Content styles

#### Default styles

- <span class="tag tag-small rounded-none tag-positive">New</span> Default styles have be added to HTML elements:
...
- <span class="tag tag-small rounded-none tag-positive">New</span> All typography global settings have been set for:
  - Headings
  - Display headings
  - Regular texts
...
- <span class="tag tag-small rounded-none tag-positive">New</span> Responsive flexbox grid system is now available with eight default responsive tiers defined at breakpoints `2xs`, `xs`, `sm`, `md`, `xl`, `2xl`, and `3xl`.
...
<span class="tag tag-small rounded-none tag-positive">New</span> Responsive CSS grid classes: `.g-col-{breakpoint}-{number}`.

### Helpers

#### Color background

- <span class="tag tag-small rounded-none tag-positive">New</span> The new color-background color helpers are now available. Visit our [color-bg page]([[docsref:/utilities/color-background]]) to read more.

#### Icon

- <span class="tag tag-small rounded-none tag-positive">New</span> Icons’ sizes utilities are now available to help choose the right icon size with a specific typography reference:
...
- <span class="tag tag-small rounded-none tag-positive">New</span> Responsive sticky helpers: `.sticky-{value}`, and `.sticky-{breakpoint}-{value}` where `breakpoint` is in `xs|sm|md|lg|xl|2xl|3xl`, and `value` is in `top|bottom`.

### Utilities

#### API

- <span class="tag tag-small rounded-none tag-positive">New</span> The `responsive` option is now available in the API to indicate if responsive classes should be generated.

#### Background

- <span class="tag tag-small rounded-none tag-positive">New</span> The new background color utilities are now available. Visit our [background page]([[docsref:/utilities/background]]) to read more.

#### Border

- <span class="tag tag-small rounded-none tag-positive">New</span> Border operative utilities: `.border`, `.border-none`, `.border-top`, `.border-top-none`, `.border-bottom`, `.border-bottom-none`, `.border-start`, `.border-start-none`, `.border-end` and `.border-end-none`.
...
- <span class="tag tag-small rounded-none tag-positive">New</span> The new border color utilities are now available. Visit our [border page]([[docsref:/utilities/border#color]]) to read more.

#### Colors

- <span class="tag tag-small rounded-none tag-positive">New</span> The new text color utilities are now available. Visit our [color page]([[docsref:/utilities/color]]) to read more.

#### Display

- <span class="tag tag-small rounded-none tag-positive">New</span> Responsive display utilities: `.d-{value}`, `.d-{breakpoint}-{value}` where `breakpoint` is in `xs|sm|md|lg|xl|2xl|3xl`, and `value` is in `none|inline|inline-block|block|grid|inline-grid|table|table-cell|table-row|flex|inline-flex`.

#### Flex

- <span class="tag tag-small rounded-none tag-positive">New</span> Responsive flex utilities without `breakpoint` for `2xs`, and where `breakpoint` is in `xs|sm|md|lg|xl|2xl|3xl`:
...
- <span class="tag tag-small rounded-none tag-positive">New</span> Responsive float utilities: `.float-{start|end|none}`, `.float-{breakpoint}-{start|end|none}` where `breakpoint` is in `xs|sm|md|lg|xl|2xl|3xl`.

#### Object fit

- <span class="tag tag-small rounded-none tag-positive">New</span> Responsive object fit utilities: `.object-fit-{contain|cover|fill|scale|none}`, `.object-fit-{breakpoint}-{contain|cover|fill|scale|none}` where `breakpoint` is in `xs|sm|md|lg|xl|2xl|3xl`.

#### Opacity

- <span class="tag tag-small rounded-none tag-negative">Breaking</span> Opacity utilities: `.opacity-emphasis` has been renamed to `.opacity-strong` and `.opacity-transparent` has been renamed `.opacity-invisible`.
...
- <span class="tag tag-small rounded-none tag-positive">New</span> Sizing utility `.mw-none` to set `max-width: none`. This utility is particularly useful to reset the `max-width` of our font references in some special cases.
...
- <span class="tag tag-small rounded-none tag-positive">New</span> Alignment text utilities: `.text-start`, `.text-center`, `.text-end`, and responsive versions like `.text-{breakpoint}-{start|center|end}` where `breakpoint` is in `xs|sm|md|lg|xl|2xl|3xl`.

- <span class="tag tag-small rounded-none tag-positive">New</span> Wrapping and overflow text utilities: `.text-wrap` and `.text-nowrap`.

- <span class="tag tag-small rounded-none tag-positive">New</span> Word break text utility: `.text-break`.

- <span class="tag tag-small rounded-none tag-positive">New</span> Text transform text utilities: `.text-lowercase`, `.text-uppercase`, and `.text-capitalize`.

- <span class="tag tag-small rounded-none tag-positive">New</span> Font size text utilities:
  - **Display headings**: `.fs-dl`, `.fs-dm`, `.fs-ds`
  - **Headings**: `.fs-hxl`, `.fs-hl`, `.fs-hm`, `.fs-hs`
  - **Body**: `.fs-bl`, `.fs-bm`, `.fs-bs`
  - **Code**: `.fs-cm`

- <span class="tag tag-small rounded-none tag-positive">New</span> Font weight text utilities: `.fw-normal` and `.fw-bold`.

- <span class="tag tag-small rounded-none tag-positive">New</span> Text decoration utilities: `.text-decoration-underline`, `.text-decoration-line-through`, and `.text-decoration-none`.

### Examples

- <span class="tag tag-small rounded-none tag-positive">New</span> New [Font example]([[docsref:/examples/font]]).

- <span class="tag tag-small rounded-none tag-positive">New</span> New [Grid example]([[docsref:/examples/grid/]]).
...
- <span class="tag tag-small rounded-none tag-positive">New</span> `$enable-container-classes` to enable or disable the generation of CSS classes for the grid system (e.g. `.row`, `.md:col-1`, etc.).
...
- <span class="tag tag-small rounded-none tag-positive">New</span> `color-mode({mode}, {root}, {inverted-mode})` mixin.
...
- <span class="tag tag-small rounded-none tag-positive">New</span> Opacity utilities: `.opacity-transparent`, `.opacity-weaker`, `.opacity-weak`, `.opacity-medium`, `.opacity-emphasis` and `.opacity-opaque`.
