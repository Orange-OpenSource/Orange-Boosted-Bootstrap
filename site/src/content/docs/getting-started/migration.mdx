...
- <span class="tag tag-small tag-info"><span class="tag-status-icon"></span>Info</span> Text area component has been updated to 1.2.0. Read more in the [text area design changelog](https://r.orange.fr/r/S-ouds-doc-text-area_changelog).
...
- <span class="tag tag-small tag-negative"><span class="tag-status-icon"></span>Breaking</span> The `[placeholder]` attribute is now mandatory for text area component.
  Read more in our [text area page]([[docsref:/components/text-area]]).

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> `.text-area-no-resize` class has been added to disable the resizing feature on the text area.  Read more in our [text area page]([[docsref:/components/text-area]]).
