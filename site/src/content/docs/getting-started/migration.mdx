...
- <span class="badge text-bg-status-positive-emphasized">New</span> Badge component has been implemented.
...
- <span class="badge text-bg-status-warning-emphasized">Warning</span> The icon link documentation has been merged into is the new [Link component]([[docsref:/components/link]]) documentation and removed from helpers section.
...
- <span class="badge text-bg-status-positive-emphasized">New</span> We provide four brand new themes that are <code>light</code>, <code>dark</code>,  <code>root</code> and <code>root-inverted</code>. See more on our [color modes page]([[docsref:/foundation/color-modes]])
