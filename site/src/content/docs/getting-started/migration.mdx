...
- <span class="tag tag-small rounded-none tag-warning">Warning</span> Checkbox component has been updated to 2.4.0. Read more in our [checkbox page]([[docsref:/forms/checkbox]]).
...
- <span class="tag tag-small rounded-none tag-warning">Warning</span> Switch component has been updated to 1.5.0. Read more in our [switch page]([[docsref:/forms/switch]]).
...
- <span class="tag tag-small rounded-none tag-positive">New</span> Text area has been implemented. Read more in our [text area page]([[docsref:/forms/text-area]]).

#### Text input

- <span class="tag tag-small rounded-none tag-negative">Breaking</span> `.text-input-container-rounded` has been replaced by a global `.use-rounded-corner-inputs`. Read more in our [text input page]([[docsref:/forms/text-input#rounded]]).
...
- <span class="tag tag-small rounded-none tag-positive">New</span> Text input has been implemented. Read more in our [text input page]([[docsref:/forms/text-input]]).
...
- <span class="tag tag-small rounded-none tag-positive">New</span> Checkbox component has been implemented. Read more in our [checkbox page]([[docsref:/forms/checkbox]]).

#### Radio buttons

- <span class="tag tag-small rounded-none tag-positive">New</span> Radio button component has been implemented. Read more in our [radio button page]([[docsref:/forms/radio-button]]).

#### Switches

- <span class="tag tag-small rounded-none tag-positive">New</span> Switch component has been implemented. Read more in our [switch page]([[docsref:/forms/switch]]).
