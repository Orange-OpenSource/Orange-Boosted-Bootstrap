...
- <span class="tag tag-small rounded-none tag-positive">New</span> Text Input has been implemented.
...
- <span class="tag tag-small rounded-none tag-positive">New</span> Tags components have been implemented.
...
- <span class="tag tag-small rounded-none tag-positive">New</span> `.bg-opacity-lower` and `.bg-opacity-lowest` background color utilities have been added. Visit our [background page]([[docsref:/utilities/background]]) to see more.
...
- <span class="tag tag-small rounded-none tag-positive">New</span> `.shadow-sticky` shadow utility have been added. Visit our [shadows page]([[docsref:/utilities/shadow]]) to see more.

- <span class="tag tag-small rounded-none tag-negative">Breaking</span> `.shadow-sticky-default`, `.shadow-sticky-emphasized` and `.shadow-sticky-navigation-scrolled` shadow utilities have been removed. Visit our [shadows page]([[docsref:/utilities/shadow]]) to see more.
...
- <span class="tag tag-small rounded-none tag-positive">New</span> Badges components has been implemented.

#### Breadcrumb

- <span class="tag tag-small rounded-none tag-positive">New</span> Breadcrumb component has been implemented.

#### Bullet list

- <span class="tag tag-small rounded-none tag-positive">New</span> Bullet list component has been implemented.
...
- <span class="tag tag-small rounded-none tag-positive">New</span> Checkbox component has been implemented.

#### Radio buttons

- <span class="tag tag-small rounded-none tag-positive">New</span> Radio button component has been implemented.

#### Switches

- <span class="tag tag-small rounded-none tag-positive">New</span> Switch component has been implemented.

### Helpers

#### Divider
- <span class="tag tag-small rounded-none tag-positive">New</span> Horizontal and vertical rule helpers to create dividers.
...
- <span class="tag tag-small rounded-none tag-positive">New</span> Link component has been implemented.
...
- <span class="tag tag-small rounded-none tag-positive">New</span> Button component has been implemented.
...
- <span class="tag tag-small rounded-none tag-positive">New</span> We provide four brand new themes that are <code>light</code>, <code>dark</code>,  <code>root</code> and <code>root-inverted</code>. See more on our [color modes page]([[docsref:/foundation/color-modes]])
...
- <span class="tag tag-small rounded-none tag-positive">New</span> The new color-background color helpers are now available. Visit our [color-bg page]([[docsref:/utilities/color-background]]) to see more.
