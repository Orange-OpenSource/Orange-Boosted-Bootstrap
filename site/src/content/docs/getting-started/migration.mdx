...
- <span class="tag tag-small rounded-none tag-positive">New</span> We replaced the color palette page with a new and improved colors page, it list all existing semantic colors made available by OUDS Web. Read more in our [colors page]([[docsref:/foundation/colors]]).
...
- <span class="tag tag-small rounded-none tag-positive">New</span> The new color-background color helpers are now available. *Deprecated in v0.6.0*
...
- <span class="tag tag-small rounded-none tag-positive">New</span> `$enable-container-classes` to enable or disable the generation of CSS classes for the grid system (e.g. `.row`, `.col-md-1`, etc.).
