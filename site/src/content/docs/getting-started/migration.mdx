...
- <span class="tag tag-small tag-info"><span class="tag-status-icon"></span>Info</span> The design of the header component (draft) has been updated to use OUDS Web variables for the background and text colors. Colors have been also updated to better the accessibility on light mode. It requires no outward changes, but you may need to update your custom styles if you were overriding the header colors.

#### Footer

- <span class="tag tag-small tag-info"><span class="tag-status-icon"></span>Info</span> The design of the footer component (draft) has been updated to use OUDS Web variables for the background and text colors. Colors have been also updated to match the header colors. It requires no outward changes, but you may need to update your custom styles if you were overriding the header colors.
