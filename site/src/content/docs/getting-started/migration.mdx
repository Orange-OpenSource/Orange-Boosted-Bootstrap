...
- <span class="tag tag-small tag-warning"><span class="tag-status-icon"></span>Warning</span> `.colored-bg` has been removed in favor of `.link-on-colored-bg`. Read more in our [reboot page]([[docsref:/foundation/reboot#links]]).

- <span class="tag tag-small tag-warning"><span class="tag-status-icon"></span>Warning</span> `.back` has been removed in favor of `.link-previous`. Read more in our [links page]([[docsref:/components/links#with-chevron]]).
