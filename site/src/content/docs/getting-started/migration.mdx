...
<Callout type="info">
  The [`@ouds/web-migrate`](https://www.npmjs.com/package/@ouds/web-migrate) CLI can help update from one version to another. Run it against your project files and review the diff afterward:
...
- <span class="tag tag-small tag-negative"><span class="tag-status-icon"></span>Breaking</span> Some variables have been renamed or removed.

- <details class="mb-small">
    <summary><span class="tag tag-small tag-warning"><span class="tag-status-icon"></span>Warning</span> Renamed Sass variables:</summary>
    <ul>
