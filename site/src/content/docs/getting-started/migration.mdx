...
<Callout type="info">
  The [`@ouds/web-migrate`](https://www.npmjs.com/package/@ouds/web-migrate) CLI can help update to the latest version. Run it against your project files and review the diff afterward:

  ```bash
  npx @ouds/web-migrate "src/**/*.{css,scss,html}"
  ```
</Callout>

## v1.6.0 [[version-changelog-link]]
...
- <span class="tag tag-small tag-info"><span class="tag-status-icon"></span>Info</span> Button component has been updated to 3.4.0 with no changes to the HTML. Read more in the [button design changelog](https://r.orange.fr/r/S-ouds-doc-button_changelog).

- <span class="tag tag-small tag-info"><span class="tag-status-icon"></span>Info</span> Navigation button component has been updated to 3.4.0 with no changes to the HTML. Read more in the [navigation button design changelog](https://r.orange.fr/r/S-ouds-doc-navigation-button_changelog).

- <span class="tag tag-small tag-info"><span class="tag-status-icon"></span>Info</span> Assistant button component has been updated to 1.1.0 with no changes to the HTML. Read more in our [button design changelog](https://r.orange.fr/r/S-ouds-doc-button_changelog).

## v1.5.0 [[version-changelog-link]]
...
- <span class="tag tag-small tag-negative"><span class="tag-status-icon"></span>Breaking</span> `.badge-disabled` has been removed in favor of `.disabled` after being deprecated in v1.4.0. Read more in our [badges page]([[docsref:/components/badges#disabled]]).

#### Breadcrumb

- <span class="tag tag-small tag-info"><span class="tag-status-icon"></span>Info</span> Breadcrumb component has been updated to 1.2.0 with no outward changes. Read more in the [breadcrumb design changelog](https://r.orange.fr/r/S-ouds-doc-breadcrumb_changelog).

#### Buttons

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Assistant button has been implemented. Read more in our [buttons page]([[docsref:/components/buttons#assistant-button]]).
...
- <span class="tag tag-small tag-info"><span class="tag-status-icon"></span>Info</span> Button component has been updated to 3.3.0 with no outward changes. Read more in the [button design changelog](https://r.orange.fr/r/S-ouds-doc-button_changelog).

- <span class="tag tag-small tag-info"><span class="tag-status-icon"></span>Info</span> Navigation button component has been updated to 3.3.0 with no outward changes. Read more in the [navigation button design changelog](https://r.orange.fr/r/S-ouds-doc-navigation-button_changelog).

#### Chips

- <span class="tag tag-small tag-info"><span class="tag-status-icon"></span>Info</span> Suggestion chip component has been updated to 1.5.0 with no outward changes. Read more in the [suggestion chip design changelog](https://r.orange.fr/r/S-ouds-doc-suggestion-chip_changelog).

- <span class="tag tag-small tag-info"><span class="tag-status-icon"></span>Info</span> Filter chip component has been updated to 1.5.0 with no outward changes. Read more in the [filter chip design changelog](https://r.orange.fr/r/S-ouds-doc-filter-chip_changelog).

#### Footer

- <span class="tag tag-small tag-info"><span class="tag-status-icon"></span>Info</span> The design of the footer component (draft) has been updated to use OUDS Web variables for the background and text colors. Colors have also been updated to match the header colors. It requires no outward changes, but you may need to update your custom styles if you were overriding the footer colors.

#### Header

- <span class="tag tag-small tag-info"><span class="tag-status-icon"></span>Info</span> The design of the header component (draft) has been updated to use OUDS Web variables for the background and text colors. Colors have also been updated to improve accessibility in light mode. It requires no outward changes, but you may need to update your custom styles if you were overriding the header colors.

#### Items

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Items ([Static card item]([[docsref:/components/items#static-card-item]]), [static list item]([[docsref:/components/items#static-list-item]]), [navigation card item]([[docsref:/components/items#navigation-card-item]]) and [navigation list item]([[docsref:/components/items#navigation-list-item]])) have been implemented. Read more in our [items page]([[docsref:/components/items]]).

#### Links

- <span class="tag tag-small tag-info"><span class="tag-status-icon"></span>Info</span> Link component has been updated to 2.4.0. Read more in the [link design changelog](https://r.orange.fr/r/S-ouds-doc-link_changelog).

- <span class="tag tag-small tag-warning"><span class="tag-status-icon"></span>Warning</span> `.colored-bg` has been deprecated in favor of `.link-on-colored-bg`. It will be removed in v1.6.0. Read more in our [reboot page]([[docsref:/foundation/reboot#links]]).

- <span class="tag tag-small tag-warning"><span class="tag-status-icon"></span>Warning</span> `.back` has been deprecated in favor of `.link-previous`. It will be removed in v1.6.0. Read more in our [links page]([[docsref:/components/links#with-chevron]]).

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> `.link-external` class has been added for external links. [Read more about this variant]([[docsref:/components/links#with-external-icon]]).

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> `.link-compact` class has been added for more compact links. [Read more about this variant]([[docsref:/components/links#sizes]]).

#### Table

- <span class="tag tag-small tag-info"><span class="tag-status-icon"></span>Info</span> Colors have been updated to use OUDS Web variables. It requires no outward changes, but you may need to update your custom styles if you were overriding the table colors.
...
- <span class="tag tag-small tag-negative"><span class="tag-status-icon"></span>Breaking</span> `.shadow-default` has been removed in favor of `.shadow-elevated` after being deprecated in v1.4.0. Read more in our [shadow page]([[docsref:/utilities/shadow]]).

### Sass mixins

- <span class="tag tag-small tag-info"><span class="tag-status-icon"></span>Info</span> The `list-unstyled` mixin has been updated to remove the margin bottom.
...
- <span class="tag tag-small tag-warning"><span class="tag-status-icon"></span>Warning</span> `.badge-disabled` has been deprecated in favor of `.disabled`. It will be removed in v1.5.0. Read more in our [badges page]([[docsref:/components/badges#disabled]]).
...
- <span class="tag tag-small tag-warning"><span class="tag-status-icon"></span>Warning</span> All our chips now use an `inline-flex` display instead of `flex` and it might break your design depending on your implementation. Please take a look at your implementation to fix it if needed.
...
- <span class="tag tag-small tag-info"><span class="tag-status-icon"></span>Info</span> Input tag component has been updated to 1.2.0 with no outward changes. Read more in the [input tag design changelog](https://r.orange.fr/r/S-ouds-doc-input-tag_changelog).

- <span class="tag tag-small tag-info"><span class="tag-status-icon"></span>Info</span> Tag component has been updated to 1.5.0 with no outward changes. Read more in the [tag design changelog](https://r.orange.fr/r/S-ouds-doc-tag_changelog).

#### Text area

- <span class="tag tag-small tag-info"><span class="tag-status-icon"></span>Info</span> Text area component has been updated to 1.2.0, it now has a floating label like text input. Read more in the [text area design changelog](https://r.orange.fr/r/S-ouds-doc-text-area_changelog).

- <span class="tag tag-small tag-negative"><span class="tag-status-icon"></span>Breaking</span> The `[placeholder]` attribute is now mandatory for text area component.
  Read more in our [text area page]([[docsref:/components/text-area#overview]]).

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> `.text-area-no-resize` class has been added to disable the resizing feature on the text area. Read more in our [text area page]([[docsref:/components/text-area#no-manual-resizing]]).

#### Text input

- <span class="tag tag-small tag-info"><span class="tag-status-icon"></span>Info</span> Text input component has been updated to 1.4.0 with no outward changes. Read more in the [design changelog](https://r.orange.fr/r/S-ouds-doc-text-input_changelog).
...
- <details class="mb-small">
    <summary><span class="tag tag-small tag-warning"><span class="tag-status-icon"></span>Warning</span> Some variables have been renamed:</summary>
    <ul>
      <li><code>$ouds-elevation-default</code>  → <code>$ouds-elevation-elevated</code></li>
      <li><code>$ouds-elevation-x-default</code>  → <code>$ouds-elevation-x-elevated</code></li>
      <li><code>$ouds-elevation-y-default</code>  → <code>$ouds-elevation-y-elevated</code></li>
      <li><code>$ouds-elevation-blur-default</code>  → <code>$ouds-elevation-blur-elevated</code></li>
      <li><code>$ouds-elevation-spread-default</code>  → <code>$ouds-elevation-spread-elevated</code></li>
      <li><code>$ouds-control-item-size-min-height</code>  → <code>$ouds-control-item-size-min-height-default</code></li>
      <li><code>$ouds-size-max-width-type-body-large-desktop</code>  → <code>$ouds-size-max-width-body-large-desktop</code></li>
      <li><code>$ouds-size-max-width-type-body-large-mobile</code>  → <code>$ouds-size-max-width-body-large-desktop</code></li>
      <li><code>$ouds-size-max-width-type-body-large-tablet</code>  → <code>$ouds-size-max-width-body-large-desktop</code></li>
      <li><code>$ouds-size-max-width-type-body-medium-desktop</code>  → <code>$ouds-size-max-width-body-large-desktop</code></li>
      <li><code>$ouds-size-max-width-type-body-medium-mobile</code>  → <code>$ouds-size-max-width-body-large-desktop</code></li>
      <li><code>$ouds-size-max-width-type-body-medium-tablet</code>  → <code>$ouds-size-max-width-body-large-desktop</code></li>
      <li><code>$ouds-size-max-width-type-body-small-desktop</code>  → <code>$ouds-size-max-width-body-large-desktop</code></li>
      <li><code>$ouds-size-max-width-type-body-small-mobile</code>  → <code>$ouds-size-max-width-body-large-desktop</code></li>
      <li><code>$ouds-size-max-width-type-body-small-tablet</code>  → <code>$ouds-size-max-width-body-large-desktop</code></li>
      <li><code>$ouds-size-max-width-type-display-large-desktop</code>  → <code>$ouds-size-max-width-display-large-desktop</code></li>
      <li><code>$ouds-size-max-width-type-display-large-mobile</code>  → <code>$ouds-size-max-width-display-large-mobile</code></li>
      <li><code>$ouds-size-max-width-type-display-large-tablet</code>  → <code>$ouds-size-max-width-display-large-tablet</code></li>
      <li><code>$ouds-size-max-width-type-display-medium-desktop</code>  → <code>$ouds-size-max-width-display-medium-desktop</code></li>
      <li><code>$ouds-size-max-width-type-display-medium-mobile</code>  → <code>$ouds-size-max-width-display-medium-mobile</code></li>
      <li><code>$ouds-size-max-width-type-display-medium-tablet</code>  → <code>$ouds-size-max-width-display-medium-tablet</code></li>
      <li><code>$ouds-size-max-width-type-display-small-desktop</code>  → <code>$ouds-size-max-width-display-small-desktop</code></li>
      <li><code>$ouds-size-max-width-type-display-small-mobile</code>  → <code>$ouds-size-max-width-display-small-mobile</code></li>
      <li><code>$ouds-size-max-width-type-display-small-tablet</code>  → <code>$ouds-size-max-width-display-small-tablet</code></li>
      <li><code>$ouds-size-max-width-type-heading-large-desktop</code>  → <code>$ouds-size-max-width-heading-large-desktop</code></li>
      <li><code>$ouds-size-max-width-type-heading-large-mobile</code>  → <code>$ouds-size-max-width-heading-large-mobile</code></li>
      <li><code>$ouds-size-max-width-type-heading-large-tablet</code>  → <code>$ouds-size-max-width-heading-large-tablet</code></li>
      <li><code>$ouds-size-max-width-type-heading-medium-desktop</code>  → <code>$ouds-size-max-width-heading-medium-desktop</code></li>
      <li><code>$ouds-size-max-width-type-heading-medium-mobile</code>  → <code>$ouds-size-max-width-heading-medium-mobile</code></li>
      <li><code>$ouds-size-max-width-type-heading-medium-tablet</code>  → <code>$ouds-size-max-width-heading-medium-tablet</code></li>
      <li><code>$ouds-size-max-width-type-heading-small-desktop</code>  → <code>$ouds-size-max-width-heading-small-desktop</code></li>
      <li><code>$ouds-size-max-width-type-heading-small-mobile</code>  → <code>$ouds-size-max-width-heading-small-mobile</code></li>
      <li><code>$ouds-size-max-width-type-heading-small-tablet</code>  → <code>$ouds-size-max-width-heading-small-tablet</code></li>
      <li><code>$ouds-size-max-width-type-heading-xlarge-desktop</code>  → <code>$ouds-size-max-width-heading-xlarge-desktop</code></li>
      <li><code>$ouds-size-max-width-type-heading-xlarge-mobile</code>  → <code>$ouds-size-max-width-heading-xlarge-mobile</code></li>
      <li><code>$ouds-size-max-width-type-heading-xlarge-tablet</code>  → <code>$ouds-size-max-width-heading-xlarge-tablet</code></li>
      <li><code>$ouds-control-item-space-padding-block-top-error-text</code>  → <code>$ouds-control-item-space-padding-block-top-helper-text</code></li>
      <li><code>$ouds-control-item-border-radius</code>  → <code>$ouds-control-item-border-radius-default</code></li>
      <li><code>$ouds-badge-space-inset</code>  → <code>$ouds-badge-space-inset-medium-large</code></li>
    </ul>
  </details>
...
- <span class="tag tag-small tag-warning"><span class="tag-status-icon"></span>Warning</span> OUDS Web now supports a draft table component. It comes from Boosted directly with small tweaks. It is intended as a placeholder for projects that need it urgently but be aware that it will change in the future. Read more in our [table page]([[docsref:/components/table]]).

### Tools

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> We have created a new CLI tool to update your project files automatically. Read more in our [CLI tool readme](https://www.npmjs.com/package/@ouds/web-migrate).

### Utilities

#### Breakpoint prefixes

- <span class="tag tag-small tag-negative"><span class="tag-status-icon"></span>Breaking</span> Responsive utilities now use a breakpoint prefix instead of an infix. All classes that previously used `.{utility}-{breakpoint}-{value}` must be updated to `.{breakpoint}:{utility}-{value}`. Following are some examples of the changes to apply:
  - `.d-sm-none` → `.sm:d-none`
  - `.d-md-flex` → `.md:d-flex`
  ...
  Read more in our [display]([[docsref:/utilities/display]]), [flex]([[docsref:/utilities/flex]]) or [spacing]([[docsref:/utilities/spacing]]) pages.
...
- <span class="tag tag-small tag-warning"><span class="tag-status-icon"></span>Warning</span> `font-size()` mixin has been removed. Please refer to `get-font-size()` mixin instead.

- <span class="tag tag-small tag-negative"><span class="tag-status-icon"></span>Breaking</span> `generate-utility()` mixin signature was modified, and the `$is-rfs-media-query` parameter was removed. If you were using it, please make sure to update your code. For Bootstrap compatibility mode, the breakpoint is still the trailing parameter of `generate-utility()`, which lets you keep using the infix form for your custom utilities. You can check how we use it in `scss/utilities/_breakpoints.scss` for reference.
...
- <span class="tag tag-small tag-warning"><span class="tag-status-icon"></span>Warning</span> OUDS Web now supports a draft footer component. It comes from Boosted directly with small tweaks. It is intended as a placeholder for projects that need it urgently but be aware that it will change in the future. Read more in our [footer page]([[docsref:/components/footer]]).

#### Header

- <span class="tag tag-small tag-warning"><span class="tag-status-icon"></span>Warning</span> OUDS Web now supports a draft header component. It comes from Boosted directly with small tweaks. It is intended as a placeholder for projects that need it urgently but be aware that it will change in the future. Read more in our [header page]([[docsref:/components/header]]).

#### Navigation button

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Navigation button has been implemented. Read more in our [buttons page]([[docsref:/components/buttons]]).
...
- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Skeleton component has been implemented. Read more in our [skeleton page]([[docsref:/components/skeleton]]). We also added a skeleton state on every component that supports it.
...
- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> We replaced the color palette page with a new and improved colors page, it lists all existing semantic colors available in OUDS Web. Read more in our [colors page]([[docsref:/foundation/colors]]).
...
- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Orange Compact brand has been added.

### Forms

#### Validation

- <span class="tag tag-small tag-negative"><span class="tag-status-icon"></span>Breaking</span> `.was-validated` and `.is-invalid` have been removed, form validation is now based on `:user-invalid` for browser validation and `aria-invalid=true` for manual validation. Read more about [form validation]([[docsref:/foundation/form-validation]]).

### Components

#### Alerts

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Alert message and inline alert have been implemented. Read more in our [alerts page]([[docsref:/components/alerts]]).

### Helpers

#### Clearfix

- <span class="tag tag-small tag-negative"><span class="tag-status-icon"></span>Breaking</span> `.clearfix` helper and `clearfix()` mixin have been removed in favor of `.d-flow-root`.
...
- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> `.d-flow-root` utility has been added to replace `.clearfix`. Read more about this [display utility for clearfix]([[docsref:/utilities/display#clearfix]]).

#### Spacing

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Several spacing utilities based on grid measures have been added. These utilities can be used for specific layout tweaks like edge to edge containers. Read more about [grid measures spacing utilities]([[docsref:/utilities/spacing#grid-measures]]).

### Dual mode

1. Update `@ouds/web-common` and `@ouds/web-[theme]` to v1.1.0.
2. Update the import of Boosted variables out of the `.boosted` scope, to ease custom integrations.
...
- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> OUDS Web now uses custom fonts loaded from a CDN for consistency in visual rendering across environments. Read more about the [font stack]([[docsref:/foundation/reboot#font-stack]]).

### Forms

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> `.component-max-width` has been added for all control items, textual input and select input.

#### Checkboxes

- <span class="tag tag-small tag-warning"><span class="tag-status-icon"></span>Warning</span> Checkbox component has been updated to 2.4.0. Read more in our [checkbox page]([[docsref:/components/checkbox]]).

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> `.control-items-list` and `.control-item-error-message` has been added.

#### Password Input

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Password input has been implemented. Read more in our [password input page]([[docsref:/components/password-input]]).

#### Radio buttons

- <span class="tag tag-small tag-warning"><span class="tag-status-icon"></span>Warning</span> Radio button component has been updated to 1.4.0. Read more in our [radio button page]([[docsref:/components/radio-button]]).

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> `.control-items-list` and `.control-item-error-message` has been added.

#### Select input

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Select Input has been implemented. Read more in our [select input page]([[docsref:/components/select-input]]).

#### Switches

- <span class="tag tag-small tag-warning"><span class="tag-status-icon"></span>Warning</span> Switch component has been updated to 1.5.0. Read more in our [switch page]([[docsref:/components/switch]]).

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> `.control-items-list`, `.switch-item-container` and `.control-item-error-message` has been added.

#### Text area

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Text area has been implemented. Read more in our [text area page]([[docsref:/components/text-area]]).

#### Text input

- <span class="tag tag-small tag-negative"><span class="tag-status-icon"></span>Breaking</span> `.text-input-container-rounded` has been replaced by a global `.use-rounded-corner-inputs`. Read more in our [text input page]([[docsref:/components/text-input#rounded]]).

### Components

#### Button

- <span class="tag tag-small tag-negative"><span class="tag-status-icon"></span>Breaking</span> `.btn-rounded` has been replaced by a global `.use-rounded-corner-buttons`. Read more in our [buttons page]([[docsref:/components/buttons#rounded]]).
...
- <span class="tag tag-small tag-negative"><span class="tag-status-icon"></span>Breaking</span> Some background utilities have been renamed as follows:
...
- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> New background utilities: `.bg-surface-primary`, `.bg-surface-secondary`, `.bg-surface-tertiary`, `.bg-surface-inverse-high`, `.bg-surface-inverse-low`. Read more in our [background page]([[docsref:/utilities/background]]).

#### Borders

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Border color `.border-minimal` has been added.

#### Opacity

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> `.opacity-weakest` is now available.
...
- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Text input has been implemented. Read more in our [text input page]([[docsref:/components/text-input]]).

### Components

#### Badges

- <span class="tag tag-small tag-negative"><span class="tag-status-icon"></span>Breaking</span> Badges have been updated to v1.2. Default `badge` now carries a negative functional status. Badges now use dedicated classes such as `.badge-neutral`, `.badge-accent`, `.badge-positive`, `.badge-info` and `.badge-warning`.
- <span class="tag tag-small tag-negative"><span class="tag-status-icon"></span>Breaking</span> All badges sizing classes have been renamed: `.badge-xs` is `.badge-xsmall`, `.badge-sm` is `.badge-small` and `.badge-lg` is `.badge-large`.
- <span class="tag tag-small tag-negative"><span class="tag-status-icon"></span>Breaking</span> `.badge-icon` and `.badge-status-icon` have been added to handle badges with icons' styling.

#### Button

- <span class="tag tag-small tag-negative"><span class="tag-status-icon"></span>Breaking</span> Button CSS variables have been changed. `--bs-button-mono-color-bg-minimal-loading` is no longer available.
- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> `.btn-rounded` is now available.
- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> `.btn-brand` is now available.

#### Chips

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Chips components have been implemented. Read more in our [chips page]([[docsref:/components/chips]]).

#### Link

- <span class="tag tag-small tag-negative"><span class="tag-status-icon"></span>Breaking</span> Link sizing class has been renamed from `.link-sm` to `.link-small`.

- <span class="tag tag-small tag-negative"><span class="tag-status-icon"></span>Breaking</span> Link CSS variables have been changed. All the variables containing `arrow` have been renamed the same with `chevron` instead.

#### Tags

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Tags components have been implemented. Read more in our [tags page]([[docsref:/components/tags]]).

### Helpers

#### Color background

- <span class="tag tag-small tag-negative"><span class="tag-status-icon"></span>Breaking</span> All `.text-bg-*` helpers have been removed.

### Utilities

#### Background

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> `.bg-opacity-lower` and `.bg-opacity-lowest` background color utilities have been added. Visit our [background page]([[docsref:/utilities/background]]) to read more.

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> `[data-bs-theme]` now use a `--bs-color-local` to set the color if it has been defined by a specific `.bg-*` utility.

#### Borders

- <span class="tag tag-small tag-warning"><span class="tag-status-icon"></span>Warning</span> `.rounded-small` and `.rounded-medium` have been updated to respectively 4px and 8px. All components have been updated accordingly. It shouldn’t bother you too much since it’s handled on OUDS Web side.

#### Colors

- <span class="tag tag-small tag-warning"><span class="tag-status-icon"></span>Warning</span> Dark mode values of our `.text-status-info`, `.text-status-positive`, `.text-status-warning` and `.text-status-danger` have been tweaked. It shouldn’t bother you too much since it’s handled on OUDS Web side.

#### Shadow

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> `.shadow-sticky` shadow utility have been added. Visit our [shadows page]([[docsref:/utilities/shadow]]) to read more.

- <span class="tag tag-small tag-negative"><span class="tag-status-icon"></span>Breaking</span> `.shadow-sticky-default`, `.shadow-sticky-emphasized` and `.shadow-sticky-navigation-scrolled` shadow utilities have been removed. Visit our [shadows page]([[docsref:/utilities/shadow]]) to read more.

#### Spacings

- <span class="tag tag-small tag-negative"><span class="tag-status-icon"></span>Breaking</span> Spacing utilities (padding, margin, gap, ...) sizes have been renamed as follows:
  - **3xs** is renamed to `3xsmall` : for example `.m-3xs` → `.m-3xsmall`
  - **2xs** is renamed to `2xsmall` : for example `.m-2xs` → `.m-2xsmall`
  - **Xs** is renamed to `xsmall` : for example `.m-xs` → `.m-xsmall`
  - **Sm** is renamed to `small` : for example `.m-sm` → `.m-small`
  - **Md** is renamed to `medium` : for example `.m-md` → `.m-medium`
  - **Lg** is renamed to `large` : for example `.m-lg` → `.m-large`
  - **Xl** is renamed to `xlarge` : for example `.m-xl` → `.m-xlarge`
  - **2xl** is renamed to `2xlarge` : for example `.m-2xl` → `.m-2xlarge`
  - **3xl** is renamed to `3xlarge` : for example `.m-3xl` → `.m-3xlarge`
  - **4xl** is renamed to `4xlarge` : for example `.m-4xl` → `.m-4xlarge`
...
- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Read only state has been implemented.

### Components

#### Badges

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Badges components has been implemented. Read more in our [badges page]([[docsref:/components/badges]]).

#### Breadcrumb

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Breadcrumb component has been implemented. Read more in our [breadcrumb page]([[docsref:/components/breadcrumb]]).

#### Bullet list

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Bullet list component has been implemented. Read more in our [bullet list page]([[docsref:/components/bullet-list]]).

### Extend

#### Icons

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Icons’ sizes for decorative standalone icons have been added: `.decorative-4xs-icon`, `decorative-3xs-icon`.

### Utilities

#### Border

- <span class="tag tag-small tag-negative"><span class="tag-status-icon"></span>Breaking</span> Border radius utilities sizes `short` and `tall` have been renamed to `small` and `large` respectively.
...
- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Color utilities for text on status colors have been added:
...
- <span class="tag tag-small tag-negative"><span class="tag-status-icon"></span>Breaking</span> Some design tokens prefix have been changed to follow the new naming convention.
...
- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Checkbox component has been implemented. Read more in our [checkbox page]([[docsref:/components/checkbox]]).

#### Radio buttons

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Radio button component has been implemented. Read more in our [radio button page]([[docsref:/components/radio-button]]).

#### Switches

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Switch component has been implemented. Read more in our [switch page]([[docsref:/components/switch]]).

### Helpers

#### Divider

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Horizontal and vertical rule helpers to create dividers. Read more in our [divider page]([[docsref:/components/divider]]).

### CSS and Sass variables

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> A new file containing composite tokens has been added. If you were using the Sass compilation, you must import the new Sass file between the semantic and component files.
...
- <details class="mb-small">
    <summary><span class="tag tag-small tag-negative"><span class="tag-status-icon"></span>Breaking</span> Removed Sass variables:</summary>
    <ul>
...
- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Default link styles has been updated.

### Components

#### Links

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Link component has been implemented. Read more in our [links page]([[docsref:/components/links]]).

### Helpers

#### Icon link

- <span class="tag tag-small tag-negative"><span class="tag-status-icon"></span>Breaking</span> Colors links are unstyled in OUDS Web, the documentation is only kept for Bootstrap compatibility.

- <span class="tag tag-small tag-warning"><span class="tag-status-icon"></span>Warning</span> The icon link documentation has been merged into is the new [Link component]([[docsref:/components/links]]) documentation and removed from helpers section.

### Utilities

#### Border

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Border color: `.border-muted`.

#### Link

- <span class="tag tag-small tag-negative"><span class="tag-status-icon"></span>Breaking</span> Link utilities are no more used in OUDS Web and the following classes have been removed: <code>.link-opacity-{'{number}'}</code>, <code>.link-offset-{'{number}'}</code>, <code>.link-underline-{'{number}'}</code>, .<code>link-underline-opacity-{'{number}'}</code>
...
- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Button component has been implemented. Read more in our [buttons page]([[docsref:/components/buttons]]).
...
- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> `$enable-button-pointers` (default <code>true</code>) has been introduced. It is used to add a "hand" cursor to non-disabled button elements.

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> `$enable-gradients` (default <code>false</code>) has been introduced. It is used to enable predefined gradients via `background-image` styles on various components.

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> `$enable-rounded` (default <code>true</code>) has been introduced. It allows you to set rounded or flat corners on components.
...
- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> We provide four brand new themes that are <code>light</code>, <code>dark</code>,  <code>root</code> and <code>root-inverted</code>. Read more on our [color modes page]([[docsref:/foundation/color-modes]])

### Content styles

#### Default styles

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Default styles have be added to HTML elements:
...
- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> All typography global settings have been set for:
  - Headings
  - Display headings
  - Regular texts
...
- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Responsive flexbox grid system is now available with eight default responsive tiers defined at breakpoints `2xs`, `xs`, `sm`, `md`, `xl`, `2xl`, and `3xl`.
...
<span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Responsive CSS grid classes: `.g-col-{breakpoint}-{number}`.

### Helpers

#### Color background

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> The new color-background color helpers are now available. *Deprecated in v0.6.0*

#### Icon

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Icons’ sizes utilities are now available to help choose the right icon size with a specific typography reference:
...
- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Responsive sticky helpers: `.sticky-{value}`, and `.sticky-{breakpoint}-{value}` where `breakpoint` is in `xs|sm|md|lg|xl|2xl|3xl`, and `value` is in `top|bottom`.

### Utilities

#### API

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> The `responsive` option is now available in the API to indicate if responsive classes should be generated.

#### Background

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> The new background color utilities are now available. Visit our [background page]([[docsref:/utilities/background]]) to read more.

#### Border

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Border operative utilities: `.border`, `.border-none`, `.border-top`, `.border-top-none`, `.border-bottom`, `.border-bottom-none`, `.border-start`, `.border-start-none`, `.border-end` and `.border-end-none`.
...
- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> The new border color utilities are now available. Visit our [border page]([[docsref:/utilities/border#color]]) to read more.

#### Colors

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> The new text color utilities are now available. Visit our [color page]([[docsref:/utilities/color]]) to read more.

#### Display

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Responsive display utilities: `.d-{value}`, `.d-{breakpoint}-{value}` where `breakpoint` is in `xs|sm|md|lg|xl|2xl|3xl`, and `value` is in `none|inline|inline-block|block|grid|inline-grid|table|table-cell|table-row|flex|inline-flex`.

#### Flex

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Responsive flex utilities without `breakpoint` for `2xs`, and where `breakpoint` is in `xs|sm|md|lg|xl|2xl|3xl`:
...
- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Responsive float utilities: `.float-{start|end|none}`, `.float-{breakpoint}-{start|end|none}` where `breakpoint` is in `xs|sm|md|lg|xl|2xl|3xl`.

#### Object fit

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Responsive object fit utilities: `.object-fit-{contain|cover|fill|scale|none}`, `.object-fit-{breakpoint}-{contain|cover|fill|scale|none}` where `breakpoint` is in `xs|sm|md|lg|xl|2xl|3xl`.

#### Opacity

- <span class="tag tag-small tag-negative"><span class="tag-status-icon"></span>Breaking</span> Opacity utilities: `.opacity-emphasis` has been renamed to `.opacity-strong` and `.opacity-transparent` has been renamed `.opacity-invisible`.
...
- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Sizing utility `.mw-none` to set `max-width: none`. This utility is particularly useful to reset the `max-width` of our font references in some special cases.
...
- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Alignment text utilities: `.text-start`, `.text-center`, `.text-end`, and responsive versions like `.text-{breakpoint}-{start|center|end}` where `breakpoint` is in `xs|sm|md|lg|xl|2xl|3xl`.

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Wrapping and overflow text utilities: `.text-wrap` and `.text-nowrap`.

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Word break text utility: `.text-break`.

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Text transform text utilities: `.text-lowercase`, `.text-uppercase`, and `.text-capitalize`.

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Font size text utilities:
  - **Display headings**: `.fs-dl`, `.fs-dm`, `.fs-ds`
  - **Headings**: `.fs-hxl`, `.fs-hl`, `.fs-hm`, `.fs-hs`
  - **Body**: `.fs-bl`, `.fs-bm`, `.fs-bs`
  - **Code**: `.fs-cm`

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Font weight text utilities: `.fw-normal` and `.fw-bold`.

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Text decoration utilities: `.text-decoration-underline`, `.text-decoration-line-through`, and `.text-decoration-none`.

### Examples

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> New [Font example]([[docsref:/examples/font]]).

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> New [Grid example]([[docsref:/examples/grid/]]).
...
- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> `$enable-container-classes` to enable or disable the generation of CSS classes for the grid system (e.g. `.row`, `.md:col-1`, etc.).
...
From now on, by default, OUDS Web won’t embed Bootstrap elements (like helpers, utilities, variables, components variants, etc.) that do not comply with Orange Unified Design System. However, you can still use our Bootstrap compatibility mode by using `ouds-web-bootstrap.css` and `ouds-web-bootstrap.min.css`. [Learn more about Bootstrap compatibility]([[docsref:/foundation/approach#bootstrap-compatibility]]).

### Utilities

#### Opacity

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Opacity utilities: `.opacity-transparent`, `.opacity-weaker`, `.opacity-weak`, `.opacity-medium`, `.opacity-emphasis` and `.opacity-opaque`.
...
- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> `$enable-bootstrap-compatibility` option set to `false` by default. This option allows you to compile the Sass files with a Bootstrap compatibility mode.
  - For instance, without the Bootstrap compatibility mode, you won’t have the opacity Bootstrap utilities such as `.opacity-0`, `.opacity-1`, `.opacity-50`, etc. You will only have the OUDS Web utilities such as `.opacity-invisible`, `.opacity-weaker`, `.opacity-weak`, etc. [Learn more about Bootstrap compatibility]([[docsref:/foundation/approach#bootstrap-compatibility]]).
