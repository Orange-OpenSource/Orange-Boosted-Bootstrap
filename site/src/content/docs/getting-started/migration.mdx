...
- <span class="tag tag-small tag-info"><span class="tag-status-icon"></span>Info</span> Filter chip and suggestion chip components have been updated to 1.4.0 with no outward changes. Read more in the [filter chip design changelog](https://r.orange.fr/r/S-ouds-doc-filter-chip_changelog) and [suggestion chip design changelog](https://r.orange.fr/r/S-ouds-doc-suggestion-chip_changelog).

- <span class="tag tag-small tag-info"><span class="tag-status-icon"></span>Info</span> Password input component has been updated to 1.3.0 with no outward changes. Read more in the [design changelog](https://r.orange.fr/r/S-ouds-doc-password-input_changelog).

- <span class="tag tag-small tag-info"><span class="tag-status-icon"></span>Info</span> Tag and input tag components have been updated to 1.5.0 and 1.2.0 respectively, with no outward changes. Read more in the [tag design changelog](https://r.orange.fr/r/S-ouds-doc-tag_changelog) and [input tag design changelog](https://r.orange.fr/r/S-ouds-doc-input-tag_changelog).
...
- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> Alert message and inline alert has been implemented. Read more in our [alerts page]([[docsref:/components/alerts]]).
