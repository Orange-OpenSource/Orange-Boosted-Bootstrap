...
- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> `.link-external` class has been added for external links. [Read more about these variants]([[docsref:/components/links#external]]).

- <span class="tag tag-small tag-positive"><span class="tag-status-icon"></span>New</span> `.link-compact` class has been added for more compact links. [Read more about these variants]([[docsref:/components/links#sizes]]).
