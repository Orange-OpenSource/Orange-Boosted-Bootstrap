...
layout: docs
title: Customize
description: Learn how to theme, customize, and extend Boosted Innovation Cup with Sass, a boatload of global options, an expansive color system, and more.
group: customize
toc: false
aliases:
  - "/customize/"
...
sections:
  ...
  - title: Options
    description: Customize Boosted Innovation Cup with built-in variables to easily toggle global CSS preferences.
  - title: Color
  ...
  - title: CSS variables
    description: Use Boosted Innovation Cup's CSS custom properties for fast and forward-looking design and development.
  - title: Optimize
...
There are multiple ways to customize Boosted Innovation Cup. Your best path can depend on your project, the complexity of your build tools, browser support, and more.

Our two preferred methods are:

1. Using Boosted Innovation Cup [via package manager]({{< docsref "/getting-started/download#package-managers" >}}) so you can use and extend our source files.
2. Using Boosted Innovation Cup's compiled distribution files or [jsDelivr]({{< docsref "/getting-started/download#cdn-via-jsdelivr" >}}) so you can add onto or override Boosted Innovation Cup's styles.

While we cannot go into details here on how to use every package manager, we can give some guidance on [using Boosted Innovation Cup with your own Sass compiler]({{< docsref "/customize/sass" >}}).
...
As you familiarize yourself with Boosted Innovation Cup, continue exploring this section for more details on how to utilize our global options, making use of and changing our color system, how we build our components, how to use our growing list of CSS custom properties, and how to optimize your code when building with Boosted Innovation Cup.

## CSPs and embedded SVGs

Several Boosted Innovation Cup components include embedded SVGs in our CSS to style components consistently and easily across browsers and devices. **For organizations with more strict <abbr title="Content Security Policy">CSP</abbr> configurations**, we've documented all instances of our embedded SVGs (all of which are applied via `background-image`) so you can more thoroughly review your options.
