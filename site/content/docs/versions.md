  ...
  <div class="col-md-6 col-lg-4 col-xl mb-4">
    ...
    {{- range $i, $version := $versions }}
      ...
      {{ if (eq $i 0) }}<div class="list-group">{{ end }}
        <a class="list-group-item list-group-item-action py-2 {{ if (eq $version $.Site.Params.docs_version) }} d-flex justify-content-between align-items-center{{ end }}" href="{{ $release.baseurl }}/{{ $version }}/">
          {{ $version }}
