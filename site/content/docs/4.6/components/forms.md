...
<!-- Boosted mod: do not show default file input -->
...
{{< /example >}}
<!-- Boosted mod: do not show default range input -->

<!-- Boosted mod: do not show default checkbox/radio input -->
...
<!-- Boosted mod: not needed since we only expose custom-forms everywhere… -->
