...
<!-- Boosted mod: prevent using text-alignment helpers -->

## Navigation

Add some navigation to a card's header (or block) with Boosted's [nav components]({{< docsref "/components/navs" >}}).
...
<div class="card bg-dark">
   {{< placeholder width="100%" height="270" class="bd-placeholder-img-lg card-img" text="Card image" background="#000" color="#666" >}}
