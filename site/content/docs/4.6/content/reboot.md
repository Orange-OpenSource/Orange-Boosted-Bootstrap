...
To get this style without depending on `::marker`'s support, you're encouraged to use [Orange square list]({{< docsref "/content/typography#orange-square-list" >}}) utility class — which relies on `::before` pseudo-element.  
