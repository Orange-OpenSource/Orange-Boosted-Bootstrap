...
{{< example button_label="vertical alignment at the top" class="bd-example-row bd-example-row-flex-cols" >}}
...
{{< example button_label="centered vertical alignment" class="bd-example-row bd-example-row-flex-cols" >}}
<div class="container-fluid text-center">
...
{{< example button_label="vertical alignment at the bottom" class="bd-example-row bd-example-row-flex-cols" >}}
<div class="container-fluid text-center">
...
{{< example button_label="vertical alignment on each column" class="bd-example-row bd-example-row-flex-cols" >}}
<div class="container-fluid text-center">
  <div class="row">
...
{{< example button_label="horizontal alignment" class="bd-example-row" >}}
<div class="container-fluid text-center">
...
{{< example button_label="column wrapping" class="bd-example-row" >}}
...
{{< example button_label="column breaks" class="bd-example-row" >}}
<div class="container-fluid text-center">
  <div class="row">
...
{{< example button_label="column breaks at specific breakpoint" class="bd-example-row" >}}
<div class="container-fluid text-center">
  <div class="row">
...
{{< example button_label="reordering" class="bd-example-row" >}}
<div class="container-fluid text-center">
  <div class="row">
    <div class="col">
...
{{< example button_label="first and last reordering"  class="bd-example-row" >}}
<div class="container-fluid text-center">
  <div class="row">
...
{{< example button_label="column offset" class="bd-example-row" >}}
<div class="container-fluid text-center">
  <div class="row">
...
{{< example button_label="reset column offset" button_label="horizontal alignment" class="bd-example-row" >}}
<div class="container-fluid text-center">
  <div class="row">
...
{{< example button_label="margin utilities" class="bd-example-row" >}}
<div class="container-fluid text-center">
  <div class="row">
    <div class="col-md-4">.col-md-4</div>
...
{{< example button_label="standalone column classes" class="bd-example-row" >}}
...
{{< example button_label="standalone column classes with utilities" >}}
<div class="clearfix">
