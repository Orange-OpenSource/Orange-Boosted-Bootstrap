...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Static method which allows you to get the carousel instance associated to a DOM element, you can use it like this: <code>boosted.Carousel.getInstance(element)</code>
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        ...
        You can use it like this: <code>boosted.Carousel.getOrCreateInstance(element)</code>
      </td>
    </tr>
  </tbody>
</table>
