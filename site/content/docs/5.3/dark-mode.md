...
<div class="d-flex flex-column gap-2">
  <div class="d-flex flex-row gap-2 align-items-center">
    ...
    <div style="width: 50px; height: 50px; background-color:var(--bs-body-bg)"></div>
  ...
  <div class="d-flex flex-row gap-2 align-items-center">
    ...
    <div style="width: 50px; height: 50px; background-color:var(--bs-body-color)"></div>
  ...
  <div class="d-flex flex-row gap-2 align-items-center">
    ...
    <div style="width: 50px; height: 50px; background-color:var(--bs-highlight-bg)"></div>
    <div style="width: 50px; height: 50px; background-color:var(--bs-highlight-bg)" data-bs-theme="dark"></div>
  </div>
  <div class="d-flex flex-row gap-2 align-items-center">
    <div style="width: 200px">--bs-highlight-bg</div>
    <div style="width: 50px; height: 50px; background-color:var(--bs-highlight-color)"></div>
  ...
  <div class="d-flex flex-row gap-2 align-items-center">
    ...
    <div style="width: 50px; height: 50px; background-color:var(--bs-secondary-bg)"></div>
  ...
  <div class="d-flex flex-row gap-2 align-items-center">
    ...
    <div style="width: 50px; height: 50px; background-color:var(--bs-color-translucent)"></div>
  ...
  <div class="d-flex flex-row gap-2 align-items-center">
    ...
    <div style="width: 50px; height: 50px; background-color:var(--bs-secondary-color)"></div>
  ...
  <div class="d-flex flex-row gap-2 align-items-center">
    ...
    <div style="width: 50px; height: 50px; background-color:var(--bs-primary)"></div>
  ...
  <div class="d-flex flex-row gap-2 align-items-center">
    ...
    <div style="width: 50px; height: 50px; background-color:var(--bs-danger)"></div>
