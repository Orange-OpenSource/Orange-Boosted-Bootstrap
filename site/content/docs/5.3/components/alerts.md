...
Boosted also adds a dedicated icon for each contextual class using `.alert-icon`, matching [functional colors in palette]({{<docsref "customize/color-theme#functional-colors">}}):
- success,
- info,
- warning,
- danger.
