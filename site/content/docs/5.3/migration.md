...
- <span class="badge bg-warning">Warning</span> In order to improve accessibility for people suffering for any form of colorblindness, we added a visual cue to form elements on error when focused.
