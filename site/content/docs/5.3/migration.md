...
- **Typography**
  ...
  - <span class="badge bg-warning">Breaking</span> Some headings font size values and breakpoints have been changed to be compliant with the design guidelines. Please check it has no impact on your websites.
