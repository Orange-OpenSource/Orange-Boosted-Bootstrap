...
- <span class="badge text-bg-status-negative-emphasized">Breaking</span> the last element of a Breadcrumb must now contains a `span` element to handle behavior on smaller viewport.
