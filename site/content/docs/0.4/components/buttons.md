...
{{< example button_label="standard button variants" class="bd-btn-example">}}
...
{{< example button_label="variants on colored backgrounds" class="p-none bd-btn-example">}}
...
{{< example button_label="text and icon buttons" class="p-none bd-btn-example">}}
...
{{< example button_label="icon only buttons" class="p-none bd-btn-example">}}
<div class="p-tall d-flex gap-shorter flex-wrap">
...
{{< example button_label="buttons with other tags" class="bd-btn-example">}}
...
{{< example button_label="outline buttons" class="bd-btn-example">}}
{{< buttons.inline >}}
{{- range (index $.Site.Data "theme-colors") }}
...
{{< example button_label="disabled state" class="p-none bd-btn-example" >}}
<div class="p-tall d-flex gap-shorter flex-wrap">
...
{{< example button_label="disabled state with `<a>` tag" class="p-none bd-btn-example" >}}
<div class="p-tall d-flex gap-shorter flex-wrap">
...
{{< example button_label="loading state" class="p-none bd-btn-example" >}}
<div class="p-tall d-flex gap-shorter flex-wrap">
...
{{< example button_label="loading state with variants" class="bd-btn-example">}}
<div class="p-tall d-flex gap-shorter flex-wrap">
...
{{< example button_label="block buttons" class="bd-btn-example">}}
...
{{< example button_label="block buttons variation" class="bd-btn-example">}}
...
{{< example button_label="block buttons with grid system" class="bd-btn-example">}}
...
{{< example button_label="block buttons with flex utilities" class="bd-btn-example">}}
