...
By default, a dropdown menu is automatically positioned 100% from the top and along the left side of its parent. Add `.dropdown-menu-end` to a `.dropdown-menu` to right align the dropdown menu. Directions are mirrored when using Boosted in RTL, meaning `.dropdown-menu-end` will appear on the left side.
...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>To change Boosted's default Popper config, see <a href="https://popper.js.org/docs/v2/constructors/#options">Popper's configuration</a></td>
    </tr>
  </tbody>
</table>
