...
The boosted utilities are generated with the utility API which can be used to change or extend Boosted's utility classes. If you don't have any idea what Sass maps are, you can consult the [official docs](https://sass-lang.com/documentation/values/maps) to get started.
