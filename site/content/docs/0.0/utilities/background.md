...
Most <code>background-color</code> utilities are generated by our theme colors, reassigned from our generic color palette variables.
...
Variables for setting <code>background-color</code> in <code>.bg-*-subtle</code> utilities in light and dark mode:
