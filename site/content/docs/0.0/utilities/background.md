...
{{< example >}}
<div class="bg-primary p-tall mb-short fw-bold">.bg-primary</div>
<div class="bg-secondary p-tall mb-short fw-bold">.bg-secondary</div>
<div class="bg-tertiary p-tall mb-short fw-bold">.bg-tertiary</div>
<div class="bg-emphasized p-tall mb-short fw-bold">.bg-emphasized</div>
<div class="bg-overlay-default p-tall mb-short fw-bold">.bg-overlay-default</div>
<div class="bg-overlay-drag p-tall mb-short fw-bold">.bg-overlay-drag</div>
<div class="bg-overlay-emphasized p-tall mb-short fw-bold">.bg-overlay-emphasized</div>
<div class="bg-overlay-modal p-tall mb-short fw-bold">.bg-overlay-modal</div>
<div class="bg-brand-primary p-tall mb-short fw-bold">.bg-brand-primary</div>
<div class="bg-status-neutral-emphasized p-tall mb-short fw-bold">.bg-status-neutral-emphasized</div>
<div class="bg-status-neutral-muted p-tall mb-short fw-bold">.bg-status-neutral-muted</div>
<div class="bg-status-accent-emphasized p-tall mb-short fw-bold">.bg-status-accent-emphasized</div>
<div class="bg-status-accent-muted p-tall mb-short fw-bold">.bg-status-accent-muted</div>
<div class="bg-status-positive-emphasized p-tall mb-short fw-bold">.bg-status-positive-emphasized</div>
<div class="bg-status-positive-muted p-tall mb-short fw-bold">.bg-status-positive-muted</div>
<div class="bg-status-negative-emphasized p-tall mb-short fw-bold">.bg-status-negative-emphasized</div>
<div class="bg-status-negative-muted p-tall mb-short fw-bold">.bg-status-negative-muted</div>
<div class="bg-status-warning-emphasized p-tall mb-short fw-bold">.bg-status-warning-emphasized</div>
<div class="bg-status-warning-muted p-tall mb-short fw-bold">.bg-status-warning-muted</div>
<div class="bg-status-info-emphasized p-tall mb-short fw-bold">.bg-status-info-emphasized</div>
<div class="bg-status-info-muted p-tall mb-short fw-bold">.bg-status-info-muted</div>
<div class="bg-always-black p-tall mb-short fw-bold">.bg-always-black</div>
<div class="bg-always-white p-tall mb-short fw-bold">.bg-always-white</div>
<div class="bg-transparent p-tall mb-short fw-bold">.bg-transparent</div>
{{< /example >}}
