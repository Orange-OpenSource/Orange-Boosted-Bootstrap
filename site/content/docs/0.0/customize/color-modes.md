...
Here is an example of a block that uses the light theme. To get the light theme independently from the cascade, set via <span class="user-select-all">`data-bs-theme="light"`</span> on any element. Feel free to change the color mode of the page to see the effect.

{{< example >}}
<div class="bg-status-warning-emphasized p-short">
  <div data-bs-theme="light">
    <p>Some text and components in here will always be displayed in light mode</p>
    <button class="btn btn-strong mb-short">Light mode button</button>
  </div>
</div>
{{< /example >}}
...
Here is an example of a block that uses the dark theme. To get the dark theme independently from the cascade, set via <span class="user-select-all">`data-bs-theme="dark"`</span> on any element. Feel free to change the color mode of the page to see the effect.

{{< example >}}
<div class="bg-emphasized p-short">
  <div data-bs-theme="dark">
    <p>Some text and components in here will always be displayed in dark mode</p>
...
We have two more dynamic themes that are `"root"` and `"root-inverted"`. These themes are named dynamic because they depend on the root element mode, so by changing the root mode, you're changing all those dynamic calls as well. The `"root"` theme will reset the color mode to the root theme of your page, while the `"root-inverted"` theme will reset the color mode to the opposite theme of your page.
...
Here is an example of a block that inverts the root theme when it's placed inside a dark block. To get the inverted root theme independently from the cascade, set via <span class="user-select-all">`data-bs-theme="root-inverted"`</span> on any element but the root one. Feel free to change the color mode of the page to see the effect.

<!-- TODO LM: Do we keep it simple or the example should be something that can happen ? Like a dropdown menu inside a background needing root-inverted. -->

{{< example >}}
<div class="bg-always-black p-short">
  <div data-bs-theme="dark">
    <p>Some text and components in here will always be displayed in dark mode</p>
    <button class="btn btn-strong mb-short">Dark mode button</button>
    <div data-bs-theme="root-inverted" class="bg-primary p-short"> <!-- TODO LM: How to explain that we don't want to use 2 layers to define bg and theme in here ? -->
      <p>Some text and components in here will always be inverted with the root mode</p>
      <button class="btn btn-strong">Inverted root mode button</button>
    </div>
  </div>
</div>
{{< /example >}}
...
Here is an example of a block that follows the root theme when it's placed inside a dark block. To get the root theme independently from the cascade, set via <span class="user-select-all">`data-bs-theme="root"`</span> on any element but the root one. Feel free to change the color mode of the page to see the effect.

<!-- TODO LM: Do we keep it simple or the example should be something that can happen ? Like a dropdown menu inside a header. -->
...
<div class="bg-always-black p-short">
  <div data-bs-theme="dark">
    <p>Some text and components in here will always be displayed in dark mode</p>
    <button class="btn btn-strong mb-short">Dark mode button</button>
    <div data-bs-theme="root" class="bg-primary p-short">
      <p>Some text and components in here will always follow the root mode</p>
      <button class="btn btn-strong">Root mode button</button>
    </div>
  </div>
</div>
{{< /example >}}
...
{{< bs-table >}}
| Root light mode text color | Root dark mode text color | Theme that should be used |
| --- | --- | --- |
...
{{< callout warning >}}
`root` theme should be used only in very specific occasions, most of the time it will cascade from the root theme.
{{< /callout >}}
...
<div data-bs-theme="root-inverted" class="dropdown">
  <button class="btn btn-dropdown dropdown-toggle" type="button" id="dropdownMenuButtonRoot" data-bs-toggle="dropdown" aria-expanded="false">
    Root inverted dropdown and root dropdown menu
  </button>
...
<!-- TODO LM: Do we move it in color theme ? -->
<!-- ## Adding theme colors -->
