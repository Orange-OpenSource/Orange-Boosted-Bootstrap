...
layout: docs
title: Contents
description: Discover what's included in Boosted Innovation Cup, including our compiled and source code flavors.
...
The `scss/` and `js/` are the source code for our CSS and JavaScript. The `dist/` folder includes everything listed in the compiled download section above. The `site/docs/` folder includes the source code for our documentation, and `examples/` of Boosted Innovation Cup usage. Beyond that, any other included file provides support for packages, license information, and development.
