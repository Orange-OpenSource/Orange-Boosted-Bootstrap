...
<img class="mb-4 img-fluid rounded-3" srcset="/docs/{{< param docs_version >}}/assets/img/guides/boosted-webpack.png, /docs/{{< param docs_version >}}/assets/img/guides/boosted-webpack@2x.png 2x" src="/docs/{{< param docs_version >}}/assets/img/guides/boosted-webpack.png" width="2000" height="1000" alt="">
