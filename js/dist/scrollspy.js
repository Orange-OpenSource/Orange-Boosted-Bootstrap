/*!
  ...
  * Bootstrap scrollspy.js v1.5.0 (https://web.unified-design-system.orange.com/)
...
(function (global, factory) {
  ...
  class ScrollSpy extends BaseComponent {
    ...
    _configAfterMerge(config) {
      config.target = index_js.getElement(config.target);
      if (!config.target) {
    ...
    _initializeTargetsAndObservables() {
      ...
      for (const anchor of targetLinks) {
        ...
        if (!section || !this._element.contains(section) || !index_js.isVisible(section)) {
          continue;
        }
