    ...
    it('should be able to handle toggling of other children siblings', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = [
          ...
          '  </div>',
          '  <div id="parentContent" class="accordion-collapse collapse" role="region" aria-labelledby="parentHeader" data-bs-parent="#parentGroup">',
          ...
          '          </div>',
          '          <div id="childContent1" class="accordion-collapse collapse" role="region" aria-labelledby="childHeader1" data-bs-parent="#childGroup">',
          '            <div>content</div>',
          '          </div>',
          '        </div>',
          '        <div class="accordion-item">',
          ...
          '          </div>',
          '          <div id="childContent2" class="accordion-collapse collapse" role="region" aria-labelledby="childHeader2" data-bs-parent="#childGroup">',
          '            <div>content</div>',
          '          </div>',
          '        </div>',
          '      </div>',
