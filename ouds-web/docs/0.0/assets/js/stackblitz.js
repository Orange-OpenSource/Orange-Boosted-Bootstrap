...
</html>`}function z(e,t){let n=B(e);n.action=E("/run",t),n.target=S(t),document.body.appendChild(n),n.submit(),document.body.removeChild(n)}function m(e){var n;return e!=null&&e.contentWindow?((n=K(e))!=null?n:new b(e)).pending:Promise.reject("Provided element is not an iframe.")}function J(e,t){z(e,t)}function X(e,t){let n=E(`/edit/${e}`,t),o=S(t);window.open(n,o)}function Y(e,t){let n=E(`/github/${e}`,t),o=S(t);window.open(n,o)}function Q(e,t,n){var c;let o=v(e),s=G(t,n),r=document.createElement("iframe");return _(o,r,n),(c=r.contentDocument)==null||c.write(s),m(r)}function Z(e,t,n){let o=v(e),s=document.createElement("iframe");return s.src=w(`/edit/${t}`,n),_(o,s,n),m(s)}function ee(e,t,n){let o=v(e),s=document.createElement("iframe");return s.src=w(`/github/${t}`,n),_(o,s,n),m(s)}var C={connect:m,embedGithubProject:ee,embedProject:Q,embedProjectId:Z,openGithubProject:Y,openProject:J,openProjectId:X};var L="https://cdn.jsdelivr.net/npm/@ouds/web@0.0.0/dist/css/ouds-web.min.css",x="0.0";var D="https://cdn.jsdelivr.net/npm/@ouds/web@0.0.0/dist/js/ouds-web.bundle.min.js",O=`(() => {
