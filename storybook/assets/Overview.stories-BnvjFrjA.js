const f={title:"Components/Overview",parameters:{docs:{toc:!0}}},e=()=>`<div class="bd-example order-first m-0 border-0 m-0 border-0"> <form>
  <div class="mb-3">
...
<\/script>`,t=()=>`<div class="bd-example order-first m-0 border-0 m-0 border-0"> <form>
  <fieldset disabled="">
...
<script type="text/javascript">
  ...
  // storybook-end popovers
  // storybook-end overview
<\/script>`,o=()=>`<div class="bd-example order-first m-0 border-0 m-0 border-0"> <form>
  <fieldset>
    <div class="mb-3">
...
<script type="text/javascript">
  ...
  // storybook-end popovers
  // storybook-end overview
<\/script>`,l=()=>`<div class="bd-example order-first m-0 border-0 m-0 border-0"> <div class="mb-3">
...
<script type="text/javascript">
  ...
  // storybook-end popovers
  // storybook-end overview
<\/script>`;var s,r,a;e.parameters={...e.parameters,docs:{...(s=e.parameters)==null?void 0:s.docs,source:{originalSource:`() => \`<div class="bd-example order-first m-0 border-0 m-0 border-0"> <form>
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Email address</label>
    <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
    <div id="emailHelp" class="form-text">We’ll never share your email with anyone else.</div>
...
<script type="text/javascript">
  ...
  // storybook-end popovers
  // storybook-end overview
<\/script>\``,...(a=(r=e.parameters)==null?void 0:r.docs)==null?void 0:a.source}}};var i,n,p;t.parameters={...t.parameters,docs:{...(i=t.parameters)==null?void 0:i.docs,source:{originalSource:`() => \`<div class="bd-example order-first m-0 border-0 m-0 border-0"> <form>
  <fieldset disabled="">
    <legend>Disabled fieldset example</legend>
    <div class="mb-3">
      <label for="disabledTextInput" class="form-label is-disabled">Disabled input</label>
...
<script type="text/javascript">
  ...
  // storybook-end popovers
  // storybook-end overview
<\/script>\``,...(p=(n=t.parameters)==null?void 0:n.docs)==null?void 0:p.source}}};var c,d,b;o.parameters={...o.parameters,docs:{...(c=o.parameters)==null?void 0:c.docs,source:{originalSource:`() => \`<div class="bd-example order-first m-0 border-0 m-0 border-0"> <form>
  <fieldset>
    <div class="mb-3">
      <label for="requiredTextInput" class="form-label is-required">Required input<span class="visually-hidden"> (required)</span></label>
      <input type="text" id="requiredTextInput" class="form-control" placeholder="Required input" required="">
...
<script type="text/javascript">
  ...
  // storybook-end popovers
  // storybook-end overview
<\/script>\``,...(b=(d=o.parameters)==null?void 0:d.docs)==null?void 0:b.source}}};var v,u,m;l.parameters={...l.parameters,docs:{...(v=l.parameters)==null?void 0:v.docs,source:{originalSource:`() => \`<div class="bd-example order-first m-0 border-0 m-0 border-0"> <div class="mb-3">
  <label for="tooltipTextInput" class="form-label">Input with helper inside a Popover</label>
  <button type="button" class="form-helper" data-bs-toggle="popover" data-bs-placement="top" data-bs-content="Help for input">
    <span class="visually-hidden">Helper for input</span>
  </button>
