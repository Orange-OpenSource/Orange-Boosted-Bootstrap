const e={title:"Components/LocalNavigation",parameters:{docs:{toc:!0}}},a=()=>`<div class="bd-example order-first m-0 border-0 m-0 border-0"> <nav class="local-nav" aria-label="Basic local navigation">
...
<\/script>`;var l,s,n;a.parameters={...a.parameters,docs:{...(l=a.parameters)==null?void 0:l.docs,source:{originalSource:`() => \`<div class="bd-example order-first m-0 border-0 m-0 border-0"> <nav class="local-nav" aria-label="Basic local navigation">
  <button class="local-nav-button collapsed d-lg-none" type="button" data-bs-toggle="collapse" data-bs-target="#collapseLocalNav" aria-expanded="false" aria-controls="collapseLocalNav">
    <span class="container-xxl">Shop</span>
  </button>
  <div id="collapseLocalNav" class="container-xxl local-nav-collapse d-lg-block collapse">
...
<script type="text/javascript">
  /* global boosted: false */
  document.querySelectorAll('[href]').forEach(link => {link.addEventListener('click', event => {event.preventDefault()})})
<\/script>\``,...(n=(s=a.parameters)==null?void 0:s.docs)==null?void 0:n.source}}};const c=["LocalNavigation_0"];export{a as LocalNavigation_0,c as __namedExportsOrder,e as default};
