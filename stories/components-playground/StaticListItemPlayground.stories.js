...
const renderStaticListItem = ({ overline, label, boldLabel, extraLabel, description, leadingAsset, leadingSize, leadingStatus, trailingAsset, trailingSize, trailingStatus, helperText, state, background, noDivider, topAlignment, smallSize, maxWidth, icon }, icons = customIcons(icon), preview = true) => {
...
export const PlaygroundStaticListItem = {
  parameters: {
    docs: {
      codePanel: true,
      source: {
        transform: (_src, context) => renderStaticListItem(context.args, customSpriteIcons(context.args.icon), false),
      },
    },
  },
