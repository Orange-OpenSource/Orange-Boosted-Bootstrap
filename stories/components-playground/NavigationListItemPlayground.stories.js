...
// on `Wrapping link`, `Back chevron`, `External link` and the derived
// `.item-slot-focusable`. This file combines both without repeating
// either.
