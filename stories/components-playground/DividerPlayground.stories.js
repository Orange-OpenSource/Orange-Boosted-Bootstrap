...
const renderDivider = ({ orientation, color, size }, preview = true) => {
  ...
  return surroundings[preview ? 'preview' : 'code'](markup, safeOrientation)
}
    ...
    docs: {
      ...
      source: {
        transform: (_src, context) => {
          const { orientation, color, size } = context.args
