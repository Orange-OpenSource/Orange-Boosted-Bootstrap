...
const renderNavigationCardItem = ({ overline, label, boldLabel, extraLabel, description, leadingAsset, leadingSize, leadingStatus, trailingAsset, trailingSize, trailingStatus, helperText, wrappingLink, backChevron, externalLink, newWindow, state, background, noDivider, outlined, roundedCorners, topAlignment, smallSize, maxWidth, icon }, icons = customIcons(icon), preview = true) => {
