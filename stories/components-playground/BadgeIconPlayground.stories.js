...
// Docs: https://web.unified-design-system.orange.com/orange/docs/components/badges/#badge---icon
...
const renderBadgeIcon = ({ status, size, state }) => {
  const classes = [
    'badge',
...
// PlaygroundBadgeIcon porte les args par défaut : elle tient lieu de story Default.

export const Accent = {
  parameters: PlaygroundBadgeIcon.parameters,
  render: PlaygroundBadgeIcon.render,
  args: {
    ...PlaygroundBadgeIcon.args,
    status: 'Accent'
  },
}
