...
// Note: this should be refactored and removed, the sidebar ordering defined in `apps/site/data/sidebar.yml` should not
// rely on slugified custom titles that are expected to generate a string matching the actual file names on disk, this
// is error prone. Instead, custom sidebar titles should be defined in the frontmatter of the MDX files when needed and
// `apps/site/data/sidebar.yml` should only reference the actual file names and slug extracted from the docs content
