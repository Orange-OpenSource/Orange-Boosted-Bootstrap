...
<BootstrapCompatibility>
  ...
  <Example buttonLabel="Bootstrap compatibility: skeleton with `.placeholder-glow` or `.placeholder-wave`" code={`<p class="placeholder-glow">
...
<BootstrapCompatibility>
  ...
  <Example buttonLabel="Bootstrap compatibility: skeletons with title height" code={`<span class="placeholder col-12 placeholder-lg"></span>
  <span class="placeholder col-12"></span>
...
<JsDocs name="skeleton-first-example" file="../../apps/site/src/assets/partials/snippets.js" />
...
<JsDocs name="skeleton-second-example" file="../../apps/site/src/assets/partials/snippets.js" />
