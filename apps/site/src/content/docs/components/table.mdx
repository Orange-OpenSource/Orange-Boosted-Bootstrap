...
Use `.{xs|sm|md|lg|xl|2xl|3xl}:table-responsive` as needed to create responsive tables up to a particular breakpoint. From that breakpoint and up, the table will behave normally and not scroll horizontally.
...
<Details summary="Examples of responsive tables up to particular breakpoint">
  ...
  {getData('breakpoints').map((breakpoint) => {
    if (breakpoint.abbr) return (
      <div class="bd-example">
        <div class={`${breakpoint.abbr}:table-responsive`}>
          <table class="table">
            <caption>OUDS Web responsive table for {breakpoint.abbr} breakpoint and under</caption>
            <thead>
            <tr>
              <th scope="col">#</th>
              <th scope="col">Heading</th>
  ...
  <Code buttonLabel="responsive tables up to particular breakpoint" lang="html"
    code={getData('breakpoints').map((breakpoint) => { if (breakpoint.abbr) return (
  `<div class="${breakpoint.abbr}:table-responsive">
    <table class="table">
      ...
    </table>
...
<BootstrapCompatibility>
  ...
  **These tables may appear broken until their responsive styles apply at specific viewport widths.**
    ...
    if (breakpoint.abbr) return (
      <div class="bd-example">
        <div class={`table-responsive-${breakpoint.abbr}`}>
          <table class="table">
            <caption>Responsive table for {breakpoint.abbr} breakpoint and under (Bootstrap)</caption>
            <thead>
            <tr>
              <th scope="col">#</th>
              <th scope="col">Heading</th>
  ...
  <Code buttonLabel="Bootstrap compatibility: responsive tables up to particular breakpoint" lang="html"
        code={getData('bootstrap-breakpoints').map((breakpoint) => { if (breakpoint.abbr) return (
  `<div class="table-responsive-${breakpoint.abbr}">
    <table class="table">
      ...
    </table>
...
<JsDocs name="live-row-selection-checkboxes" file="../../apps/site/src/assets/partials/snippets.js" />
...
<JsDocs name="live-row-selection-radios" file="../../apps/site/src/assets/partials/snippets.js" />
...
<Example buttonLabel="table with components and icons" class="table-responsive" code={`<table class="table">
      ...
      <tr class="align-middle">
        <td>
          <svg class="bm-large-icon me-xsmall" aria-hidden="true">
            <use xlink:href="${getVersionedDocsPath('/assets/img/ouds-web-sprite.svg#file-document')}"></use>
          </svg>Cell
        </td>
        <td>This is a much longer section of text that demonstrates what happens when text wraps within a cell in a table</td>
        <td>
...
<Example buttonLabel="table with components and icons preserving the row height" class="table-responsive" code={`<table class="table">
