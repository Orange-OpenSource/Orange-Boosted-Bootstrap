...
The `scss/` and `js/` are the source code for our CSS and JavaScript. The `dist/` folder includes everything listed in the compiled download section above. The documentation site source code, including our live examples of OUDS Web usage, lives separately in the repository's `apps/site/src/content/docs/` folder.
