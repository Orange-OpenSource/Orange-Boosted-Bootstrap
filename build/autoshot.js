...
const items = [{
  ...
  src: `http://${host}:${port}/docs/4.0/examples/checkout/index.html`,
  dest: 'checkout.png'
}, {
...
{
  src: `http://${host}:${port}/docs/4.0/examples/floating-labels/index.html`,
...
{
  src: `http://${host}:${port}/docs/4.0/examples/quick-links/index.html`,
  dest: 'quick-links.png'
},
{
  src: `http://${host}:${port}/docs/4.0/examples/content-panel/index.html`,
  dest: 'content-panel.png'
},
{
  src: `http://${host}:${port}/docs/4.0/examples/product-details/index.html`,
...
{
  src: `http://${host}:${port}/docs/4.0/examples/navbar-fixed/index.html`,
  dest: 'navbar-fixed.png'
},
{
  src: `http://${host}:${port}/docs/4.0/examples/navbar-static/index.html`,
...
{
  src: `http://${host}:${port}/docs/4.0/examples/navbar-top/index.html`,
  dest: 'navbar-top.png'
},
{
...
{
  src: `http://${host}:${port}/docs/4.0/examples/sign-in/index.html`,
  dest: 'sign-in.png'
},
{
  src: `http://${host}:${port}/docs/4.0/examples/pricing/index.html`,
  dest: 'pricing.png'
},
{
  src: `http://${host}:${port}/docs/4.0/examples/product/index.html`,
  dest: 'product.png'
},
{
...
{
  src: `http://${host}:${port}/docs/4.0/examples/administration-mainpage/index.html`,
  dest: 'administration-mainpage.png'
},
{
  src: `http://${host}:${port}/docs/4.0/examples/administration-edition-page/index.html`,
  dest: 'administration-edition-page.png'
},
{
  src: `http://${host}:${port}/docs/4.0/examples/dashboard-orange-branded/index.html`,
...
{
  src: `http://${host}:${port}/docs/4.0/examples/news-template/index.html`,
  dest: 'news-template.png'
},
{
  src: `http://${host}:${port}/docs/4.0/examples/orange-homepage/index.html`,
