...
<div class="card{% unless color.name == "light" or color.name == "info" or color.name == "warning" or color.name == "success" or color.name == "primary" %} text-white{% endunless %} bg-{{ color.name }} mb-3" style="max-width: 20rem;">
...
<div class="row">
  <div class="col-md-4">
    <a href="#" class="card o-card-link">
        <div class="card-img">
            <img data-src="holder.js/100x100?auto=yes&bg=666&fg=fff&text=Image" alt="Card image cap">
        </div>
        <div class="card-body">
