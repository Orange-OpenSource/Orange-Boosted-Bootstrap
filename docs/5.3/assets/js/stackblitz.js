...
</html>`}function te(e,t){let n=C(e);n.action=v("/run",t),n.target=I(t),document.body.appendChild(n),n.submit(),document.body.removeChild(n)}function f(e){var n;return e!=null&&e.contentWindow?((n=X(e))!=null?n:new E(e)).pending:Promise.reject("Provided element is not an iframe.")}function ne(e,t){te(e,t)}function oe(e,t){let n=v(`/edit/${e}`,t),o=I(t);window.open(n,o)}function se(e,t){let n=v(`/github/${e}`,t),o=I(t);window.open(n,o)}function re(e,t,n){var i;let o=S(e),s=ee(t,n),r=document.createElement("iframe");return _(o,r,n),(i=r.contentDocument)==null||i.write(s),f(r)}function ie(e,t,n){let o=S(e),s=document.createElement("iframe");return s.src=w(`/edit/${t}`,n),_(o,s,n),f(s)}function ce(e,t,n){let o=S(e),s=document.createElement("iframe");return s.src=w(`/github/${t}`,n),_(o,s,n),f(s)}var B={connect:f,embedGithubProject:ce,embedProject:re,embedProjectId:ie,openGithubProject:se,openProject:ne,openProjectId:oe};var L="https://cdn.jsdelivr.net/npm/boosted@5.3.4/dist/css/boosted.min.css",O="5.3",x="https://cdn.jsdelivr.net/npm/boosted@5.3.4/dist/fonts/HelvNeue55_W1G.woff2",M="sha384-R6e0PFLMMV6HBvkQK22ecNfjOzyh89wSndiTC71MuvoaOnhIYgOAGVC0gW0kVN16",k="https://cdn.jsdelivr.net/npm/boosted@5.3.4/dist/fonts/HelvNeue75_W1G.woff2",H="sha384-ylOkwNNvSwXpWNbpEhI45ruJTXyfQbIb42IxMvSGGcndZBpZ9iAmOFSUl4/Goeqz",q="https://cdn.jsdelivr.net/npm/boosted@5.3.4/dist/css/orange-helvetica.min.css",F="sha384-A0Qk1uKfS1i83/YuU13i2nx5pk79PkIfNFOVzTcjCMPGKIDj9Lqx9lJmV7cdBVQZ";var D="https://cdn.jsdelivr.net/npm/boosted@5.3.4/dist/js/boosted.bundle.min.js",G=`(() => {
  // ns-hugo-imp:/Users/zgrl8388/dev/ob1/Orange-Boosted-Bootstrap/site/assets/js/partials/snippets.js
...
<head>
  ...
  <link href="${q}" rel="stylesheet" integrity="${F}" crossorigin="anonymous">

  <link href="${L}" rel="stylesheet">
  <link href="https://boosted.orange.com/docs/${O}/assets/css/docs.css" rel="stylesheet">
