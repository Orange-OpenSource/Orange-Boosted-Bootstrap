...
e("#exampleModal").on("show.bs.modal",function(t){var n=e(t.relatedTarget).data("whatever"),r=e(this);r.find(".modal-title").text("New message to "+n),r.find(".modal-body input").val(n)}),
...
e(".highlight").each(function(){e(this).before('<div class="bd-clipboard"><button class="btn-clipboard btn btn-sm btn-secondary" title="Copy to clipboard">Copy</button></div>'),e(".btn-clipboard").tooltip().on("mouseleave",function(){
// explicitly hide tooltip, since after clicking it remains
// focused (as it's a button), so tooltip would otherwise
// remain visible until focus is moved away
e(this).tooltip("hide")})});var t=new Clipboard(".btn-clipboard",{target:function(e){return e.parentNode.nextElementSibling}});t.on("success",function(t){e(t.trigger).attr("title","Copied!").tooltip("_fixTitle").tooltip("show").attr("title","Copy to clipboard").tooltip("_fixTitle"),t.clearSelection()}),t.on("error",function(t){var n="Press "+(/Mac/i.test(navigator.userAgent)?"⌘":"Ctrl-")+"C to copy";e(t.trigger).attr("title",n).tooltip("_fixTitle").tooltip("show").attr("title","Copy to clipboard").tooltip("_fixTitle")})})}(jQuery),function(){"use strict";anchors.options={icon:"#"},anchors.add(".bd-content > h2, .bd-content > h3, .bd-content > h4, .bd-content > h5")}(),function(e){// eslint-disable-line
